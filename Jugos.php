...
<html>
  <head> 
    ...
    <meta name="description" content="Desarrolla jugos premium con ingredientes de alto rendimiento: mejor sabor, estabilidad y calidad consistente en cada producción"> 
    <title>Chemical Broker | Jugos | Proveedor Global y Nacional de Ingredientes Quimicos para la Industria Alimentaria</title>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/CB_JUGO_200521.jpg" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Jugos</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
        <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b class="Tipografia--general Subtitulos">Inicio&nbsp</b><b class="Tipografia--general Subtitulos">>&nbsp</b></a><a class="breditem active" href="Mercados.php" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general Subtitulos">Mercados   </b><b class="Tipografia--general Subtitulos">   > &nbsp</b></a><a class="breditem active" href="Alimentos.php" style="color:#262137 !important;margin-left:-2px" id="Mercado"><b class="Tipografia--general Subtitulos">Alimentos & Nutricion Humana</b><b class="Tipografia--general Subtitulos"> > &nbsp</b></a><a class="breditem active" href="Spray_Nasal.php" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general Subtitulos"> </b><b></b></a><a class="breditem active" href="Carbonatadas.php" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general Subtitulos">Bebidas  ></b></a> <a class="breditem active" href="Jugos.php" style="color:red !important;margin-left:-2px"><b style="color:red;" class="Tipografia--general Subtitulos">Jugos </b></a> </section></section>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Jugos</b></h2>
                <p class="Elementos--Listas letranegro General--Cuerpo">La industria de los jugos es un sector clave en el mercado global de bebidas, centrado en la producción, distribución y comercialización de bebidas a base de frutas y vegetales. Este sector abarca desde jugos 100% naturales hasta bebidas de frutas mezcladas con agua, edulcorantes y otros ingredientes. Es una industria que combina innovación tecnológica, tendencias de consumo saludable y un enfoque creciente en la sostenibilidad.</p>
                <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Aspectos clave de la industria de los jugos</b></h2>
                <ol>
                    <li class="Elementos--Listas">Categorías Principales
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Aspectos clave de la industria de los jugos</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Concentrados de jugo: Jugos procesados para eliminar el agua y reducir el volumen para su transporte.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Bebidas con jugo: Mezclas de jugo con agua, azúcar y otros ingredientes; contienen menos porcentaje de jugo real.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Smoothies y jugos funcionales: Enriquecidos con vitaminas, minerales, fibra, probióticos o proteínas.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Jugos orgánicos: Elaborados con frutas cultivadas sin pesticidas ni químicos artificiales.</li>
                        </ol>
                    </li>
                </ol>
                ...
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Proceso de producción
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Recolección: Las frutas o vegetales se seleccionan y se transportan a las plantas de procesamiento.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Lavado y preparación: Se lavan, pelan y trituran para extraer el jugo.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Pasteurización: Proceso térmico para eliminar microorganismos y extender la vida útil</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Concentración (opcional): Se elimina parte del agua para facilitar el transporte y almacenamiento.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Envasado: Se utiliza tecnología de llenado en caliente o frío para preservar la calidad del producto.</li>
                        </ol>
                    </li>
                </ol>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Mercado Global: El mercado global de jugos esta valorado en mas de 160 mil millones de USD en 2023, con un crecimiento impulsado por: 
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">La demanda de opciones saludables</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">La popularidad de los jugos presnsados en frío</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">La diversificación en sabores y formatos</li>
                        </ol>
                    </li>
                </ol>


               <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Ingredientes Químicos utilizados</b></h2>

               <ol>
                <li class="Elementos--Listas" style="margin-top:30px;">Conservantes: Evita el credimiento de microorganismos y prolongan la vida útil del jugo
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;">Benzoato de sodio (E211): Inhibe el crecimiento de levaduras, bacterias y mohos. Común en jugos no 100% naturales </li>
                        <li class="Elementos--Listas" style="margin-top:30px;">Sorbato de potasio (E202): Utilizado en combinación con otros conservantes para proteger contra mohos y levaduras</li>
                        <li class="Elementos--Listas" style="margin-top:30px;">Ácido ascórbico (E300): Vitamina C que actua como antioxidante y previene la oxidación de colores y sabores</li>
                        <li class="Elementos--Listas" style="margin-top:30px;">Ácido cítrico (E330): Conservante natural que también regula la acidez del producto</li>
                    </ol>
                </li>
                <ol>
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;">Acidulantes: Ajustan el pH, mejoran el sabor y potencian la acción de conservantes:
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ácido cítrico (E330): Común en jugos cítricos, aporta frescura y acidez</li>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ácido málico (E296): Intensifica sabores frutales, especialmente en jugos de manzana y uva</li>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ácido tartárico (E334): Usado en jugos de uva y mezclas de frutas, aporta una acidez más intensa</li>
                            </ol>
                        </li>
                    </ol>
                </ol>
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Edulcorantes: Añaden dulzura en jugos no 100% naturales, especialmente en bebidas con bajo contenido de jugo
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Azúcar (sacarosa): El endulzante más común, derivado de caña de azucar o remolacha</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Jarabe de maíz de alta fructusa (HFCS): utilizado por su bajo costo y alta dulzura</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Sucralosa: (E955): Edulcorante artificial sin calorias</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Estevia (E960): Endulzante natural derivado de plantas, cada vez mas usado en productos bajos en azucar</li>
                        </ol>
                    </li>
                </ol>
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Colorantes: Aportan colores mas vibrantes o reemplazan los perdidos durante el procesamiento
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Carotenoides (E160): Para tonos amarillos y naranjas, extraidos de zahorias o maíz</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Antocianinas (E163): Derivados de uvas o moras, dan colores rojizos o púrpuras.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Clorofilas (E140): Para tonos verdes, extraídas de vegetales</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Amarillo tartrazina (E102): Común en jugos de cítricos (uso más restringido por su potencial efecto alergénico).</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Rojo allura (E129): Usado en bebidas de frutas rojas.</li>
                        </ol>
                    </li>
                </ol>
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Aromatizantes: Intensifican o recrean el sabor de frutas. Pueden ser naturales o artificiales
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Naturales: Aceites esenciales o extractos concentrados de frutas.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Artificiales: Compuestos químicos como el acetato de isoamilo (sabor a plátano) o citral (sabor cítrico).</li>
                        </ol>
                    </li>
                </ol>
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Antioxidantes: Previenen la oxidacion de ingredientes y mantienen el color y sabor fresco
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Ácido ascórbico (E300): Vitamina C, también usada como conservante</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Tocoferoles (E306): Derivados de la vitamina E, estabilizan jugos grasos como los de mango o aguacate.</li>
                        </ol>
                    </li>
                </ol>
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Agentes de emulsión: Usado en jugos con aceites esencuiales o sabores añadidos que tienden a separarse
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Glicerol éster de resina de madera (E445): Estabiliza las mezclas de aceites y agua.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Lecitina (E322): Emulsionante derivado de fuentes naturales como la soya.</li>
                        </ol>
                    </li>
                </ol>
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Vitaminas y minerales añadidos: Fortifican los jugos, especialmente en variantes funcionales
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Vitamina C: Frecuentemente añadida como ácido ascórbico.</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Calcio: Enriquecimiento común en jugos de naranja</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Vitamina D: Añadida para beneficios óseos.</li>
                        </ol>
                    </li>
                </ol>
               </ol>
