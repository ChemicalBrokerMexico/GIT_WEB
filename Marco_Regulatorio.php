        ...
        <ul class="slides slides-pruea">
          <li><img src="img/probar2.jpg" style="height:800px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h1><b class="segundotitulo" style="font-size:26px">Marco Regulatorio</b>
              <div class="container">
      <section style="margin-top:30px;"><a href="index.php" style="color:white !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Cumplimiento.php"><b class="Tipografia--general Subtitulos" style="color:white;">Cumplimiento > </b></a><a class="active" href="Marco_Regulatorio.php"><b class="Tipografia--general Subtitulos" style="color:red;">Marco Regulatorio</b></a></section>
    </div>
            </div>
          </li>
        </ul>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12;center-align">
                <ul class="Tipografia--general;center-align">
                    ...
                    <li class="opacity--menor Tipografia--general" id="A" onclick="filtroa();"><b>A</b></li>
                    ...
                    <li class="opacity--menor Tipografia--general " id="G" onclick="filtrog();"><b>G</b></li>
                    <li class="opacity--menor Tipografia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="H"><b>H</b></li>
                    <li class="no--opacidad Tipografia--general" id="I" onclick="filtroi();"
                         id="I"><b>I</b></li>
                    <li class="no--opacidad Tipografia--general" id="J" onclick="filtroj();"><b>J</b></li>
                    <li class="opacity--menor Tipografia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="K"><b>K</b></li>
                    ...
                    <li class="opacity--menor Tipografia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="O"><b>O</b></li>
                    <li class="opacity--menor Tipografia--general" onclick="filtrop();" id="P"><b>P</b></li>
                    <li class="opacity--menor Tipografia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="Q"><b>Q</b></li>
                    <li class="no--opacidad Tipografia--general"  id="R" onclick="filtror()"><b>R</b></li>
                    <li class="opacity--menor Tipografia--general" id="S" onclick="filtros()"><b>S</b></li>
                    <li class="opacity--menor Tipogradia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="T"><b>T</b></li>
                    <li class="no--opacidad Tipogradia--general" id="U" onclick="filtrou();"><b>U</b></li>
                    <li class="opacity--menor Tipogradia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="V"><b>V</b></li>
                    <li class="opacity--menor Tipogradia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="W"><b>W</b></li>
                    <li class="opacity--menor Tipogradia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="X"><b>X</b></li>
                    <li class="opacity--menor Tipogradia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="Y"><b>Y</b></li>
                    <li class="opacity--menor Tipogradia--general tooltipped" data-position="bottom"
                        data-tooltip="Proximamente" id="Z"><b>Z</b></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid center-align" style="margin-top:-50px">
            <p class="Tipografia--general letranegro center-align Pie--Pagina">© 2014 C&amp;E | Chemical Broker Todos
                los Derechos Reservados. | <a href="Contact.php" style="color:black !important;font-size:16px">Contacto
                    ...
                    <script type="text/javascript" src="js/ABC_Marco_Regulatorio.js"></script>
                </a></p>
        </div>
    </footer>
</body>
