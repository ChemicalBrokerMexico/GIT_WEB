                ...
                <table class="display" id="table_id2" name="table_id2"
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">Ter Butil Hidro Quinona</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;text-align:center;"
                            class="table_bha_mobile">
                            <img src="img/CB_ESTRUCTURA-QUIMICA_TBHQ.png" alt="" width="30%">
                        </td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">
                            C<sub>10</sub>H<sub>14</sub>O<sub>2</sub></td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">1948-33-0</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">E319</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%"
                            class="table_bha_mobile">78886</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">CHEMBL242080</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">15235</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">07726</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">16043</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">C12674942B</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">1.050 g/mL</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">166.220 g.mol<sub>-1</sub></td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">127 a 129 °C</td>
                    </tr>
