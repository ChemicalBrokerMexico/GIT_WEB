...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Chemical Broker | Fosfatos | Proveedor Global y Nacional de Fosfatos</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
...
<div class="container" style="margin-top:150px;">
    <div class="row">
        ...
        <section><a class="breditem active" href="#" style="color:black !important"><b class="Tipografia--general  Subtitulos ">Inicio&nbsp</b><b class="Tipografia--general  Subtitulos"> >&nbsp  </b></a><a class="breditem active" href="Productos_news.php" style="color:black !important;margin-left:-2px"><b class="Tipografia-general  Subtitulos ">Productos > </b> </a> <a class="breditem active" href="Fosfatos.php" style="color:red !important;margin-left:-2px"><b class="Tipografia-general Subtitulos ">Fosfatos</b></a></section>
            ...
            <!-- <div class="col s12 m12 l12 xl12 center-align" style="margin-top:50px;">
            <img src="img/FOSFATOS_PRODUDCTOS_110724.jpg" alt="" width="80%" style="border-radius:10px;">
</div> -->
<!-- <div class="col s12 m12 l12 xl12" style="">
            <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Productos</h5>
            <ol>
                <li class="Elementos--Listas">Fosfato Monocalcico Anhidro</li>
                <li class="Elementos--Listas">Fosfato Monocalcico Monohidratado</li>
                <li class="Elementos--Listas">Fosfato Dicalcico Anhidro</li>
                <li class="Elementos--Listas">Fosfato Dicalcico Dihidratado</li>
                <li class="Elementos--Listas">Fosfato Tricalcico</li>
                <li class="Elementos--Listas">Pirofosfato Acido de Calcio</li>
                <li class="Elementos--Listas">Fosfato Monosodico Anhidro</li>
                <li class="Elementos--Listas">Fosfato Monosodico Monohidratado</li>
                <li class="Elementos--Listas">Fosfato Disodico Anhidro</li>
                <li class="Elementos--Listas">Fosfato Disodico Dodecahidratado</li>
                <li class="Elementos--Listas">Fosfato Trisodico Anhidro</li>
                <li class="Elementos--Listas">Fosfato Trisodico Dodecahidratado</li>
                <li class="Elementos--Listas">Pirofosfato Tetrasodico Anhidro</li>
                <li class="Elementos--Listas">Pirofosfato Acido de Sodio</li>
                <li class="Elementos--Listas">Tripolifosfato de Sodio</li>
                <li class="Elementos--Listas">Hexametafosfato de Sodio</li>
                <li class="Elementos--Listas">Trimetafosfato de Sodio</li>
                <li class="Elementos--Listas">Pirofosfato Acido Trisodico</li>
                <li class="Elementos--Listas">Fosfato de Aluminio y Sodio Anhidro</li>
                <li class="Elementos--Listas">Fosfato de Aluminio y Sodio Tetrahidratado</li>
                <li class="Elementos--Listas">Fosfato Monopotasico</li>
                <li class="Elementos--Listas">Fosfato Dipotásico</li>
                <li class="Elementos--Listas">Fosfato Tripotásico</li>
                <li class="Elementos--Listas">Pirofosfato Tetrapotasico</li>
                <li class="Elementos--Listas">Tripolifosfato de Potasio</li>
                <li class="Elementos--Listas">Polimetafosfato de Potasio</li>
                <li class="Elementos--Listas">Fosfato Mono Amónico</li>
                <li class="Elementos--Listas">Fosfato Di amónico</li>
            </ol>
            </div> -->
    ...
    <div class="col s12 m12 l12 xl12">
      <div class="card">
        <div class="card-image">
          ...
          <span class="card-title" style="font-size:40px;"><b>Productos</b></span>
        </div>
        ...
        <ol>
            ...
            <li style="list-style-type:disc;" class="Tipografia--general letranegro General--Cuerpo">Fosfato de Aluminio y Sodio Anhidro</li>
            <li style="list-style-type:disc;" class="Tipografia--general letranegro General--Cuerpo">Fosfato de Aluminio y Sodio Tetrahidratado</li>
            <li style="list-style-type:disc;" class="Tipografia--general letranegro General--Cuerpo">Fosfato Monopotasico</li>
            <li style="list-style-type:disc;" class="Tipografia--general letranegro General--Cuerpo">Fosfato Dipotásico</li>
            <li style="list-style-type:disc;" class="Tipografia--general letranegro General--Cuerpo">Fosfato Tripotásico</li>
            <li style="list-style-type:disc;" class="Tipografia--general letranegro General--Cuerpo">Pirofosfato Tetrapotasico</li>
