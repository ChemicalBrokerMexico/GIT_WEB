    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/PESCADO_270623.jpg" alt="" style="height:650px">
            <div class="caption center-align" style="margin-top:50px;"><br><br><br><br>
                <b class="segundotitulo" style="font-size: 26px;">Pescados</b>
            </div>
          </li>
        </ul>
      </div>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<p style="color: orange;" class="Tipografia--general letranegro General--Cuerpo">La industria de alimentos balanceados para peces es un pilar fundamental en la acuicultura, proporcionando dietas formuladas para garantizar el crecimiento, la salud y la calidad de especies destinadas al consumo humano. Con el auge de la pesca sostenible y el crecimiento de la demanda mundial de pescado, esta industria ha evolucionado hacia soluciones más eficientes y sustentables.</p>
<h2 class="Tipografia--general letranegro General--Cuerpo"><b>Aspectos Claves de la Industria</b></h2>
<ol class="Elementos--Listas">
<li class="Elementos--Listas">Nutrición Especializada: Las dietas se diseñan para optimizar el crecimiento y minimizar el impacto ambiental.</li>
<li class="Elementos--Listas"> Sostenibilidad: Reducción del uso de harina y aceite de pescado, promoviendo ingredientes alternativos.</li>
<li class="Elementos--Listas">Seguridad Alimentaria: Cumplimiento de regulaciones para evitar contaminantes como antibióticos y metales pesados.</li>
<li class="Elementos--Listas">Eficiencia en Conversión Alimenticia: Optimización de fórmulas para que los peces crezcan con menor consumo de alimento.</li>
</ol>
<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Tendencias y Desafíos</b></h2>
<ol>
    <li class="Elementos--Listas">Uso de proteínas alternativas (harinas vegetales, insectos, subproductos agroindustriales).</li>
    <li class="Elementos--Listas">Mejoras en la digestibilidad con prebióticos y probióticos.</li>
    <li class="Elementos--Listas">Alimentos funcionales que mejoran la inmunidad y reducen enfermedades.</li>
</ol>
<ol>
    <li class="Elementos--Listas">Reducción del impacto ambiental de la producción de alimento.</li>
    <li class="Elementos--Listas">Costos de materias primas, especialmente la harina y el aceite de pescado.</li>
    <li class="Elementos--Listas">Regulación estricta sobre el uso de ciertos ingredientes y aditivos.</li>
</ol>
<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Ingredientes Químicos Utilizados</b></h2>
<ol>
    <li class="Elementos--Listas">Proteínas y Aminoácidos: Harina de pescado, soya, harina de insectos, metionina, lisina.</li>
    <li class="Elementos--Listas">Lípidos y Ácidos Grasos: Aceite de pescado, aceite de algas, fosfolípidos.</li>
    <li class="Elementos--Listas">Vitaminas y Minerales: Vitaminas A, D, E, K, calcio, fósforo, zinc, hierro.</li>
    <li class="Elementos--Listas">Aditivos Funcionales: Antioxidantes (BHT, BHA), prebióticos, probióticos, inmunoestimulantes.</li>
    <li class="Elementos--Listas">Pigmentos Naturales y Sintéticos: Astaxantina y cantaxantina para mejorar el color de la carne (especialmente en salmón y camarón).</li>
</ol>
</div>
</div>
</div>
