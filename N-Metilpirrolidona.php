...
<head>
    ...
    <title>Chemical Broker | N-Metilpirrolidona del fabricante Basf | Proveedor Global y Nacional de Ingredientes Quimicos</title>
...
<script type="application/Id+json">
    {
      ...
      "@type": "Product",
      "name": "N-Metilpirrolidona",
      "description": "La N-metil-2-pirrolidona (NMP) es un disolvente orgánico aprotico, altamente polar, que consta de una lactama de 5 miembros.,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/N-Metilpirrolidona.php",
        "priceCurrency": "MXN",
                    ...
                    <div class="modal" id="modal2" style="overflow-x:hidden">
                        <div class="modal-content">
                            ...
                            <p class="Tipografia--general letranegro General--Cuerpo" style="float:left;">Cuando visita
                                ...
                                funcione como espera. Por lo general, la información no lo identifica directamente, pero
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <p class="Tipografia--general letranegro General--Cuerpo">Estas cookies son
                                            ...
                                            guardan ninguna información personal identificable</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <p class="Tipografia--general letranegro General--Cuerpo">Estas cookies nos
                                            ...
                                            menos populares y ver cuantas personas visitan el sitio. Toda la información
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <p class="Tipografia--general letranegro General--Cuerpo">Estas cookies pueden
                                            ...
                                            mostrarle anuncios relevantes en otros sitios. No almacenan información
                                            personal directamente, si no que se basan en la identificación unica de su
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/N-METHYL_081122.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">N-Metilpirrolidona</b><br></h1>
              <div class="container">
        ...
        <div class="row">
            ...
            <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="N-Metilpirrolidona.php"><b class="Tipografia--general Subtitulos" style="color:red;">Productos</b></a><a class="active" href="N-Metilpirrolidona.php"><b class="Tipografia--general Subtitulos" style="color:red;">N-Metilpirrolidona</b></a></section>
                ...
                <table class="display" id="table_id2" name="table_id2" style="width:100%;border-spacing:2px 2px;border:none;margin-top:30px;margin-bottom:0px;margin-left:0px;margin-right:0px;">
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td
                            ...
                            <ol style="margin-left:52px;color:white;">
                                ...
                                <li style="list-style-type:disc;margin-left:-69px;"
                                    class="Tipografia General Elementos--Listas colornegro">N-metilpirrolidona</li>
                                <li style="list-style-type:disc;margin-left:-69px;"
                                    class="Tipografia General Elementos--Listas colornegro">N-metilpirrolidinona</li>
                            </ol>
                        </td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td
                            style="text-align: center;font-size:16px !important;border:1px solid #C0C0C0;width:50%;background-color:#2F5496;">
                            <img src="img/FORMULA_ESTRUCTURAL_NMTYL.png" alt="" style="width:50%;">
                        </td>
                    </tr>
                    <tr class="Tipografia--general General--Cuerpo"
                        style="text-align:center;padding:10px;font-size:18px !important;width:150px;">
            ...
            <div class="col s12 m12 l12 xl12" style="margin-top:50px;">
                ...
                <table style="border:2px solid f2f2f2;margin-top:50px">
                    ...
                    <tr>
                        <th class="tablaword"
                            style="background-color:#2F5496;color:white;text-align:center;border:2px solid #f2f2f2;">
                    ...
                    <tr>
                        <td class="tablaword class" style="border:2px solid #f2f2f2;">Ensayo, % minimo (incl. DMP1):
                        </td>
                        <td class="tablaword class" style="text-align:center;border:2px solid #f2f2f2;">99.85</td>
                        <td class="tablaword class" style="text-align:center;border:2px solid #f2f2f2;">8450</td>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                            style="text-align:center;border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                            style="text-align:center;border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;color:black;">Agua, % maximo:</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">0.03</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">8432</td>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                    ...
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;color:black;">Color, APHA maximo:</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">30</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">8415</td>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                    ...
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;color:black;">Aminas totales po IC (MMA +
                            DMA + TMA)2, maximo:</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">5</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">8434</td>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                    ...
                    <tr>
                        <td class="tablaword" style="border:2px solid #f2f2f2;color:black;">Aminas totales por
                            titulacion, maximo:</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">12</td>
                        <td class="tablaword" style="text-align:center;border:2px solid #f2f2f2;color:black;">8451</td>
                    </tr>
                    <tr>
                        <td class="tablaword"
                            style="text-align:center;border:2px solid #f2f2f2;background-color:#BDD6EE;"></td>
                ...
                <table style="border:1px solid #f2f2f2;margin-top:50px">
                    <tr>
                        <th style="background-color:#2F5496;color:white;text-align:center;border:1px solid #f2f2f2;">
                            <b>Propiedades fisicas:</b>
                        </th>
                        <th
                            style="background-color:#2F5496;color:white;text-align:center;border:1px solid #f2f2f2;width: 25.5%;">
                            <b>Resultado</b>
                        </th>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;">Temperatura de fusion °C:</td>
                        <td class="tablaword" style="text-align:center;border:1px solid #f2f2f2;width:24.5%;">-23.6</td>

                    </tr>
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                            style="text-align:center;border:1px solid #f2f2f2;background-color:#BDD6EE;"></td>

                    </tr>
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;color:black;">Punto de ebullicion, °C:
                        </td>
                        <td class="tablaword" style="text-align:center;border:1px solid #f2f2f2;color:black;">204.3</td>
                    </tr>
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;background-color:#BDD6EE;"></td>
                        <td class="tablaword"
                    ...
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;color:black;">Densidad a 25 °C, g/cm3:
                        </td>
                        <td class="tablaword" style="text-align:center;border:1px solid #f2f2f2;color:black;">1.028</td>
                    ...
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;color:black;">Punto de inflamacion, °C:
                        </td>
                        <td class="tablaword" style="text-align:center;border:1px solid #f2f2f2;color:black;">91</td>
                    ...
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;color:black;">Temperatura de autoignicion
                            °C:</td>
                        <td class="tablaword" style="text-align:center;border:1px solid #f2f2f2;color:black;">245</td>
                    ...
                    <tr>
                        <td class="tablaword" style="border:1px solid #f2f2f2;color:black;">Solubilidad en agua:</td>
                        <td class="tablaword" style="text-align:center;border:1px solid #f2f2f2;color:black;">Miscible
                        </td>
                ...
                <ol style="margin-bottom:0px;">
                    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Frasco de
                        Cristal de 0.500 Kg,</li>
                    <br>
                    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Tambor de
                        Acero de 200 Kg,</li>
                    <br>
                    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">IBC de
                        1,000 Kg,</li>
                    <br>
                    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Granel.
                    </li>
                </ol>
                ...
                <ol>
                    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;margin-left:-23px;"><a
                            href="PDF/CATALOGUES/BASF_PS_N-METHYLPYRROLIDONE_100915.pdf"
                            class="arrowblue Tipografia--general Botones letranegro" download
                            style="margin-top: 30px;color:rgba(2 146 238 /99%)">BASF_PS_N-METHYLPYRROLIDONE_100915.pdf
                            &nbsp <span class="arrowblue desaparece">Descargar...</span></a></li>
                    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;margin-left:-23px;"><a
                            href="PDF/CATALOGUES/BASF_TDS_N-METHYLPYRROLIDONE_011109.pdf"
                            class="arrowblue Tipografia--general Botones letranegro" download
                            style="margin-top: 30px;color:rgba(2 146 238 /99%)">BASF_TDS_N-METHYLPYRROLIDONE_011109.pdf
                            &nbsp <span class="arrowblue desaparece">Descargar...</span></a></li>
                </ol>
