...
<html>
  <head> 
    ...
    <meta name="description" content="Optimiza la alimentación de tu ganado con ingredientes premium: mayor conversión alimenticia, mejor crecimiento y productividad garantizada.">
    <title>Chemical Broker | Alimento Vacuno | Proveedor Global y Nacional de Ingredientes Quimicos para la Industria Alimentaria</title>
    <link rel="canonical" href="https://chemicalbroker.mx/Vacuno.php">
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/CB_BOVINE_200521.jpeg" alt="" style="height:650px;margin-top: -207px;">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Vacuno</b>
            </div>
          </li>
        </ul>
      </div>
