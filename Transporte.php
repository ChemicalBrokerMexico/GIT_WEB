...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">Transporte </b></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/LOGISTICA_V2_040422.jpg" class="IMAGE--SORBITOLS" alt="">
      </div>
      <div class="col s12 m12 l6 xl6" style="margin-top:6px;">
        <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
            style="border-bottom:3px solid #262137;color:#262137;">Transporte</b></h5>
        <p class="Tipografia--general letranegro General--Cuerpo">Los medios de transporte consisten en el desplazamiento de personas o bienes dentro del espacio físico, facilitando la movilidad de los individuos, dotando de accesibilidad a los territorios, permitiéndoles un mejor desarrollo económico.</p>
      </div>
    </div>
  </div>
...
<div class="container">
  <div class="row">
    <div class="col s12 m12 l12 xl12">
      <h5 class="Tipografia--general letranegro Titulos">Terrestre</h5>
      <p class="Tipografia--general letranegro General--Cuerpo">En algún momento de la historia, la sociedad tuvo la necesidad de trasladar mercancías de un punto a otro. Es así como la necesidad de distribuir mercancías entre distintos puntos de origen inicio al transporte terrestre.</p>
    </div>
  </div>
</div>
