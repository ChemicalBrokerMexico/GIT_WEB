...
<li tabindex="0"><a href="Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/COOKIES_280421.jpeg" style="height:400px;" alt="Historia Ascendente">
    ...
    <div class="container" style="margin-top:130px;">
        ...
        <ol>
            <li style="list-style-type:disc;margin-top:30px">Estándares de uniformidad: Uso de maquinaria para garantizar que cada galleta tenga el mismo tamaño, textura, color y sabor</li>
        </ol>

        <ol>
            <li style="list-style-type:disc;margin-top:30px">Larga vida útil: Incorporacion de conservantes y antioxidantes para que las galletas puedan mantenerse frescas por meses en los estantes</li>
        </ol>

        <ol>
            <li style="list-style-type:disc;margin-top:30px">Variedad de sanores y formatos: Adaptacion a diferentes gustos del mercado, como galletas con rellenos, cubiertas de chocolate, integrales, dietéticas o funcionales</li>
        </ol>
        ...
        <ol>
            <li style="list-style-type: disc;margin-top:50px;">Emulsionantes<ol>
                <li style="list-style-type:disc;margin-top:30px;">Lecitina: Facilita la mezcla de grasas y agua en la masa, dando textura uniforme</li>
                <li style="list-style-type:disc;margin-top:30px;">Mono y diglicéridos de ácidos grasos: Ayudan a mantener la frescura y la textura de las galletas, especialmente en productos rellenos o recubiertos</li>
            </ol></li>
        </ol>

        <ol>
            <li style="list-style-type: disc;margin-top:50px;">Mejoradores de textura<ol>
                <li style="list-style-type:disc;margin-top:30px;">Carbonato de amonio: Actúa como agente leudante, creando burbujas de aire que hacen que las galletas sean mas ligeras y crujientes</li>
                <li style="list-style-type:disc;margin-top:30px;">Fosfato Monocálcico: Ayuda a que las galletas tengan una estructura uniforme</li>
            </ol></li>
        </ol>

        <ol>
            <li style="list-style-type: disc;margin-top:50px;">Edulcorantes <ol>
                <li style="list-style-type:disc;margin-top:30px;">Aspartame y Sucralosa: Se utilizan en galletas bajas en azúcar</li>
                <li style="list-style-type:disc;margin-top:30px;">Jarabe de maíz alto en fructosa: Un edulcorante economico que tambien actua como agente humectante</li>
            </ol></li>
        </ol>

        <ol>
            <li style="list-style-type:disc;margin-top:50px;">Saborizantes artificiales<ol>
                <li style="list-style-type:disc;margin-top:30px;">Sabores de vainilla, chocolate y mantequilla</li>
                <li style="list-style-type:disc;margin-top:30px;">Se sintetizan químicamente para replicar los sabores naturales a un menor costo</li>
            </ol></li>
        </ol>

        <ol>
            <li style="list-style-type:disc;margin-top:50px;">Colorantes artificiales <ol>
                <li style="list-style-type:disc;margin-top:30px;">Caramelo: Usado para oscurecer las galletas y darles un color dorado</li>
                <li style="list-style-type:disc;margin-top:30px;">Colorantes sintéticos: Utilizados para galletas decoradas o con tonos llamaticos, especialmente en productos infantiles</li>
            </ol></li>
        </ol>
