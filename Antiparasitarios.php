    ...
    <div class="nav-wrapper flex"><a class="sidenav-trigger" href="#" data-target="mobile-demo"><i
      ...
      <ul class="hide-on-med-and-down">
        ...
        <ul id="dropdown3" class="dropdown-content">
                    <li><a href="Productos_news.php" class="Tipografia--general letranegro Subtitulos">Familia</a>
          </li>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/antiparasitarios_veterinaria.jpg" style="height:500px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Antiparasitarios</b><br></h1>
              <div class="container">
  ...
  <div class="row">
    <div class="col s12 m12 l12 xl12">
    <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Mercados.php"><b class="Tipografia--general Subtitulos" style="color:black;">Mercados > </b></a><a class="active" href="Mercados.php"><b class="Tipografia--general Subtitulos" style="color:red;">Antiparasitarios</b></a></section>
    </div>
  </div>
  </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                ...
                <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Ingredientes clave en los antiparasitarios</b></h2>
                            ...
                            <li class="Elementos--Listas" style="margin-top:30px;"> Insecticidas y acaricidas: Combaten pulgas, garrapatas y ácaros.
                                <ol>
                                    <li class="Elementos--Listas" style="margin-top:30px;"> Ejemplo
                                        <ol>
                                            <li class="Elementos--Listas" style="margin-top:30px;">Fipronil: Interfiere en el sistema nervioso central de los insectos.</li>
                                            <li class="Elementos--Listas">Imidacloprid: Actúa sobre los receptores nicotínicos del parásito.</li>
                                            <li class="Elementos--Listas">Permetrina: Eficaz contra garrapatas, pulgas y mosquitos.</li>
                                        </ol>
                                    </li>
                                </ol>
                            </li>
