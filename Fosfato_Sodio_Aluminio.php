        ...
        <ul class="slides slides-pruea">
          <li><img src="img/FOSFATOS_BANNER_110724.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Fosfatos</b><br></h1>
              <div class="container">
    </div>
            </div>
          </li>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<section style="margin-top:75px"><a class="active" href="index.php" style="color:black !important"><b class="Tipografia--general Subtitulos">Inicio&nbsp > </b><a class="active" href="Products_news.php" style="color:black !important"><b class="Tipografia--general Subtitulos">Productos&nbsp</b><b class="Tipografia--general Subtitulos" style="color:black;"> >&nbsp  </b></a><a class="breditem active" href="Fosfatos.php" style="color:black !important;margin-left:-2px"><b class="Tipografia-general Subtitulos">Fosfatos > </b></a><a class="breditem active" href="Fosfato_Sodio_Aluminio.php" style="color:red !important;margin-left:-2px"><b class="Tipografia-general Subtitulos">Fosfato de Sodio y Aluminio.</b></a></section>

<p class="Tipografia--general letranegro General--Cuerpo">Optimiza tus formulaciones con BUDAL® 2308 Fosfato de Sodio y Aluminio, un ingrediente versátil y de alto desempeño ideal para aplicaciones alimenticias e industriales. Mejora estabilidad, textura y rendimiento en cada proceso.</p>
...
<div class="container" style="margin-top:100px">
    <div class="row">
        ...
        <div class="col s6 m6 l6 xl6">
            <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Fosfato de Sodio y Alumnio</b></h2>
        </div>
        <div class="col s6 m6 l6 xl6">
