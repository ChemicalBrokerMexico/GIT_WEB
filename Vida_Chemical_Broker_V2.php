...
<head>
    ...
    <title>Chemical Broker | Vida en Chemical Broker</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="slider slider-prueba" style="margin-top:0px">
            <ul class="slides slides-pruea">
                <li> <img src="img/CB_CONTRATO_020323.jpg" alt="" style="height:500px;filter:brightness(0.7);">
                    <div class="caption center-align"><br><br><br><br>
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b>
                        <h3 class="primertitulo"><b class="boldbanner">Vida en la Empresa</b></h3>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <section class="breditem--inicio"><a class="breditem active" href="index.php"
                        ...
                        href=".php" style="color:#262137 !important;margin-left:-2px"><b>Carreras</b><b>
                            ></b>
                            &nbsp</b><a class="breditem active" href="Pectinas.php"
                            style="color:#262137 !important;margin-left:-2px"><b
                                class="Tipografia--general letranegro Subtitulos breadcrumb">Vida en la Empresa</b></a>
                </section>
                </section>
            </div>
        </div>
    ...
    <div class="container" style="background:linear-gradient(#C0C0C0, #071637);">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
              ...
              <h5 class="colornegro Tipografia--general General--Cuerpo" style="color:white;"><b>Valores</b></h5>
              <h5 class="colonegro Tipografia--general General--Cuerpo" style="color:white;">Contamos con los más altos estándares de no discriminación</h5>
              <p class="colonegro Tipografia--general General--Cuerpo" style="color:white;">Dia a día existen cambios en la perspectiva de inclusión a nivel mundial, las empresas están implementando nuevas políticas en cuanto a la diversidad de los recursos humanos, Chemical Broker a través de su política de diversidad e inclusión apoya el hecho de trabajar con todas las personas que tengan las aptitudes para desempeñarse sin limites en un puesto de trabajo, sin importar raza, credo o religión.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="Tipografia--general letranegro Titulos"><b>Proceso de contratación</b></h5>
                <p class="Tipografia--general letranegro General--Cuerpo">En Chemical Broker buscamos a los mejores
                    talentos por eso, el proceso de contratación es minucioso y nos garantiza contratar a los mejores
                    colaboradores para mantener el éxito empresarial y por ende el desarrollo profesional exitoso. </p>

                <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Nuestro proceso, consta de cuatro pasos que
                    guiaran de forma correcta al postulante:</p>
                <!-- <ol>
                <li class="Tipografia--general letranegro Elemetos--Listas" style="list-style-type:none;"><i class="material-icons" style="color:green;">done</i>Solicitud</li>
                <p class="Tipografia--general letranegro General--Cuerpo">La solicitud es el primer paso en el proceso de contratación. Asegúrate de cumplir con todos los rubros que se solicitan. Prepara tu C.V. / Solicitud de trabajo, disminuyendo el riesgo de pérdida de información.</p>
                <p class="Tipografia--general letranegro General--Cuerpo">Todas los vacantes tienen un tiempo determinado de vigencia, postúlate lo antes posible, permitiendo que tu información sea visualizada adecuadamente.</p>
                <li class="Tipografia--general letranegro Elemetos--Listas" style="list-style-type:none;"><i class="material-icons" style="color:green;">done</i>Evaluación</li>
                <p class="Tipografia--general letranegro General--Cuerpo">Después de enviar tu solicitud recibirás un correo electrónico donde se indica si fuiste seleccionado para continuar con el proceso, adicionalmente recibirás un link en donde se especificará fecha y hora para el llenado de una prueba psicométrica</p>
                <p class="Tipografia--general letranegro General--Cuerpo">Nuestras evaluaciones nos ayudan a determinar si eres el candidato indicado para continuar con el proceso. La evaluación será en línea. Estas medirán tus destrezas y habilidades que generalmente no surgen en las entrevistas presenciales.</p>
                <p class="Tipografia--general letranegro General--Cuerpo">Los resultados de la evaluación son inmediatos. vía correo electrónico se te informara si continuar en el siguiente paso del proceso.</p>
                <p class="Tipografia--general letranegro General--Cuerpo">Tipos de Evaluaciones:</p>
                <p class="Tipografia--general letranegro General--Cuerpo">Es posible que se solicite realizar diferentes evaluaciones según la vacante a la que se aplique.</p>
                <p class="Tipografia--general letranegro General--Cuerpo">Proceso para la Evaluación:</p>
                <ol>
                    <li style="list-style-type:disc;">Ingreso desde PC / Dispositivo móvil con conexión a internet. </li>
                    <li style="list-style-type:disc;">Selección de idioma de acuerdo con la lengua materna.</li>
                    <li style="list-style-type:disc;">Responder las preguntas solicitadas.</li>
                    <li style="list-style-type:disc;">Verificar que las preguntas se encuentren con la palabra realizada.</li>
                    <li style="list-style-type:disc;">Enviar la evaluación realizada por medio del botón finalizar.</li>
                </ol>
                <li class="Tipografia--general letranegro Elemetos--Listas" style="list-style-type:none;"><i class="material-icons" style="color:green;">done</i>Entrevista</li>
                <p class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:none;"></p>
                <li class="Tipografia--general letranegro Elemetos--Listas" style="list-style-type:none;"><i class="material-icons" style="color:green;">done</i>Oferta</li>
            </ol> -->
                <ul class="collapsible">
                    <li>
                        <div class="collapsible-header"><b>Solicitud</b><i class="material-icons">arrow_downward</i></div>
                        <div class="collapsible-body">
                            <p class="Tipografia--general letranegro General--Cuerpo">La solicitud es el primer paso en
                                el proceso de contratación. Asegúrate de cumplir con todos los rubros que se solicitan.
                                Prepara tu C.V. / Solicitud de trabajo, disminuyendo el riesgo de pérdida de
                                información.</p>
                            <p class="Tipografia--general letranegro General--Cuerpo">Todas los vacantes tienen un
                                tiempo determinado de vigencia, postúlate lo antes posible, permitiendo que tu
                                información sea visualizada adecuadamente.</p>
                        </div>
                    </li>
                    <li>
                        <div class="collapsible-header"><b>Evaluación</b> <i class="material-icons">arrow_downward</i></div>
                        <div class="collapsible-body">
                            <p class="Tipografia--general letranegro General--Cuerpo">Después de enviar tu solicitud
                                recibirás un correo electrónico donde se indica si fuiste seleccionado para continuar
                                con el proceso, adicionalmente recibirás un link en donde se especificará fecha y hora
                                para el llenado de una prueba psicométrica</p>
                            <p class="Tipografia--general letranegro General--Cuerpo">Nuestras evaluaciones nos ayudan a
                                determinar si eres el candidato indicado para continuar con el proceso. La evaluación
                                será en línea. Estas medirán tus destrezas y habilidades que generalmente no surgen en
                                las entrevistas presenciales.</p>
                            <p class="Tipografia--general letranegro General--Cuerpo">Los resultados de la evaluación
                                son inmediatos. vía correo electrónico se te informara si continuar en el siguiente paso
                                del proceso.</p>
                            <p class="Tipografia--general letranegro General--Cuerpo">Tipos de Evaluaciones:</p>
                            <p class="Tipografia--general letranegro General--Cuerpo">Es posible que se solicite
                                realizar diferentes evaluaciones según la vacante a la que se aplique.</p>
                            <p class="Tipografia--general letranegro General--Cuerpo">Proceso para la Evaluación:</p>
                            <ol>
                                <li style="list-style-type:disc;">Ingreso desde PC / Dispositivo móvil con conexión a
                                    internet. </li>
                                <li style="list-style-type:disc;">Selección de idioma de acuerdo con la lengua materna.
                                </li>
                                <li style="list-style-type:disc;">Responder las preguntas solicitadas.</li>
                                <li style="list-style-type:disc;">Verificar que las preguntas se encuentren con la
                                    palabra realizada.</li>
                                <li style="list-style-type:disc;">Enviar la evaluación realizada por medio del botón
                                    finalizar.</li>
                            </ol>
                        </div>
                    </li>
                    <li>
                        <div class="collapsible-header"><b>Entrevistas</b><i class="material-icons">arrow_downward</i></div>
                        <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                    </li>
                    <li>
                        <div class="collapsible-header"><b>Oferta</b><i class="material-icons">arrow_downward</i></div>
                        <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                    </li>
                </ul>
            </div>
