...
<head>
  ...
  <title>Chemical Broker | Colágeno Hidrolizado de Halavet | Proveedor Global y Nacional de Colageno Hidrolizado</title>
  ...
  <div class="container" style="margin-top:140px;">
    <div class="row">
        ...
        <div class="col s12 m12 l12 xl12">
            ...
            <p class="letranegro Tipografia--general General--Cuerpo">El <b>Colágeno</b> es una molécula proteica o proteína que forma fibras, las fibras colágenas. Estas se encuentran en todos los animales. Son secretadas por las células del tejido conjuntivo como los fibroblastos, así como por otros tipos celulares. Es el componente más abundante de la piel y de los huesos, cubriendo un 25% de la masa total de proteínas en los mamíferos.</p>
            <p class="letranegro Tipografia--general General--Cuerpo" style="margin-top:50px;">El <b>Colágeno</b> es una especie de pegamento que une todas las células; es el componente básico de la piel, los huesos, los dientes, los tendones, los cartílagos o la córnea del ojo.</p>
