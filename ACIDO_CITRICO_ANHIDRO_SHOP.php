...
<ul class="slides">
<li><div style="height:800px;background:linear-gradient(#0070C0 1%, #071637 99%);">

<b class="segundotitulo" style="float:right;color:white;margin-top:200px;margin-right:150px;">Acido Citrico Anhidro Shop</b>
        ...
        <div class="col s6 m6 l6 xl6">
            ...
            <table>
                <tr>
                    ...
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">Acido Cítrico</td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Familia:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">Acidos Carboxilicos</td>
                </tr>
                <tr>
                    ...
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">77-92-9</td>
                </tr>
                <tr>
                    ...
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">Cristales traslucidos incoloros o como polvo blanco, fino y cristalino</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Contenido:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">99.5 - 100.5 %</td>
                </tr>
                <tr>
                    ...
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">< 0.5% </td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Valor de pH (5%):</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">1.7 - 2.0</td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Acido Oxálico:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">< 100 mg/Kg</td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Sulfato:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;"> < 150ppm</td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Sustancias <br>facilmente</br> carbonizables:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">ABS < 0.52 <br> TRA >30%</td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Residuos <br>de</br> Ignicion:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">< 0.05%</td>
                </tr>
                <tr>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#071637;color:white;"><b>Vida anaquel:</b></td>
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">3 Años</td>
                </tr>
            </table>
        </div>
        <!-- <div class="col s12 m12 l12 xl12">
