...
<head>
  ...
  <title>Chemical Broker | Mercado Farmacéutico | Proveedor Global y Nacional de Ingredientes Quimicos para la industria Farmaceutica</title>
...
<script type="application/Id+json">
    {
      ...
      "@type": "Markets",
      "name": "Farmaceutica",
      "description": Calidad en cada ingrediente; en Chemical Broker contamos con un amplio portafolio de ingredientes farmaceuticos los cuales cumplen con las mejores certificaciones a nivel global con el objetivo de brindar la mayor calida a nuestros socios de negocios lo cual nos convierte en uno de los principales proveedores de ingredientes quimicos para farmaceutica a nivel global.,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/pharmaceutical.php",
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:125px"><a class="breditem active" href="index.php"
            style="color:#262137 !important"><b class="Tipografia--general Subtitulos">Inicio&nbsp </b><b> >&nbsp </b></a><a class="breditem active"
            href="Mercados.php" style="color:#262137 !important"><b class="Tipografia--general Subtitulos">Mercados&nbsp </b><b>>&nbsp </b></a><a
            class="breditem active" href="pharmaceutical.php" style="color:red !important;margin-left:-2px"><b
              class="Tipografia--general Subtitulos">Farmacéutica </b></a></section>
      </div>
    </div>
  </div>
