...
<script type="application/Id+json">
    {
      ...
      "@type": "Product",
      "name": "Jarabe de Maiz",
      "description": "El Jarabe de Maíz es un edulcorante líquido, creado a partir del almidón o fécula de maíz. Con un rango de jarabes carbón-refinados, desmineralizados y de conversión enzimática los ingredientes ,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/Jarabe_Maiz.php",
        "priceCurrency": "MXN",
        ...
        <ul class="slides slides-pruea">
          <li><img src="img/CB_JARABE_MAIZ_270223.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Jarabe de Maíz</b><br></h1>
              <div class="container">
    </div>
            </div>
          </li>
