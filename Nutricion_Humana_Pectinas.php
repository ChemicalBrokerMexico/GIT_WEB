...
<head>
    ...
    <title>Chemical Broker | Pectinas Nutricion Humana | Proveedor Gloabl</title>
...
<script type="application/Id+json">
    {
      ...
      "@type": "Product",
      "name": "Pectinas para Nutricion Humana",
      "description": "La pectina, como producto derivado de la naturaleza, tiene una gran demanda en la industria de alimentos y bebidas, donde constantemente se descubren nuevas aplicaciones, se puede utilizar como agente gelificante, agente espesante y estabilizador en aplicaciones alimentarias,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/Nutricion_HUmana_Pectinas.php",
        "priceCurrency": "MXN",
...
<div class="col s12 m12 l12 xl12">
        ...
        <div class="row">
            ...
            <section style="margin-top:125px"><a class="active" href="#" style="color:black !important"><b class="Tipografia--general Subtitulos">Inicio&nbsp</b><b class="Tipografia--general Subtitulos" style="color:black;"> >&nbsp  </b></a><a class="breditem active" href="Productos_news.php" style="color:white !important;margin-left:-2px"><b class="Tipografia-general Subtitulos" style="color:black;">Productos ></b></a> <a class="breditem active" href="Pectinas.php" style="color:white !important;margin-left:-2px"><b class="Tipografia-general Subtitulos" style="color:black;">Pectinas ></b></a>    <a class="breditem active" href="Nutricion_Humana_Pectinas.php" style="color:red !important;margin-left:-2px"><b class="Tipografia-general Subtitulos">Pectinas - Nutricion Humana</b></a></section>
                ...
                <p class="colornegro Tipografia--general General--Cuerpo">La pectina, como producto derivado de la
                    ...
                    estabilizador en aplicaciones alimentarias como como mermeladas, jaleas, yogurt, bebidas lácteas
                ...
                <ol style="margin-bottom:0px;">
                    <li class="Listas_disc" style="margin-top:50px;">Frutas para Panadería:
                        <ol>
                            <br>
                ...
                <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Tabla de Pectinas</b></h5>

                <table style="margin-top:30px;">
                    <thead>
                        <tr>
                            <th style="border:2px solid #f2f2f2;width:30%;background-color:#f2f2f2;" rowspan="2">
                            ...
                            <th colspan="2"
                                ...
                                <b>(LM)*</b>
                                <br>
                                <span style="font-size:10px;">*Low Methoxy por sus siglas en ingles.</span>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="General--Cuerpo letranegro Tipografia--general"><b>Productos</b></h5>
                <br>
                <table>
                    <thead>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                ...
                <ol>
                    <li style="list-style-type:disc"><a href="PDF/CATALOGUES/CARGILL_PECTINS-BROCHURE.pdf"
                            style="color:rgba(2 146 238 /99%) !important;" class="arrowblue"
                            download><b>CARGILL_PECTINS-BROCHURE.pdf
                                &nbsp</b><span class="arrowblue desaparece">Descargar...</span></a></li>
                </ol>
            </div>
        </div>
    </div>
