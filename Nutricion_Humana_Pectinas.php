    ...
    <div class="container-fluid">
        <div class="slider slider-prueba" style="margin-top:0px">
            <ul class="slides slides-pruea">
                <li> <img src="img/CB_PECTINAS_ALIMENTOS_121222.jpg" alt=""
                        style="height:500px;filter:brightness(0.9);">
                    <div class="caption center-align"><br><br><br><br>
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b
                            class="segundotitulo" style="font-size: 26px;">Pectinas &nbsp- Nutricion Humana</b>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <section class="breditem--inicio"><a class="breditem active" href="index.php"
                        ...
                        <a class="breditem active" href="Nutricion_Humana_Pectinas.php"
                            style="color:#262137 !important;margin-left:-2px"><b
                                class="Tipografia--general letranegro Subtitulos breadcrumb">Pectinas - Nutricion
                                Humana</b></a></section>
                </section>
            </div>
        </div>
