...
<meta name="description" content="Comienza tu carrera profesional, en una organizacion comprometida completamente con tu crecimiento profesional unete a nuestro gran equipo en Chemical Broker">
...
<div class="col s12 m12 l12 xl12" style="margin-top:20px;">
  <a href="Proximamente.php" class="btn boton--carreers" style="color:#262137;color:white">Vida en Chemical Broker</a>
</div>
<div class="col s12 m12 l12 xl12" style="margin-top:20px">
  <a href="#" class="btn tooltipped boton--carreers" data-position="bottom" data-tooltip="Conoce Todas Nuestras Vacantes">Registrate</a>
</div>
<br>
</div>
</li>
...
<p class="Tipografia--general letranegro General--Cuerpo"><b class="Tipografia--general letranegro Genera l--Cuerpo">Chemical Broker</b> es una organización enfocada a la
    ...
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s4"><a class="active" href="#test1">Diversidad e Inclusion</a></li>
        <li class="tab col s4"><a href="#test2">Compromiso</a></li>
        <li class="tab col s4"><a href="#test3">Trabajo en Equipo</a></li>
...
</div><img class="mercadosimagen" src="img/DIVERSITY_INCLUSION_260623.jpg" alt="" style="border-radius:10px">
</div>
</a></div>
...
<p class="Tipografia--general letranegro General--Cuerpo">Día a día existen cambios en la perspectiva de inclusión a nivel mundial, las empresas están implementando nuevas políticas en cuanto a la diversidad de los Recursos Humanos, Chemical Broker a través de la política inclusión y diversidad química apoya el hecho de trabajar con todas las personas que tengan las aptitudes para desempeñarse sin límites en un puesto de trabajo, sin importar raza, credo o religión.</p>
    ...
    <div id="test2" class="col s12"><div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;"><a href="Proximamente.php"
style="cursor:pointer;">
<div class="contenedor">
<div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
<div class="centrado_sub" style="position:absolute;z-index:2">
...
A través de nuestra política de puertas abiertas, cada una de las áreas puede realizar sus labores manteniendo estrecha comunicación de forma ascendente, horizontal y descendente con las áreas y departamentos, lo que permite que exista un total compromiso de nuestros colaboradores para el logro de los objetivos.
    ...
    <div id="test3" class="col s12"><div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;"><a href="Proximamente.php"
style="cursor:pointer;">
<div class="contenedor">
<div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
<div class="centrado_sub" style="position:absolute;z-index:2">
...
</div><img class="mercadosimagen" src="img/TRABAJO_EQUIPO_260623.jpg" alt="" style="border-radius:10px">
</div>
</a></div>
<div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
...
<a href="#" class="btn" style="background:#000020;">Leer Mas</a>
    ...
    <div id="test2C" class="col s12"><div class="col s12 m12 l6 xl6 mercados" style="margin-top:10px;"><a href="Proximamente.php"
style="cursor:pointer;">
<div class="contenedor">
<div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
<div class="centrado_sub" style="position:absolute;z-index:2">
