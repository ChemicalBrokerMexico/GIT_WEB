  ...
  <script type="application/Id+json">
    {
      ...
      "@type": "Product",
      "name": "Trigliceridos de Cadena Media",
      "description": "Los trigliceridos de cadena media aportan energia rapida, facil digestion y se utilizan en nutricion clinica, deportiva y alimentos funcionales,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/Trigliceridos_Cadena_Media.php",
        "priceCurrency": "MXN",
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/BANNER_PRINCIPAL_TCM.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Trigliceridos de Cadena Media</b><br></h1>
              <div class="container">
    </div>
            </div>
          </li>
  ...
  <div class="container" style="margin-top:130px;">
    <div class="row">
      ...
      <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Productos_news.php"><b class="Tipografia--general Subtitulos" style="color:black;">Productos > </b></a><a class="active" href="Glycerins.php"><b class="Tipografia--general Subtitulos" style="color:red;">Trigliceridos de Cadena Media</b></a></section>
                ...
                <li class="Elementos--Listas" style="margin-top:50px;"><b>Composición de ácidos grasos</b>
                    <ol>
                        <li class="Elementos--Listas"> Los TCM más comunes incluyen:
                            <ol>
                                <li class="Elementos--Listas">Ácido caproico (C6:0)</li>
                                <li class="Elementos--Listas">Ácido caprílico (C8:0)</li>
                                <li class="Elementos--Listas">Ácido cáprico (C10:0)</li>
                                <li class="Elementos--Listas">Ácido láurico (C12:0)</li>
                            </ol>
                        </li>
                    </ol>
                </li>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"><b>Nutrición:</b>
                    <ol>
                        <li class="Elementos--Listas">Soporte en dietas cetogénicas y control de peso:
                            <ol>
                                <li class="Elementos--Listas">Ayudan a generar cetonas, lo que favorece la quema de grasa y el control del apetito.</li>
                                <li class="Elementos--Listas">Utilizados en planes de alimentación para la pérdida de peso y dietas bajas en carbohidratos.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
                ...
                <li class="Elementos--Listas" style="margin-top:50px;"><b>Aplicaciones en el Deporte y el Rendimiento Físico</b>
                    <ol>
                        <li class="Elementos--Listas">Energía rápida y sostenida
                            <ol>
                                <li class="Elementos--Listas">Proporcionan energía sin elevar los niveles de glucosa en sangre.</li>
                                <li class="Elementos--Listas">Utilizados en suplementos deportivos para aumentar resistencia y mejorar recuperación muscular.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
