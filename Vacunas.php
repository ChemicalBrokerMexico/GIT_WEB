...
<html lang="es"> 
  <head> 
    ...
    <link rel="canonical" href="https://chemicalbroker.mx/Vacunas.php">
...
<ul class="slides">
<li> <img src="img/VACUNAS_VETERINARIA.jpg" style="height:400px;" alt="Industria Quimica">
<div class="caption center-align"><br><br><br><br>
<h1 class="primertitulo"><b class="primertitulo">Vacunas</b></h1>
...
<h2 class="Tipografia--general letranegro General--Cuerpo"><b>Componentes activos (antígenos):</b></h2>
...
<ol>
    <li class="Elementos--Listas" style="margin-top:30px;"><b>Adyuvantes:</b>
        <ol>
            ...
            <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Hidróxido de aluminio, Fosfato de aluminio.</li>
        </ol>
    </li>
</ol>
...
<ol>
    <li class="Elementos--Listas" style="margin-top:30px;"><b>Conservantes: Previenen la contaminación microbiana en vacunas multidosis. Ejemplos:</b>
        <ol>
            ...
            <li class="Elementos--Listas" style="margin-top:30px;">Benzalconio cloruro: Antiséptico utilizado en ciertas formulaciones.</li>
        </ol>
    </li>
</ol>
    ...
    <li class="Elementos--Listas" style="margin-top:30px;"><b>Estabilizantes: Prolongan la vida útil y mantienen la potencia de la vacuna durante su almacenamiento.</b>
        <ol>
            <li class="Elementos--Listas" style="margin-top:30px;"> Azúcares:
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Sacarosa, Trehalosa.</li>
                    <li class="Elementos--Listas" style="margin-top:30px;">Uso: Protegen antígenos durante la liofilización.</li>
                </ol>
            </li>
        </ol>
        <ol>
    ...
    <li class="Elementos--Listas" style="margin-top:30px;"><b>Excipientes y vehículos: Facilitan la formulación y administración.</b>
        <ol>
            <li class="Elementos--Listas" style="margin-top:30px;"> Soluciones tampón:
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Tampón fosfato-salino (PBS), Citratos.</li>
                    <li class="Elementos--Listas" style="margin-top:30px;">Uso: Mantienen el pH adecuado.</li>
                </ol>
            </li>
        </ol>
        <ol>
