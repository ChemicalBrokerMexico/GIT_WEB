...
<li> <a class="elemennav-secun Tipografia--general letranegro Subtitulos dropdown-trigger" href="#!" data-target="dropdown3"><b>Productos<i class="material-icons right">arrow_drop_down</i></b></a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="vcol s12 m12 l12 xl12">
          <section style="margin-top:125px;width:150px"><a class="breditem active" href="index.php" style="color: #262137 !important;"><b>Inicio &nbsp</b><b>  >&nbsp</b></a><a class="breditem active" href="Contact.php" style="color: #262137 !important;margin-left: -2px;"><b class="Tipografia--general letranegro Subtitulos breadcrumb"> Contacto </b></a></section>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <p class="Tipografia--general letranegro General--Cuerpo ">Bienvenido a <b style="color: #262137;">Chemical Broker</b>, para solicitar información sobre nuestros productos o servicios, por favor contáctenos vía: 
          </p>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m6 l6 xl6">
          <h6><b style="color:#262137">Ventas </b></h6>
        ...
        <div class="col s12 m6 l6 xl6">
          <h6> <b style="color:#262137" class="Tipografia--general letranegro General--Cuerpo">Información General</b></h6>
    ...
    <div class="container" style="margin-top:50px">
      <form action="envio_correo.php" method="POST" id="enviocorreo">
        ...
        <div class="row center-align">
          <div class="col s12 m12 l12 xl12">
            <button class="btn waves-light" type="submit" name="Enviarinformacion" id="Enviarinformacion" onclick= "document.getElementById('enviocorreo').submit();Validarcampos();" class="Tipografia--general Botones" style="background-color: #262137; text-transform: none;"><span id="envioinfocon">Enviar Información   </span></button>
          </div>
        </div>
        </form>
          ...
          <div id="modal10" class="modal esquinas_redondeadas_contacto">
            <div class="modal-content">
              ...
              <div class="col s12 m12 l6 xl6">
                ...
                <p class="Tipografia--general General--Cuerpo letranegro"><i class="tiny material-icons prefix">phone</i><b>Télefono:</b><a class="arrowblue" href="tel:+525575861888" style="color:#262137">+52.55.7586.1888</a></p>
...
<h4 style="font-family: Arial !important;font-size: 35px;opacity:.6;color: #262137;">Información enviada con éxito</h4>
</div> 
  </div>
</div>
