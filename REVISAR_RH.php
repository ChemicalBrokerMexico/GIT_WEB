...
<ul id="slide-out" class="sidenav">
  <li><a class="btn" style="font-size:16px;background-color:#262137;" href="#!">Publicar un Empleo</a></li>
  <li><a style="font-size:16px;" href="#!">Empleos <i class="material-icons">keyboard_arrow_right</i></a></li>
  <li><a style="font-size:16px;" href="#">Candidatos <i class="material-icons">keyboard_arrow_right</i></a></li>
  <li><a style="font-size:16px;" href="#">Buscar CV <i class="material-icons">keyboard_arrow_right</i></a></li>
  <li><a style="font-size:16px;" href="#">Entrevistas <i class="material-icons">keyboard_arrow_right</i></a></li>
  <li><a style="font-size:16px;" href="#">Analisis <i class="material-icons">keyboard_arrow_right</i></a></li>
  <li><a style="font-size:16px;" href="#">Herramientas <i class="material-icons">keyboard_arrow_right</i></a></li>
</ul>
...
<nav id="nav_oscuro" style="background-color:white;height:100px;margin-top:-15px;">
        ...
        <a href="#" data-target="slide-out" class="sidenav-trigger" style="color:black;display:inline-block;margin-top:25px;"><i class="material-icons">menu</i></a>
        </div>
        ...
        <div style="display:inline-block;margin-left:15px;">
        <p class="dropdown-trigger" data-target='dropdown1' style="color:#262137;display:inline-block;">human.resources@chemicalbroker.mx <i class="material-icons" style="display:inline-block;color:black;">account_box</i></p>
        </div>
        </div>
        </div>
        </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                ...
                <a href="" class="btn" style="color:black;float:right;">Añadir candidato</a>
