...
<td class="border--hidden"><a class="letranegro" href="https://docs.google.com/forms/d/e/1FAIpQLScRNCAuH7KNNX6VGxRfLjKib0OsLdAJacf7pEjuu4eynxzD5A/viewform" style="border:hidden">Codigo de Conducta Organizacional</a></td>
    ...
    <div class="container" style="margin-top:150px;">
        ...
        <section><a class="active" href="#" style="color:black !important"><b
            ...
            <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">El proceso de refinación
                implica varias etapas, incluyendo la trituración, la purificación con cal, la carbonatación, la
                filtración, la cristalización y finalmente, el secado. Este proceso produce un azúcar blanco, granulado
                y de alta pureza, que es el tipo de azúcar más comúnmente utilizado en la cocina y la repostería.</p>
            ...
            <ol>
                ...
                <ol style="margin-top:30px;">
                    <li class="Elementos--Listas"><b style="color:#660066">Endulzante:</b> Es el uso más común,
                        utilizado para endulzar bebidas, postres, y diversos platos.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Panadería y repostería:</b> Es un ingrediente
                        clave en la elaboración de pasteles, galletas, panes, tartas, muffins y otros productos
                        horneados.</li>
                    <br>
                    ...
                    <li class="Elementos--Listas"><b style="color:#660066">Fermentación:</b> Es fundamental en la
                        fermentación de productos como el vino, la cerveza y el pan, ya que alimenta a las levaduras y
                        bacterias necesarias para el proceso.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Decoración:</b> Utilizado en formas de
                        glaseado, fondant y azúcar glas para decorar pasteles y otros postres.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Condimentos y salsas:</b> Se usa para
                        equilibrar sabores en salsas, aderezos y marinados.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Confitería:</b> Es esencial en la producción
                        de dulces, caramelos, chocolates, gomitas y otros dulces.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Lácteos:</b> utilizada en la producción de
                        bebidas saborizadas, helados, yogures, flanes y otros postres lácteos para mejorar el sabor y la
                        textura.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Bebidas:</b> Endulzante para refrescos,
                        jugos, tés, bebidas energéticas, isotónicas, cafés y bebidas alcohólicas como el vino y la
                        cerveza.</li>
                </ol>
            </ol>
            ...
            <ol style="margin-top:50px;">
                ...
                <ol style="margin-top:30px;">
                    <li class="Elementos--Listas"><b style="color:#660066">Medicamentos:</b>Utilizado como excipiente en
                        jarabes, pildoras y comprimidos para mejorar el sabor.</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Suplementos Nutricionales:</b> A menudo
                        incluido en la formulación de suplementos vitamínicos y minerales.</li>
                    <br>
            ...
            <ol style="margin-top:0px;">
                ...
                <ol style="margin-top:30px;">
                    <li class="Elementos--Listas"><b style="color:#660066">Exfoliantes:</b>Utilizado en productos
                        exfoliantes para la piel debido a su textura granulada</li>
                    <br>
                    <li class="Elementos--Listas"><b style="color:#660066">Cremas y Lociones:</b>Utilizado para mejorar
                        el sabor y la palatabilidad de los alimentos para mascotas.</li>
                    <br>
            ...
            <ol style="margin-top:0px;">
                ...
                <ol style="margin-top:30px;">
                    <li class="Elementos--Listas"><b style="color:#660066">Alimento para mascotas:</b>Utilizado para
                        mejorar el sabor y la palatabilidad de los alimentos para mascotas.</li>
                </ol>
            </ol>
