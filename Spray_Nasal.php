  ...
  <div class="modal" id="modal1" style="overflow-y:auto;">
    ...
    <div class="modal-footer" style="height:25px">
      <div class="row center-align">
        ...
        <div class="col s12 m12 l4 xl4" style="margin-top:20px"><a
            class="close_hover letranegro Tipografia--general Botones" onclick="denegarCookies();">No Estoy de Acuerdo
          </a></div>
        <div class="col s12 m12 l4 xl4" style="margin-top:20px"><a
                  ...
                  <ul>
                    <p style="color:white"><b class="Tipografia--general Titulos">Politicas </b>
                      ...
                      <li><a class="arrowblue Tipografia--general Subtitulos"
                          href="../PDF/CBM_CODCONDUCT_PROVEEDORES.pdf" download>Código de Conducta de Proveedores &nbsp
                          <i class="fas fa-long-arrow-alt-right desaparece" id="aparece"></i></a></li>
                      <li><a class="arrowblue Tipografia--general Subtitulos" href="../PDF/CBM_CODCONDUCT_CLIENTES.pdf"
              ...
              <tbody class="center-align">
                ...
                <tr>
                  <td style="border:hidden;background-color:#262137"><a href="Contact.php"
                      style="color:white !important;border:hidden"> </a></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <li><img src="img/SPRAY_NASAL.jpeg" style="height:800px;" alt="Historia Ascendente">
          <div class="caption center-align"><br><br><br><br>
            <h1 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h1><b class="segundotitulo"
              style="font-size:26px">Spray Nasal</b>
            <div class="container">
            </div>
          </div>
        </li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        ...
        <p class="Tipografia--general General--Cuerpo">El mercado de los sprays nasales es una parte importante del
          sector farmacéutico que aborda una variedad de necesidades de salud relacionadas con el tracto respiratorio
          superior. Estos productos están diseñados para administrar medicamentos directamente en la cavidad nasal, lo
          que los hace efectivos para tratar afecciones como congestión nasal, alergias, sinusitis, resfriados y rinitis
          entre otros.</p>
        ...
        <!-- </p> -->
        <p class="Tipografia--general General--Cuerpo"><b>Algunos de los puntos clave de este mercado son:</b></p>
        <ol>
          <li class="Elementos--Listas" style="list-style-type:disc;margin: top 50px;;"><b
              style="color:#071637;">Crecimiento de mercado:</b> El mercado de los sprays nasales ha experimentado un
            crecimiento constante debido a factores como el aumento de la prevalencia de condiciones respiratorias, el
            envejecimiento de la población y una mayor conciencia sobre el autocuidado de la salud.</li>
          <li class="Elementos--Listas" style="list-style-type:disc;margin-top:30px;"><b
              style="color:#071637;">innovación:</b> Las empresas farmacéuticas están en constantemente innovando en el
            desarrollo de nuevos productos y formulaciones para mejorar la eficacia, la comodidad y seguridad de los
            sprays nasales.</li>
          <li class="Elementos--Listas" style="list-style-type:disc;margin-top:30px;"><b
              style="color:#071637;">Regulación:</b> Los sprays nasales están sujetos a regulaciones estrictas por parte
            de las agencias de salud en diferentes países para garantizar su seguridad y eficacia. Esto incluye
            requisitos de etiquetado claros, pruebas de seguridad y calidad.</li>
        </ol>
        <h5 class="Tipografia--general General--Cuerpo" style="margin-top:50px;"><b>Ingredientes químicos utilizados en
            los sprays nasales:</b></h5>
        <ol>
          <li style="list-style-type:disc;margin-top:50px;"><b style="color:#071637;">Descongestionantes:</b> Los
            descongestionantes nasales son a menudo compuestos adrenérgicos, como la oximetazolina, la fenilefrina o la
            pseudoefedrina. Estos compuestos actúan sobre los receptores alfa- adrenérgicos en los vasos sanguíneos
            nasales causando construcción y reduciendo la congestión nasal.</li>
          <li style="list-style-type:disc;margin-top:30px;"><b style="color:#071637;">Antihistamínicos:</b> los
            antihistamínicos utilizados en los sprays nasales como la azelastina o la olopatadina bloquean los
            receptores de histamina en la mucosa nasal, lo que ayuda a reducir la inflamación y los síntomas asociados
            con la rinitis alérgica. </li>
          <li style="list-style-type:disc;margin-top:30px;"><b style="color:#071637;">Corticosteroides:</b> Los
            corticosteroides nasales, como la fluticasona, la budesónida o la mometasona, son potentes antiinflamatorios
            que reducen la inflamación y la hinchazón de la mucosa nasal al inhibir la liberación de los mediadores
            inflamatorios y la síntesis de citoquinas. </li>
          <li style="list-style-type:disc;margin-top:30px;"><b style="color:#071637;">Conservantes y
              estabilizadores:</b> Los conservantes y estabilizadores se utilizan para mantener la esterilidad y la
            estabilidad del producto durante su vida útil. Estos ingredientes pueden incluir conservantes como el
            cloruro de benzalconio o el cloruro de sodio, así como estabilizadores de pH y antioxidantes</li>
        </ol>

      </div>
      <div class="col s12 m12 l12 xl12">
        <h5 class="Tipografia--general General--Cuerpo" style="margin-top:50px;"><b
            style="color:#262137;"><b>Productos</b></b></h5>
      </div>
    </div>
  </div>
  <div class="container" style="margin-top:-50px;">
    <div class="row">
      ...
      <div class="col s12 m12 l4 xl4">
        ...
        <!-- <ol>
          <li style="list-style-type:disc;"><a href="Glycerins.php" style="color:rgba(2 146 238 /99%)">Glicerina</a>
          </li>
        </ol> -->
