...
<html>
  <head> 
    ...
    <title>Chemical Broker | Fertilizantes | Proveedor Global y Nacional de Ingredientes Quimicos para la Industria Agroquimica</title>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/FERTILIZANTES.jpg" alt="" style="height:400px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Fertilizantes</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
        <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b class="Tipografia--general Subtitulos">Inicio&nbsp </b><b class="Tipografia--general Subtitulos">   > &nbsp</b></a><a class="breditem active" href="Mercados.php" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general Subtitulos">Mercados   </b><b class="Tipografia--general Subtitulos">   > &nbsp</b></a><a class="breditem active" href="Alimentos.php" style="color:#262137 !important;margin-left:-2px" id="Mercado"><b class="Tipografia--general Subtitulos">Agroquimicos</b><b class="Tipografia--general Subtitulos"> > &nbsp</b></a><a class="breditem active" href="Spray_Nasal.php" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general Subtitulos"> </b><b></b></a><a class="active" href="Mascotas.php" style="color:red !important;margin-left:-2px"><b class="Tipografia--general letranegro Subtitulos breadcrumb" style="color:red;">Fertilizantes</b></a></section></section>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <p class="Tipografia--general letranegro General--Cuerpo">La industria de los fertilizantes se enfoca en la producción y comercialización de nutrientes esenciales que mejoran la productividad y calidad de los cultivos agrícolas. Estos productos proporcionan elementos fundamentales para el crecimiento de las plantas, como nitrógeno, fósforo y potasio, conocidos comúnmente como macronutrientes primarios.</p>
                ...
                <ol>
                    <li class="Elementos--Listas">Extracción de materias primas: Se obtienen compuestos minerales y químicos a partir de fuentes naturales o procesos sintéticos.</li>
                    <li class="Elementos--Listas">Formulación y mezcla: Se combinan los nutrientes según necesidades específicas de los cultivos.</li>
                    <li class="Elementos--Listas">Granulación y secado: Los fertilizantes sólidos se granulan para facilitar su aplicación.</li>
                    <li class="Elementos--Listas">Envasado y distribución: Se empaquetan en presentaciones líquidas, sólidas o granuladas.</li>
                </ol>
                ...
                <ol>
                    <li class="Elementos--Listas">Agricultura intensiva: Uso masivo para maximizar el rendimiento de cultivos de alto valor como maíz, trigo, soya y caña de azúcar.</li>
                    <li class="Elementos--Listas">Jardinería y paisajismo: Fertilizantes especiales para césped, flores y plantas ornamentales.</li>
                    <li class="Elementos--Listas">Sistemas hidropónicos y agricultura controlada: Fertilizantes solubles específicos para sistemas sin suelo.</li>
                ...
                <ol>
                    <li class="Elementos--Listas">Uso de fertilizantes de liberación controlada y lenta.</li>
                    <li class="Elementos--Listas">Productos más eficientes y ecológicos (biofertilizantes).</li>
                    <li class="Elementos--Listas">Formulaciones personalizadas para suelos específicos</li>
                </ol>


                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Ingredientes Químicos Utilizados en los Fertilizantes</b></h2>

                <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Macronutrientes Primarios (N-P-K)</b></h2>

                <p class="Tipografia--general letranegro General--Cuerpo">Son los nutrientes esenciales requeridos en grandes cantidades para el crecimiento de las plantas.</p>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Nitrógeno (N): Promueve el crecimiento de hojas y tallos verdes.
                        <ol>
                            <li class="Elementos--Listas">Urea (CO(NH2)2): Fertilizante nitrogenado más común.</li>
                            <li class="Elementos--Listas">Nitrato de amonio (NH4NO3): Alta solubilidad y eficacia.</li>
                            <li class="Elementos--Listas">Sulfato de amonio ((NH4)2SO4): Aporta azufre además de nitrógeno.</li>
                        </ol>
                    </li>
                </ol>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Fósforo (P): Favorece el desarrollo de raíces y flores.
                        <ol>
                            <li class="Elementos--Listas">Superfosfato simple (Ca(H2PO4)2): Fuente de fósforo soluble.</li>
                            <li class="Elementos--Listas">Fosfato monoamónico (MAP, NH4H2PO4): Ideal para suelos ácidos.</li>
                            <li class="Elementos--Listas">Fosfato diamónico (DAP, (NH4)2HPO4): Muy eficiente para cultivos extensivos.</li>
                        </ol>
                    </li>
                </ol>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Potasio (K): Mejora la resistencia a enfermedades y la calidad del fruto.
                        <ol>
                            <li class="Elementos--Listas">Cloruro de potasio (KCl): Fertilizante potásico más común.</li>
                            <li class="Elementos--Listas">Sulfato de potasio (K2SO4): Usado en cultivos sensibles al cloro.</li>
                        </ol>
                    </li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Macronutrientes Secundarios</b></h2>

                <p class="Tipografia--general letranegro General--Cuerpo">Son necesarios en cantidades menores pero esenciales para un desarrollo saludable.</p>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Calcio (Ca): Fortalece las paredes celulares.
                        <ol>
                            <li class="Elementos--Listas">Nitrato de calcio (Ca(NO3)2): Usado en cultivos hortícolas y frutas.</li>
                        </ol>
                    </li>
                </ol>

                <ol>
                    <li class="Elementos--Listas">Magnesio (Mg): Fundamental para la fotosíntesis.
                        <ol>
                            <li class="Elementos--Listas">Sulfato de magnesio (MgSO4, sal de Epsom): Fuente rápida de magnesio.</li>
                        </ol>
                    </li>
                </ol>

                <ol>
                    <li class="Elementos--Listas">Azufre (S): Participa en la síntesis de proteínas.
                        <ol>
                            <li class="Elementos--Listas">Sulfato de amonio y sulfato de potasio: Fuentes comunes de azufre.</li>
                        </ol>
                    </li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Micronutrientes</b></h2>

                <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:30px;">Necesarios en pequeñas cantidades pero vitales para procesos metabólicos.</p>

                <ol>
                    <li class="Elementos--Listas">Hierro (Fe): Clave para la fotosíntesis.
                        <ol>
                            <li class="Elementos--Listas">Quelato de hierro (Fe-EDTA): Soluble y de rápida absorción.</li>
                        </ol>
                    </li>
                </ol>

                <ol>
                    <li class="Elementos--Listas">Manganeso (Mn), Zinc (Zn), Cobre (Cu), Boro (B), Molibdeno (Mo):
                        <ol>
                            <li class="Elementos--Listas">Quelatos y sales solubles: Usados para corregir deficiencias específicas.</li>
                        </ol>
                    </li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Aditivos y Agentes Mejoradores</b></h2>

                <p class="Tipografia--general letranegro General--Cuerpo">Optimizan la efectividad del fertilizante y su aplicación.</p>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Inhibidores de la nitrificación y ureasa (NBPT, DMPP): Evitan la pérdida de nitrógeno por volatilización o lixiviación.</li>
                    <li class="Elementos--Listas">Surfactantes y humectantes: Facilitan la absorción del fertilizante por el suelo.</li>
                    <li class="Elementos--Listas">Antipolvo y aglutinantes: Mejoran la manipulación y el almacenamiento de fertilizantes granulados.</li>
                </ol>

                
                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Biofertilizantes y Alternativas Sostenibles</b></h2>

                <p class="Tipografia--general letranegro General--Cuerpo">Alternativas ecológicas basadas en microorganismos y sustancias naturales.</p>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Bacterias fijadoras de nitrógeno (Rhizobium, Azospirillum): Aumentan el nitrógeno disponible para las plantas.</li>
                    <li class="Elementos--Listas">Micorrizas y hongos solubilizadores de fósforo: Mejoran la absorción de nutrientes.</li>
                    <li class="Elementos--Listas">Ácidos húmicos y fúlvicos: Estimulan el crecimiento radicular y la absorción de nutrientes.</li>
                </ol>
