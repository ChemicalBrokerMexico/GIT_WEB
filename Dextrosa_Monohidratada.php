...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;">search</i></a></li>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/POSTRES_CONGELADOS_270426.jpg" style="height:800px;filter:brightness(0.9);" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Dextrosa Monohidratada</b><br></h1>
              <div class="container">
  ...
  <div class="container" style="margin-top:130px;">
    <div class="row">
      ...
      <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Products_news.php"><b class="Tipografia--general Subtitulos" style="color:black;">Productos > </b></a><a class="active" href="Dextrosas.php"><b class="Tipografia--general Subtitulos" style="color:black;">Dextrosas > </b></a><a class="active" href="Dextrosa_Monohidratada.php"><b class="Tipografia--general Subtitulos" style="color:red;">Dextrosa Monohidratada</b></a></section>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b>Dextrosa Monohidratada</b></h2>

      <p class="Tipografia--general letranegro General--Cuerpo">La dextrosa monohidratada es un monosacárido (D-glucosa) obtenido a partir de la hidrólisis del almidón, que contiene una molécula de agua de cristalización. Se presenta como un polvo cristalino blanco, con excelente estabilidad y facilidad de manejo.</p>
      <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Gracias a su balance entre funcionalidad, costo y estabilidad, es uno de los ingredientes más utilizados en las industrias alimentaria, farmacéutica, nutracéutica y de fermentación, destacando por su versatilidad como edulcorante y agente técnico.</p>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Caracteristicas del Producto</b></h2>
    
      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Mayor estabilidad en almacenamiento: Menor sensibilidad a condiciones ambientales</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Fácil manejo y transporte: Menor tendencia a apelmazamiento</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Versatilidad funcional: Edulcorante, agente de carga y sustrato</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Costo competitivo: Alternativa eficiente para producción a gran escala</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Buen desempeño en fermentación: Fuente de carbono estable</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Mejora textura y volumen en alimentos</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Alta compatibilidad en formulaciones industriales</li>
      </ol>
      ...
      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Bebidas (refrescos, jugos, isotónicas)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Panificación (pan, galletas, pasteles)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Confitería (gomitas, caramelos, chocolates)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Lácteos y derivados</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Helados y postres congelados</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Industria farmacéutica</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Excipiente en tabletas y cápsulas</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Jarabes y soluciones orales</li>
      ...
      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Alimentos balanceados</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Suplementos energéticos</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Mejoradores de palatabilidad</li>
      </ol>
