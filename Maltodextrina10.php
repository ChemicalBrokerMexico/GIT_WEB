...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;">search</i></a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/SOPA_INSTANTEA.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Maltodextrina 10</b><br></h1>
              <div class="container">
    ...
    <div class="container" style="margin-top:130px;">
        <div class="row">
            ...
            <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Products_News.php"><b class="Tipografia--general Subtitulos" style="color:black;">Productos > </b></a><a class="active" href="Maltodextrina10.php"><b class="Tipografia--general Subtitulos" style="color:red;">Maltodextrina 10</b></a></section>
                <h2 class="Tipografia--general letranegro Titulos" style="margin-top:50px;"><b>Maltodextrina 10</b></h2>
                <p class="Tipografia--general letranegro General--Cuerpo">La maltodextrina DE 10 es un polisacárido obtenido a partir de la hidrólisis parcial del almidón (generalmente de maíz), caracterizado por un bajo grado de hidrólisis (DE 10). Se presenta como un polvo blanco, de sabor neutro o ligeramente dulce.</p>
                <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Gracias a su baja dulzura, alta solubilidad y capacidad como agente de carga, es ampliamente utilizada en la industria alimentaria, farmacéutica y nutracéutica para mejorar la textura, estabilidad y volumen de diversas formulaciones.</p>
                
                <h2 class="Tipografia--general letranegro Titulos" style="margin-top:50px;"><b>Características del producto</b></h2>

                <ol>
                    <li class="Tipografia--general Elementos--Listas">Bajo dulzor: Ideal para formulaciones donde no se desea alterar el perfil de sabor</li>
                    <li class="Tipografia--general Elementos--Listas">Excelente agente de carga (bulking agent)</li>
                    <li class="Tipografia--general Elementos--Listas">Mejora la textura y cuerpo de los productos</li>
                    <li class="Tipografia--general Elementos--Listas">Alta estabilidad en procesos térmicos</li>
                    <li class="Tipografia--general Elementos--Listas">Buena dispersibilidad y rápida disolución</li>
                    <li class="Tipografia--general Elementos--Listas">Control de viscosidad en formulaciones líquidas</li>
                    <li class="Tipografia--general Elementos--Listas">Reduce cristalización en alimentos</li>
                    <li class="Tipografia--general Elementos--Listas">Portador de ingredientes activos (sabores, vitaminas, etc.)</li>
                </ol>
                ...
                <ol>
                    <li class="Elementos--Listas Tipografia--general">Bebidas en polvo y listas para beber</li>
                    <li class="Elementos--Listas Tipografia--general">Sopas y salsas instantáneas</li>
                    ...
                    <li class="Elementos--Listas Tipografia--general">Snacks y alimentos procesados</li>
                </ol>
                ...
                <ol>
                    ...
                    <li class="Elementos--Listas Tipografia--general">Proteínas en polvo</li>
                    <li class="Elementos--Listas Tipografia--general">Ganadores de masa</li>
                </ol>
