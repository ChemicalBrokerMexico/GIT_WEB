...
<head>
  ...
  <title>Chemical Broker | Bicar Pharma API de Solvay | Proveedor Global y Nacional de Bicar Pharma API</title>
  <meta name="description" content="Bicar Pharma API de alta pureza para formulaciones farmacéuticas. Ingrediente activo confiable, estable y con cumplimiento regulatorio para desarrollos seguros y de calidad">
...
<li><a href="Catalogos_Producto.php" class="Tipografia--general letranegro Subtitulos">Catalogos</a></li> 
          </li>
        </ul>
...
<li tabindex="0"><a href="Sistema de Gestión Integral.php" class="Tipografia--general letranegro Subtitulos">Sistema de Gestión Integral</a></li>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
  ...
  <div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12">
            <h2 class="letranegro Tipografia--general Titulos" style="width:535px;"><b style="color:#071637;">Bicarbonato de Sodio (Ingrediente Farmacéutico Activo)</b></h2>
        </div>
        ...
        <div class="col s12 m12 l12 xl12">
            ...
            <div style="border:1px solid #071637;border-radius:15px;height:500px;">
                ...
                <ol>
                    ...
                    <ol>
                       <a href="PDF/SOLVAY_PDS_BICARPHARMA-API_010416.pdf" download><li style="list-style-type:circle;color:#071637" class="arrowblue"">SOLVAY_PDS_BICARPHARMA-APL_010416.pdf</li></a>
                    </ol>
                </ol>
            </div>
            </div>
