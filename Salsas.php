...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12">
            <h2 class="Tipografia--general letranegro General--Cuerpo">La industria de las salsas</h2>
            ...
            <ol>
                <li>Importancia económica y cultural
                    <ol>
                        <li>Diversidad de productos: Incluye salsas picantes, dulces, ácidas, a base de tomate, crema, aceite y más</li>
                        <li>Mercado Global: Países como Estados Unidos, México, India, China e Italia destacan por su contribución a esta industria.</li>
                        <li>Consumo creciente: El cambio hacia alimentos preparados y convenientes ha aumentado la demanda de salsas listas para usar.</li>
                    </ol>
                </li>
            </ol>

            <ol>
                <li>Segmentación del mercado
                    <ol>
                        <li> Por tipo de producto
                            <ol>
                                <li>Salsas tradicionales:
                                    <ol>
                                        <li>Salsas mexicanas (guacamole, salsa roja, verde).</li>
                                        <li>Salsas italianas (pomodoro, pesto).</li>
                                        <li>Salsas asiáticas (soja, teriyaki, tamarindo, curry).</li>
                                    </ol>
                                </li>
                            </ol>
                        </li>
            ...
            <ol>
                <li>Salsas para pasta:
                    <ol>
                        <li>A base de tomate, queso, crema o hierbas.</li>
                    </ol>
                </li>
            </ol>
            ...
            <ol>
                <li>Salsas picantes:
                    <ol>
                        <li>Variedades como Tabasco, Sriracha, y productos artesanales.</li>
                    </ol>
                </li>
            </ol>

            <ol>
                <li> Salsas dulces y agridulces:
                    <ol>
                        <li>Usadas en marinados y acompañamientos (ej., salsa de arándano, BBQ).</li>
                    </ol>
                </li>
            </ol>

            <ol>
                <li>Salsas funcionales:
                    <ol>
                        <li>Enriquecidas con proteínas, vitaminas o bajas en calorías.</li>
                    </ol>
                </li>
            </ol>

            <ol>
                <li>Por canal de distribución
                    <ol>
                        <li>Retail: Supermercados, tiendas especializadas.</li>
                        <li>Food service: Restaurantes, cadenas de comida rápida, catering.</li>
                        <li>Mercado gourmet: Productos premium o artesanales.</li>
                    </ol>
                </li>
            </ol>
