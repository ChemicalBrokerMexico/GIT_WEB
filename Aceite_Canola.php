...
<head>
  ...
  <title>Chemical Broker | Aceite de Canola RBD | Proveedor Global</title>
  ...
  <script type="application/Id+json">
    {
      ...
      "description": "Aceite de canola RBD, Refinado, Blanqueado y Desodorizado de alta calidad. Ideal para aplicaciones alimenticias e industriales por su pureza y versatilidad. Descubre más aquí.",
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/Aceite_Canola.php",
        "priceCurrency": "MXN",
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/CANOLA_ACEITE.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Aceite de Canola RBD</b><br></h1><b class="segundotitulo" style="font-size:26px"></b>
...
<div class="container" style="margin-top:130px;">
    <div class="row">
      ...
      <section style="margin-top:0px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Historia_Hechos.php"><b class="Tipografia--general Subtitulos" style="color:red;">Aceite de Canola RBD</b></a></section>
                ...
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;"><b>Refinación:</b> Se eliminan compuestos no deseados como fosfolípidos, ácidos grasos libres, ceras y otros materiales que pueden afectar la estabilidad y calidad del aceite.</li>
                    <li class="Elementos--Listas"><b>Blanqueo:</b> Se utiliza arcilla o carbón activo para eliminar pigmentos como la clorofila y carotenoides, logrando un aceite de color más claro.</li>
                    <li class="Elementos--Listas"><b>Desodorización:</b> Se somete a un proceso de destilación a alta temperatura y vacío para eliminar compuestos volátiles que producen olores o sabores fuertes, dejando un aceite más neutro.</li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b>Propiedades</b></h2>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;"><b>Color:</b> Claro, casi transparente.</li>
                    <li class="Elementos--Listas"><b>Sabor y olor:</b> Neutros</li>
                    <li class="Elementos--Listas"><b>Punto de humo:</b> Alto, lo que lo hace adecuado para freír y cocinar a altas temperaturas.</li>
                    <li class="Elementos--Listas"><b>Composición nutricional:</b> Rico en ácidos grasos monoinsaturados y bajo en grasas saturadas, además de contener omega-3 y vitamina E.</li>
                </ol>
                ...
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">El <b>Aceite de Canola RBD</b> es ampliamente utilizado en la preparación de alimentos debido a su sabor neutro, alto punto de humo y propiedades saludables.</li>
                    <li class="Elementos--Listas"><b>Cocción y fritura:</b> Ideal para freír, saltear y hornear debido a su resistencia al calor y baja generación de humo.</li>
                    <li class="Elementos--Listas"><b>Producción de margarinas y mantecas:</b> Base en la elaboración de grasas vegetales para untar o cocinar.</li>
                    <li class="Elementos--Listas"><b>Aderezos y salsas:</b> Usado en mayonesas, vinagretas y aderezos por su sabor ligero.</li>
                    <li class="Elementos--Listas"><b>Conservación de alimentos:</b> Se utiliza como recubrimiento para alimentos para prolongar su vida útil.</li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Industria Cosmética y Cuidado Personal:</b></h2>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">El aceite de canola RBD también es un ingrediente importante en productos cosméticos y de cuidado personal.</li>
                    <li class="Elementos--Listas"><b>Hidratantes y cremas:</b> Actúa como emoliente por su capacidad para retener la humedad en la piel.</li>
                    <li class="Elementos--Listas"><b>Productos capilares:</b> Se incluye en acondicionadores y tratamientos capilares debido a sus propiedades hidratantes y fortalecedoras.</li>
                    <li class="Elementos--Listas"><b>Jabones y lociones:</b> Usado como base vegetal por su textura ligera y sus beneficios para la piel.</li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Industria Farmacéutica:</b></h2>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">En esta área, se emplea como vehículo o excipiente para la elaboración de ciertos medicamentos y suplementos.</li>
                    <li class="Elementos--Listas"><b>Cápsulas blandas:</b> Se usa como base de aceite en cápsulas de suplementos alimenticios.</li>
                    <li class="Elementos--Listas"><b>Formulaciones tópicas:</b> Parte de cremas y pomadas farmacéuticas.</li>
                </ol>

                <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Aplicaciones industriales:</b></h2>

                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;"><b>Biocombustibles:</b> Es un insumo en la fabricación de biodiésel.</li>
                    <li class="Elementos--Listas"><b>Lubricantes y aceites técnicos:</b> Se emplea como lubricante ecológico en algunas maquinarias.</li>
                </ol>
