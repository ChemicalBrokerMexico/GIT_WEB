...
<meta name="description" content="Suministramos ingredientes y aditivos para el pan artesanal: mejoradores naturales, levaduras y suplementos que potencian sabor, textura y frescura en cada horneado.">
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/CBM_PAN_ARTESANAL_201124.jpg" style="height:400px;" alt="Historia Ascendente">
        ...
        <div class="row">
            ...
            <section style="margin-top:150px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Panificacion.php"><b class="Tipografia--general Subtitulos" style="color:black;">Mercados ></b></a> <a class="active" href="Panificacion.php"><b class="Tipografia--general Subtitulos" style="color:black;">Alimentos ></b></a> <a class="active" href="Panificacion.php"><b class="Tipografia--general Subtitulos" style="color:black;">Panificacion ></b> <a class="active" href="Panificacion.php"><b class="Tipografia--general Subtitulos" style="color:red;">Pan Artesanal</b></a></a></section>
                ...
                <ol>
                    ...
                    <li class="Elementos--Listas" style="margin-top:50px;">Ingredientes Naturales: Los panaderos priorizan el uso de ingredientes frescos y de origen local, harinas integrales, masas madre y semillas son comunes en este tipo de pan</li>
                    <li class="Elementos--Listas" style="margin-top:50px;">Sin aditivos ni conservantes: A diferencia del pan industrial, el artesanal no tiene conversantes quimicos, lo que lo convierte en un producto mas fresco y natural, aunque de menor duracion</li>
                ...
                <ol>
                    ...
                    <li class="Elementos--Listas" style="margin-top:50px;">Interés por la salud: Hay un auge en la demanda de panes con beneficios especificos, como los integrales, sin gluten o enrriquecidos con semillas y granos.</li>
