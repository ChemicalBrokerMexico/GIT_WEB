    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/CB_POPSTART_MALTODEXTRINA_080323.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h1><b class="segundotitulo" style="font-size:26px">Maltodextrina</b>
              <div class="container">
      <section style="margin-top:30px;"><a href="index.php" style="color:white !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Maltodextrina.php"><b class="Tipografia--general Subtitulos" style="color:red;">Maltodextrina</b></a></section>
    </div>
            </div>
          </li>
        </ul>
...
<h5 class="Tipografia--general letranegro General--Cuerpo Titulos"><b>Especificaciones</b></h5>
                ...
                <ol>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Aditivo
                        Económico</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Espesante
                    </li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">
                        Conservante. - aumenta la vida útil de los alimentos</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Humectante
                    </li>
                </ol>
                ...
                <ol>
                    ...
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Suplementos Alimenticios</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Fórmulas Lácteas Infantiles</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Postres</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Bebidas en polvo</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Snacks</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Panificación</li>
                    <br>
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Cervezas</li>
                    </ol>

                </ol>

                <ol style="margin-top:50px;">
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Agroquímicos:</li>
                    <ol style="margin-top:20px;">
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;">Insecticidas</li>
                    </ol>
                </ol>

                <ol style="margin-top:50px;">
                    <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;"><b>Productos:</b></li>
                    <ol style="margin-top:20px;">
                        <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;color:rgba(2 146 238 /99%);"><a href="Proximamente.php" class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b>Maltodextrina 10</b></a></li>
                        <br>
                        <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;color:rgba(2 146 238 /99%);"><a href="Proximamente.php" class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b>Maltodextrina 20</b></a></li>
                        <br>
                        <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;color:rgba(2 146 238 /99%);"><a href="Proximamente.php" class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b>Maltodextrina 30</b></a></li>
                    </ol>
                </ol>
