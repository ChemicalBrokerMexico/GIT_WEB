        ...
        <ul class="slides slides-pruea">
          <li><img src="img/CB_POPSTART_MALTODEXTRINA_080323.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Maltodextrina</b><br></h1>
              <div class="container">
...
<!-- <h5 class="Tipografia--general letranegro General--Cuerpo Titulos"><b>Especificaciones</b></h5>
                ...
                <ol style="margin-top:50px;">
                    ...
                    <ol style="margin-top:20px;">
                        <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;color:rgba(2 146 238 /99%);"><a href="Maltodextrina10.php" class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b>Maltodextrina 10</b></a></li>
                        <br>
                        <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;color:rgba(2 146 238 /99%);"><a href="Maltodextrina20.php" class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b>Maltodextrina 20</b></a></li>
                        <br>
                        <li class="letranegro Tipografia--General General--Cuerpo" style="list-style-type:disc;color:rgba(2 146 238 /99%);"><a href="Maltodextrina30.php" class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b>Maltodextrina 30</b></a></li>
                    </ol>
                </ol>
