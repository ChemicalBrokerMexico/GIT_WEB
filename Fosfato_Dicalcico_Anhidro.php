...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Chemical Broker | Fosfato Dicálcico Anhidro | Proveedor Global y Nacional de Fosfato Dicalcico Anhidro</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
...
<div class="container" style="margin-top:150px;">
    ...
    <h5 class="Tipografia--general letranegro General--Cuerpo breadfosfatos" style="background-color:#FF6600;padding:10px;color:white;font-size:35px;border-radius:10px"><b>Fosfato Dicálcico Anhidro</b></h5>
