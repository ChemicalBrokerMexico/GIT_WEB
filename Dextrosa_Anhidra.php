...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;">search</i></a></li>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/DEXTROSA_ANHIDRA_270426.jpg" style="height:800px;filter:brightness(0.9);" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Dextrosa Anhidra</b><br></h1>
              <div class="container">
  ...
  <div class="container" style="margin-top:130px;">
    <div class="row">
      ...
      <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Products_news.php"><b class="Tipografia--general Subtitulos" style="color:black;">Productos > </b></a><a class="active" href="Dextrosas.php"><b class="Tipografia--general Subtitulos" style="color:black;">Dextrosas > </b></a><a class="active" href="Dextrosa_Anhidra.php"><b class="Tipografia--general Subtitulos" style="color:red;">Dextrosa Anhidra</b></a></section>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b>Dextrosa Anhidra</b></h2>

      <p class="Tipografia--general letranegro General--Cuerpo">La dextrosa anhidra es un monosacárido puro (D-glucosa) obtenido a partir de la hidrólisis del almidón, caracterizado por no contener agua de cristalización. Se presenta como un polvo cristalino blanco, altamente soluble y de rápida asimilación.</p>
      <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Gracias a su alta pureza, estabilidad y rápida disponibilidad energética, es un ingrediente ampliamente utilizado en las industrias alimentaria, farmacéutica, nutracéutica y de fermentación. Su comportamiento funcional la convierte en una solución eficiente tanto como edulcorante como agente técnico en diversos procesos industriales.</p>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Caracteristicas del Producto</b></h2>
    
      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Alta estabilidad química: Ideal para formulaciones sensibles a la humedad</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Rápida disolución: Excelente para aplicaciones instantáneas</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Fuente energética inmediata: Absorción rápida en el organismo</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Versatilidad funcional: Actúa como edulcorante, agente de carga y sustrato</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Mejora procesos de fermentación: Favorece el crecimiento microbiano controlado</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Control de textura: Evita cristalización en productos alimenticios</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Compatibilidad amplia: Se integra fácilmente en múltiples formulaciones</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Certificaciones</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Grado alimenticio (Food Grade)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Grado farmacéutico (USP / EP / BP)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Certificación Kosher</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Certificación Halal</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">FSSC 22000 / ISO 22000 (seguridad alimentaria)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">ISO 9001 (gestión de calidad)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Non-GMO (según origen del almidón)</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Aplicaciones</b></h2>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Industria Alimentaria</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Bebidas energéticas e isotónicas</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Panificación y productos horneados</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Confitería (gomitas, caramelos, chocolates)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Lácteos y derivados</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Helados y postres congelados</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Industria Alimentaria</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Excipiente en tabletas y cápsulas</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Soluciones orales y jarabes</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Sueros de rehidratación</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Nutrición deportiva</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Suplementos energéticos</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Recuperadores post-entrenamiento</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Fórmulas de ganancia de masa</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Fermentación y biotecnología</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Producción de alcoholes</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Ácidos orgánicos (ácido láctico, cítrico)</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Medios de cultivo</li>
      </ol>

      <h2 class="Tipografia--general letranegro Titulos" style="margin-top:19px;margin-top:50px;"><b>Industria pecuaria</b></h2>

      <ol>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Suplementos nutricionales</li>
        <li class="Elementos--Listas Tipografia--general General--Cuerpo">Mejoradores de palatabilidad en alimento animal</li>
      </ol>
