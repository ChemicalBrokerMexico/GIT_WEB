              ...
              <ul class="collapsible elementos--cookies">
                <li>
                  <div class="collapsible-header letranegro Tipografia--general Botones">Cookies estrictamente
                    necesarias
                    <label>
                      <input class="filled-in float-right" type="checkbox" checked="checked" disabled="disabled" /><span
                ...
                <li>
                  <div class="collapsible-header Tipografia--general Botones letranegro">Cookies de rendimiento
                    <label>
                      <input class="filled-in float-right" type="checkbox" disabled="disabled" /><span
                        class="letranegro"> </span>
                    </label>
                  </div>
                  <div class="collapsible-body">
                  ...
                  <ul>
                    <p class="color--blanco"><b class="Tipografia--general Titulos">Politicas </b>
                      ...
                      <li> <a class="arrowblue Tipografia--general Subtitulos" href="Code_of_Conduct.php">Codigo de
                          conducta <i class="fas fa-long-arrow-alt-right desaparece" id="aparece"></i></a></li>
                      <li> <a class="arrowblue Tipografia--general Subtitulos"
                          href="PDF/CB_POLITICA_PRIVACIDAD_240521.pdf" download="download">Politica de Privacidad <i
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
  ...
  <ul class="sidenav fondo--color--corporativo" id="mobile-demo">
    ...
    <div class="divider"></div>
    <li> <a class="waves-effect waves-light color--blanco" href="VISTA/Principal.php" style="background-color:#c73e32;"
        id="LockBoton">Login<i class="material-icons right color--blanco"
          ...
          <div class="col s12 m12 l12 xl12 search" id="search2">
            <table class="search-table" id="searchTable2" style="width:100%;">
              ...
              <tbody class="center-align">
                ...
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Servicio_Total.php">Servicio Total </a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                ...
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Contact.php">Contacto </a></td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        ...
        <div class="caption center-align" style="z-index:3;position:relative;"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Chemical Broker</b><br></h1><b class="segundotitulo" style="font-size:26px;color:white;">Agroquimicos </b>
            </div>
          <li> 
        
             <video class="videos_mercados_AGRICULTURA" style="border-radius:10px;" autoplay="autoplay" loop="loop" muted defaultMuted >
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <p class="Tipografia--general General--Cuerpo" style="color:#006600;text-align: center;font-size:25px;">La industria Agroquímica es de suma importancia a nivel global, debido a que la mayor parte de ingredientes naturales para la preparación de alimentos, depende de ella para tener un correcto desarrollo</p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          ...
          <ol style="margin-top:30px;">
            ...
            <li style="list-style-type: disc;">Insecticidas de ingestión: Son ingeridos por los insectos y actúan despues de que el insecto los consume. Ejemplo incluyen insecticidas sistémicos y reguladores del crecimiento de insectos. </li>
            <li style="list-style-type: disc;">Insecticidas de fumigación: Se utilizan en forma gaseosa para eliminar plagas en espacios cerrados o áreas de almacenamiento. </li>
          </ol>
          <h2 class="Tipografia--general General--Cuerpo letranegro" style="margin-top:50px;">Clasificación por origen y composición</h2>
          <ol>
            <li class="Elementos--Listas">Insecticidas químicos : Basados en compuestos químicos sintéticos diseñados para ser tóxicos para los insectos </li>
            <li class="Elementos--Listas">Insecticidas Biológicos: Derivados de microorganismos, extractos vegetales o compuestos naturales que controlan las plagas de manera selectiva y respetuosa con el medio ambiente.</li>
            <li class="Elementos--Listas">Insecticidas botánicos: Derivados de extractos de plantas con propiedades insecticidas, como piretrinas (naturales) y neem (azadiractina)</li>
          </ol>
          <h2 class="Tipografia--general General--Cuerpo letranegro" style="margin-top:50px;">Funciones y Aplicaciones</h2>
          <ol>
            <li class="Elementos--Listas">Protección de cultivos agrícolas: Los insecticidas protegen los cultivos de insectos que causan daños, como gusanos, pulgones, escarabajos y ácaros, permitiendo rendimientos mas altos y una mejor calidad de los cultivos.</li>
            <li class="Elementos--Listas">Control de vector de enfermedades: Los insecticidas también se utilizan para controlar insectos vectores que transmiten enfermedades animales y humanas, como mosquitos y garrapatas.</li>
          ...
          <ol>
            <li class="Elementos--Listas">
              Organofosforados
              <ol style="margin-top:30px;">
                <li style="list-style-type:disc;">Estos compuestos hacen referencia a un grupo de insecticidas que actúan sobre la enzima acetilcolinesterasa (el grupo de pesticidas de los carbamatos también actúa sobre esta encima, pero en un mecanismo diferente)</li>
              </ol>
            </li>
            <li class="Elementos--Listas" style="margin-top:30px;">
              Organoclorados
              <ol style="margin-top:30px;">
                <li style="list-style-type:disc;">Esta familia química hace referencia a un amplio grupo de compuestos químicos orgánicos que contiene cloro, además de otros elementos químicos, muchos insecticidas poderosos y efectivos son compuestos organoclorados.</li>
              </ol>
            </li>
            <li class="Elementos--Listas" style="margin-top:30px;">
              Carbamatos
              <ol style="margin-top:30px;">
                <li style="list-style-type:disc;">o	Los carbamatos presentan las mismas características que los organofosforados, pero con una toxicidad menor. Uno de ellos, el aldicarbe, usado frecuentemente en la agricultura, es muy soluble.</li>
              </ol>
            </li>
            <li class="Elementos--Listas" style="margin-top:30px;">
              Triazinas 
              <ol style="margin-top:30px;">
                <li style="list-style-type:disc;">La mayoría son utilizados en programas de control selectivos para malas hierbas. Como herbicidas, las triazinas pueden ser usadas solas o en combinación con otros ingredientes activos para incrementar el espectro de control de las malas hierbas.</li>
              </ol>
            </li>
          </ol>
