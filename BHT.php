        ...
        <ul class="slides slides-pruea">
          <li><img src="img/CB_BHT_230524.jpg" style="height:800px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h1><b class="segundotitulo" style="font-size:26px">BHT (Butilhidroxitolueno)</b>
              <div class="container">
      <section style="margin-top:30px;"><a href="index.php" style="color:white !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="BHT.php"><b class="Tipografia--general Subtitulos" style="color:red;">BHT (Butilhidroxitolueno)</b></a></section>
    </div>
            </div>
          </li>
        </ul>
