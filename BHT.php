        ...
        <div class="nav-wrapper flex"><a class="sidenav-trigger" href="#" data-target="mobile-demo"><i
            ...
            <ul class="hide-on-med-and-down">
                ...
                <ul id="dropdown3" class="dropdown-content">
                    <li><a href="Productos_news.php" class="Tipografia--general letranegro Subtitulos"> Familias
                            </a>
                    </li>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/CB_BHT_230524.jpg" style="height:800px;" alt="Historia Ascendente">
    ...
    <div class="container" style="margin-top:130px;">
        <div class="row">
            ...
            <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Products_news.php"><b class="Tipografia--general Subtitulos" style="color:black;">Productos > </b></a><a class="active" href="BHT.php"><b class="Tipografia--general Subtitulos" style="color:red;">BHT (Butilhidroxitolueno)</b></a></section>
...
<!-- 
                ...
                <table class="display" id="table_id2" name="table_id2"
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;background-color:#FFCCCC;color:black;"
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;text-align:center;"
                            class="table_bha_mobile">
                            <img src="img/CBMX_FORMULA-QUIMICA_BUTILHIDROXITOLUENO.png" alt="" width="30%">
                        </td>
                    </tr>

                    <tr class="Tipografia--general General--Cuerpo"
                        style="padding:10px;font-size:15px !important;width:150px;">
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;background-color:#FFCCCC;color:black;"
                            class="table_bha_mobile">
                            <b>Nombre IUPAC:</b>
                        </td>
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">
                            2, 6-bis(1, 1-dimetiletil)-9-4-metilfenol</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile"><ol>
                                <li style="list-style-type:disc;">Dibutilhidroxitolueno</li>
                                <li style="list-style-type:disc;">Hidroxitolueno Butilado</li>
                            </ol></td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;text-align:center;"
                            class="table_bha_mobile"><img src="img/CBMX_FORMULA-ESTRUCTURAL_BUTILHIDROXITOLUENO.png" alt="" width="30%"></td>
                    </tr>


                    <tr class="Tipografia--general General--Cuerpo"
                        style="padding:10px;font-size:15px !important;width:150px;">
                        <td style="font-size:15px !important;border:1px solid #C0C0C0;background-color:#FFCCCC;color:black;"
                            class="table_bha_mobile">
                            <b>Numero CAS:</b>
                        </td>
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%"
                            class="table_bha_mobile">128-37-0</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">204-881-4</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;"
                            class="table_bha_mobile">GO7875000</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">34247</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">CHEMBL146</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">31404</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">1P9D0Z171K</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">C14693 D02413 C14639</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">1,048 Kg./m</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">220,35 g/mol</td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile"><ol>
                                <li style="list-style-type:disc;">343,15 K (70 °C)</li>
                                <li style="list-style-type:disc;">346,15 K (73 °C)</li>
                            </ol></td>
                    </tr>
                    ...
                    <tr class="Tipografia--general General--Cuerpo"
                        ...
                        <td style="font-size:18px !important;border:1px solid #C0C0C0;width:50%;margin-bottom:0px"
                            class="table_bha_mobile">538 K (265 °C)</td>
                    </tr>
