    ...
    <div>
      <ul> <a class="waves-effect right btn-lock1" style="background-color:#c73e32;cursor:pointer;padding:10px;" href=""
          ...
          <div style="display:flex;justify-content:center">
            <p class="Botones Logindesktop Tipografia--general" style="align-self:center">Iniciar Sesión</p>
          </div>
        </a>
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/LECITINAS_4.jpg" alt="" style="height:800px;">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Lecitinas</b>
            </div>
          </li>
        </ul>
      </div>
...
<h5><b class="Tipografia--general letranegro Titulos">Lecitinas</b></h5>
  ...
  <div class="container">
    <div class="row">
      ...
      <h5 class="Tipografia--general letranegro General--Cuerpo"><b
        ...
        <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;margin-bottom:5px;"><b>Tipos</b></h5>
        ...
        <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Estado Regulatorio</b></h5>
  ...
  <!-- <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <h5 style="margin-top:0px;"><b class="Tipografia--general letranegro Titulos">Propiedades</b></h5>
        <ol style="margin-bottom: 0px;">
          <li class="Tipografia--general letranegro Elementos--Listas">Emulsionante natural</li>
          <li class="Tipografia--general letranegro Elementos--Listas">Agente espumante</li>
          <li class="Tipografia--general letranegro Elementos--Listas">Antioxidante</li>
          <li class="Tipografia--general letranegro Elementos--Listas">Homogeneizador</li>
          <li class="Tipografia--general letranegro Elementos--Listas">Nutriente</li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <h5 style="margin-top: 0px;"><b class="Tipografia--general letranegro Titulos">Industria y Aplicaciones</b></h5>
        <ol style="list-style-type: disc;">
          <li class="Tipografia--general letranegro Elementos--Listas">
            <b>Farmacéutica:</b>
          </li>
          <ol style="list-style-type: disc;margin-top: 15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para transtornos metabolicos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para arterioesclerosis</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamiento de enfermedades hepáticas y
              biliares</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para mejorar el funcionamiento del
              sitema nervioso</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Lubricante de supositorios </li>
            <li class="Tipografia--general letranegro Elementos--Listas">Estabilizador para suspensiones y emulsiones
            </li>
            <li class="Tipografia--general letranegro Elementos--Listas">Productos naturales / nutricionales</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para la ansiedad</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para la dermatitis</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para el colesterol alto</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Tratamientos para parkinson</li>
          </ol>
        </ol>

        <ol style="list-style-type: disc;">
          <li class="Tipografia--general letranegro Elementos--Listas"><b>Alimentos y Nutrición Humana:</b></li>
          <ol style="list-style-type: disc;margin-top:15px;">
        ...
        <ol style="list-style-type: disc;">
          <li><b>Cosmética y Cuidado Personal:</b></li>
          <ol style="list-style-type: disc;margin-top: 15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Cosméticos Naturales</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Lápiz de cejas</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Crema anti-edad</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Base de maquillaje</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Lápiz de ojos y khol</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Cosméticos para el cabello</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Cosméticos decorativos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Productos de limpieza para la piel</li>
          </ol>
        </ol>
        <ol style="list-style-type: disc;">
          <li><b>Alimentos y Nutrición Animal</b></li>
          <ol style="list-style-type: disc;margin-top: 15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para cerdos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para terneras</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para pollos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para gallinas</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para pavos</li>
             <li class="Tipografia--general letranegro Elementos--Listas">Alimento para conejos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para caballos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para acuicultura</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para perros y gatos</li>
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para animales de zoológico</li>
          </ol>
        </ol>
      </div>
    </div>
