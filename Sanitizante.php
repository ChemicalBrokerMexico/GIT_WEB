    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/CB_SANITIZANTE.jpg" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Sanitizantes</b>
            </div>
          </li>
        </ul>
      </div>
...
<div class="container">
  <div class="row">
    <div class="col s12 m12 l12 xl12">
      <h1 class="Tipografia--general letranegro General--Cuerpo"><b>Mercado de Sanitizantes</b></h1>
      <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Naturaleza del Mercado</b></h2>
      <p class="Tipografia--general letranegro General--Cuerpo" >Los sanitizantes son productos diseñados para:</p>
      <ol>
        <li class="Elementos--Listas">Reducir o eliminar microorganismos (bacterias, virus, hongos)</li>
        <li class="Elementos--Listas">Cumplir estándares de higiene específicos</li>
        <li class="Elementos--Listas">Actuar en superficies, piel o sistemas industriales</li>
      </ol>

      <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Ingredientes Químicos Utilizados en Sanitizantes</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Alcoholes</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo">Funciones:</h2>

      <ol>
        <li class="Elementos--Listas">Desnaturalizan proteínas de microorganismos</li>
        <li class="Elementos--Listas">Acción rápida</li>
      </ol>

      <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Ácidos orgánicos</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo">Funciones:</h2>

      <ol>
        <li class="Elementos--Listas">Penetración en la membrana celular del microorganismo</li>
        <li class="Elementos--Listas">Disociación dentro de la célula</li>
      </ol>
