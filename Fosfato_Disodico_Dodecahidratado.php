...
<div class="container" style="margin-top:150px;">
    ...
    <h5 class="Tipografia--general letranegro General--Cuerpo breadfosfatos" style="background-color:#FF6600;padding:10px;color:white;font-size:29px;border-radius:10px"><b>Fosfato Disódico Dodecahidratado</b></h5>
...
<ol>
    ...
    <li class="Elementos--Listas" style="margin-top:30px;">Cristalización: Forma cristales incoloros o blancos en condiciones adecuadas de temperatura y concentración.</li>
    <li class="Elementos--Listas" style="margin-top:30px;">pH: Actúa como un regulador de pH, lo que significa que puede ayudar a mantener un pH específico en soluciones acuosas. Por lo general, tiene un pH ligeramente básico.</li>
    <li class="Elementos--Listas" style="margin-top:30px;">Agente quelante: Tiene la capacidad de unirse y neutralizar iones metálicos, actuando como un agente quelante. Esto lo hace útil en productos de limpieza y en procesos de tratamiento de aguas, donde ayuda a eliminar contaminantes metálicos.</li>
    <li class="Elementos--Listas" style="margin-top:30px;">Estabilidad: Es estable en condiciones normales de almacenamiento, pero puede degradarse en presencia de ácidos fuertes.</li>
    <li class="Elementos--Listas" style="margin-top:30px;">Higroscopicidad: Tiende a absorber humedad del aire, lo que puede afectar su fluidez y manipulación si no se almacena adecuadamente en un ambiente seco.</li>
    <li class="Elementos--Listas" style="margin-top:30px;">Uso en alimentos: Es aprobado por varias agencias reguladoras para su uso en alimentos como aditivo, donde actúa como estabilizante, emulsionante y regulador de pH.</li>
</ol>
