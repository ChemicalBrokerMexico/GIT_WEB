...
<li> <a class="elemennav-secun Tipografia--general letranegro Subtitulos dropdown-trigger" href="#!" data-target="dropdown3"><b>Productos<i class="material-icons right">arrow_drop_down</i></b></a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
        <p style="color:#262137"> México es el segundo páis que consume la mayor cantidad de dulces de america latina, solo por detras de brazil, esto de acuerdo con datos de la Camara de la Industria Alimenticia.
