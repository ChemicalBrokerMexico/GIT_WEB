...
<li tabindex="0"><a href="Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l6 xl6">
                <h5 class="Tipografia--general Titulos top--lecitinas center-align"><b style="color:#071637;font-size:22px;">Política de Calidad</b></h5>
                ...
                <div class="col s12 m12 l6 xl6">
                <h5 class="Tipografia--general Titulos top--lecitinas center-align"><b style="color:#071637;font-size:22px;">Objetivos de Calidad</b></h5>
