...
<head>
  ...
  <title>Chemical Broker | Medicamentos de Prescripcion </title>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/medicamento_prescripcion_210624.jpg" style="height:500px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Medicamentos de Prescripcion</b><br></h1>
              <div class="container">
