...
<head>
  ...
  <title>Chemical Broker | Aceite de Soya RBD | Proveedor Global y Nacional de Ingredientes Quimicos</title>
    ...
    <div class="row">
      ...
      <section style="margin-top:0px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Products_news.php"><b class="Tipografia--general Subtitulos" style="color:black;"> Productos ></b></a><a class="active" href="Aceite_RBD.php"><b class="Tipografia--general Subtitulos" style="color:red;">Aceite de Soya RBD</b></a></section>
        ...
        <ol style="margin-top:30px;">
            <li class="Elementos--Listas"><b>Refinado. -</b> El aceite crudo de soya se somete a un proceso de refinado para eliminar impurezas como sólidos, gomas y fosfolípidos. Este proceso generalmente involucra la neutralización del aceite con soda caustica o acido fosfórico, seguido de la separación de los compuestos no deseados.</li>
            <li class="Elementos--Listas" style="margin-top:50px;"><b>Desodorizado. -</b> Después del refinado, el aceite se somete a un proceso de desodorización para eliminar o reducir los compuestos que pueden darle un olor no deseado. La desodorización se realiza mediante calor y vació para eliminar los compuestos volátiles. </li>
            <li class="Elementos--Listas" style="margin-top:50px;"><b>Blanqueado. -</b> En esta etapa, el aceite se trata con arcillas absorbentes para eliminar cualquier color no deseado o pigmentos presentes en el aceite. El blanqueo también ayuda a eliminar algunas impurezas residuales.</li>
        </ol>
