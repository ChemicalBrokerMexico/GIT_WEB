...
<script type="application/Id+json">
    {
      ...
      "@type": "Product",
      "name": "Pectinas",
      "description": "Chemical Broker brinda a sus socios de negocio Pectinas de la mas alta calidad a nivel mundial del fabricante Cargill con el objetivo de satisfacer sus necesidades,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/Pectinas.php",
        "priceCurrency": "MXN",
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/MANZANA_VERDE_141222.jpg" style="height:800px;filter:brightness(0.9)" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Pectinas</b><br></h1>
              <div class="container">
    </div>
            </div>
          </li>
