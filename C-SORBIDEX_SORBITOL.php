...
<head>
  ...
  <script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc="
    ...
    <script type="application/Id+json">
    {
      ...
      "@type": "Product",
      "name": "C-Sorbidex Sorbitol",
      "description": "El C-Sorbidex Sorbitol es un poliol altamente versatil utilizado en formulaciones que requieren control de humedad, dulzor moderado textura mejorada y excelente estabilidad quimica.,
      "brand": {
        "@type": "Brand",
      ...
      "offers":{
        "@type": "Offer",
        "url": "https://chemicalbroker.mx/C-SORBIDEX_SORBITOL.php",
        "priceCurrency": "MXN",
...
<section><a class="active" href="#" style="color:black !important"><b
                                            ...
                                            class=" active" href="Sorbitoles.php" style="margin-left:-2px"><b
                                                class="Tipografia-general  Subtitulos" style="color:black;">Sorbitol > </b></a> <a
...
<p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>C-Sorbidex™</b> es un humectante excelente que proporciona una textura y una sensación en la boca suaves. Ayuda a mantener los productos suaves y húmedos durante una vida útil prolongada.</p>
</div>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12" style="margin-top:50px;">
            <h5 style="margin: 0px;"><b class="Tipografia--general letranegro Titulos" style="border-bottom: 3px solid #00e2f8">Aplicaciones</b></h5>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12" style="margin-top:50px;">
        <p style="margin: 0px;"><b class="Tipografia--general letranegro General--Cuerpo" style="border-bottom: 3px solid #00e2f8">Proceso de producción:</b></p>
<ol>
    ...
    <div class="row">
        ...
        <tbody>
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;border-right: 1px solid white;">Sorbitol 98%</td>
            <td style="text-align:center;border-right: 1px solid white;" id="prueba35">Powder</td>
            <td style="text-align:center;width:120px;border-right: 1px solid white;"></td>
            <td style="text-align:center;width:180px;border-right:1px solid white;"><b>C- Sorbidex ™ P</td>
          ...
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;border-right: 1px solid white;">Sorbitol 98%</td>
            <td style="text-align:center;border-right: 1px solid white;" id="prueba35">Granular</td>
            <td style="text-align:center;border-right: 1px solid white;"></td>
            <td style="text-align: center;width:180px;border-right:1px solid white;"><b>C-Sorbidex™S</td>
            <td style="text-align: center;border-right: 1px solid white;">Cargill</td>
            ...
            <td style="text-align: center;border-right: 1px solid white;"><ol style="padding-left: 24px;padding-right: 12px;">
            <li class="center-align Elementos--Listas">Bakery</li>
            <li class="center-align Elementos--Listas">Mixes</li>
            </ol></td>
          </tr>
        </tbody>
      </table>
