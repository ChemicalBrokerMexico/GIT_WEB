...
<p></p>
  ...
  <li><a href="Product_List.php" class="Tipografia--general letranegro Subtitulos">Lista de Productos</a></li>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
            ...
            <div class="col s12 m12 l12 xl12 search" id="search">
              <table class="search-table" id="searchTable" style="width:100%">
                ...
                <tbody class="center-aling">
                  ...
                  <tr>
                    <td class="border--hidden"><a class="letranegro border--hidden" href="Brand.php">Marca</a></td>
                  </tr>
                  <tr>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px;"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp</b><b>  >&nbsp     </b></a><a class="breditem active" href="Servicios.php" style="color: #262137 !important;margin-left: -2px;"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Servicios</b></a></section>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <p class="Tipografia--general letranegro General--Cuerpo"><b>Chemical Broker</b>, ha desarrollado un proceso integral de servicios, con el principal objetivo de ofrecer <b style="color:#071637">ingredientes químicos</b> de la más alta calidad, a través de una Cadena de Suministros Global, con operaciones de Comercio Internacional (Importaciones y Exportaciones), Logística (Transporte Aéreo, Marítimo, Terrestre y Centros de Distribución), así como de Coberturas de Seguros que mitiguen los riesgos implícitos en la operación.</p>
          ...
          <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px"><a href="Cadena_Suministro.php" style="cursor:pointer;">
              ...
              <div class="transfo" id="overlay" style="border-radius:10px"></div>
                ...
                <h5 class="titulo_submercado"><b class="titulo_submercado"> <span style="position:relative;z-index:2">Cadena de Suministros</span></b></h5><b> </b>
                <hr class="animacion">
                  <p><b style="color:white !important">
                  <p class="leer_mas_mercados center-align botones-logistics">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/CADENA_SUMINISTRO_BANNER_040123.jpg" alt="" style="border-radius:10px;filter:brightness(0.8)">
               
              </div></a></div>

              <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px"><a href="Logistica_Global.php" style="cursor:pointer;">
              <div class="contenedor">
              <div class="transfo" id="overlay" style="border-radius:10px"></div> 
                <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_submercado"><b class="titulo_submercado"> <span style="position:relative;z-index:2">Logística Global</span></b></h5><b> </b>
                <hr class="animacion">
                  <p><b style="color:white !important">
                  <p class="leer_mas_mercados center-align botones-logistics">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/LOGISTICA-GLOBAL_BANNER_040123.jpg" alt="" style="border-radius:10px;filter:brightness(0.8)">
             
              </div></a></div>

              <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px"><a href="Proximamente.php" style="cursor:pointer;">
              <div class="contenedor">
               <div class="transfo" id="overlay" style="border-radius:10px"></div> 
                <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_submercado"><b class="titulo_submercado"> <span style="position:relative;z-index:2">Comercio Internacional</span></b></h5><b> </b>
                <hr class="animacion">
                  <p><b style="color:white !important">
                  <p class="leer_mas_mercados center-align botones-logistics">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/COMERCIO-INTERNACIONAL_BANNER_040123.jpg" alt="" style="border-radius:10px;filter:brightness(0.8)">
              </div></a></div>
              ...
              <div class="contenedor">
               <div class="transfo" id="overlay" style="border-radius:10px"></div> 
                <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_submercado"><b class="titulo_submercado"> <span style="position:relative;z-index:2">Coberturas de Riesgos</span></h5></b><b> </b>
                <hr class="animacion">
                  <p><b style="color:white !important">
                  <p class="leer_mas_mercados center-align botones-logistics">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/COBERTURA-RIESGOS_BANNER_040123.jpg" alt="" style="border-radius:10px;filter:brightness(0.8)">
    ...
    <!-- <div class="container">
      <div class="row" style="margin-top:5px">
        <div class="col s12 m12 l6 xl6 mercados zoom" >
            <div class="contenedor">
              <div class="transfo" id="overlay" style="border-radius:10px"></div>
              <div class="centrado_sub" style="position:absolute;z-index:20">
                <h5 class="titulo_logistica"></h5><b class="titulo_logistica"> <span style="position:relative;z-index:20">Cadena de <br/>Suministros</span></b><b> </b>
                <hr class="animacion"/>
              </div><img class="mercadosimagen" src="img/CADENA_SUMINISTRO_PRINCIPAL_061022.jpeg" alt="" style="border-radius:10px"/>
            </div></div>
        <div class="col s12 m12 l6 xl6">
          <h6> -->
            <!-- <p class="Tipografia--general Botones letranegro" style="text-align:justify">Para Chemical Broker una cadena de suministro eficiente, es responsable de una adecuada administración de los “procesos operativos” involucrados en la Servicios de Ingredientes Químicos para nuestros “Socios de Negocios”.</p> -->
            <!-- <p class="Tipografia--general Letranegro Tipografia--general" style="font-size:16px;">Nuestra Cadena de Suministros contempla como elementos principales:</p>
            <ol>
              <li class="Tipografia--general Letranegro Elementos--listas" style="list-style-type:decimal;">Materias Primas</li>
              <br>
              <li class="Tipografia--general Letranegro Elementos--listas" style="list-style-type:decimal;">Produccion / Proveedores</li>
              <br>
              <li class="Tipografia--general Letranegro Elementos--listas" style="list-style-type:decimal;">Transporte Logistico</li>
              <br>
              <li class="Tipografia--general Letranegro Elementos--listas" style="list-style-type:decimal;">Centros de distribucion / Almacen</li>
              <br>
              <li class="Tipografia--general Letranegro Elementos--listas" style="list-style-type:decimal;">Punto de Venta </li>
              <br>
              <li class="Tipografia--general Letranegro Elementos--listas" style="list-style-type:decimal;">Cliente final / Consumidor</li>
            </ol> -->
            <!-- <p class="Tipografia--general Botones letranegro" style="text-align:justify">Nuestra Cadena de Suministros contempla (como elementos) dentro de sus elementos principales la Administracion, la Gestion, el Suministro, la Fabricación y la distribución para llevar de un lugar a otro ingredientes químicos de la más alta calidad global.</p> -->
            <!-- <p class="Tipografia--General Botones letranegro">Para llevar de nuestros proveedores a nuestros clientes ingredientes químicos en óptimas condiciones de calidad, presentación e inocuidad.</p>
            <p class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b class="arrowblue"><a href="Cadena_Suministro.php" style="color:rgba(2 146 238 /99%) !important;">Leer Mas</a><span class="arrowblue desaparece">...</span></b></p>
          </h6>
        </div>
      </div>
    </div> -->
      ...
      <div class="row" style="margin-top:5px">
        <div class="col s12 m12 l6 xl6 mercados zoom">
            <div class="contenedor">
              <div class="transfo" id="overlay" style="border-radius:10px"></div>
              <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_logistica"></h5><b class="titulo_logistica"> <span style="position:relative;z-index:20">Logística <br/>Global</span></b><b> </b>
                <hr class="animacion"/>
              </div><img class="mercadosimagen" src="img/LOGISTICS_290822.jpg" alt="" style="border-radius:10px"/>
            </div></div>
        <div class="col s12 m12 l6 xl6">
          <h6>
            <p class="Tipografia--general Botones letranegro" style="text-align:justify;">Nuestro objetivo es brindar un servicio integral de Servicios para cumplir de forma adecuada las necesidades y expectativas de nuestros clientes en la obtención de productos químicos.</p>
            <p class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b class="arrowblue"><a href="Proximamente.php" style="color:rgba(2 146 238 /99%) !important;">Leer Mas</a><span class="arrowblue desaparece">...</span></b></p>
          </h6>
        </div>
      </div>
    </div> -->
      ...
      <div class="row" style="margin-top:5px">
        <div class="col s12 m12 l6 xl6 mercados zoom">
            <div class="contenedor">
              <div class="transfo" id="overlay" style="border-radius:10px"></div>
              <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_logistica"></h5><b class="titulo_logistica"> <span style="position:relative;z-index:2">Comercio  <br/>Internacional</span></b><b> </b>
                <hr class="animacion"/>
              </div><img class="mercadosimagen" src="img/IMPORTACION_EXPORTACION_240822_V3.jpg" alt="" style="border-radius:10px"/>
            </div></div>
        <div class="col s12 m12 l6 xl6">
          <h6>
            <p class="Tipografia--general letranegro General--Cuerpo">Chemical Broker en cumplimiento con las regulaciones y legislaciones mundiales en materia de importación y exportación ofrece a sus socios de negocios, procesos eficientes relacionados al comercio internacional.</p>
            <p class="Tipografia--general letranegro General--Cuerpo"> El Comercio Internacional es la puerta de entrada y salida de transacciones globales de compra y venta de ingredientes químicos, su crecimiento ha sido exponencial en las últimas décadas, debido acuerdos internacionales entre naciones.</p>
            <p class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b class="arrowblue"><a href="Proximamente.php" style="color:rgba(2 146 238 /99%) !important;">Leer Mas</a><span class="arrowblue desaparece">...</span></b></p>
            </p>
          </h6>
        </div>
      ...
      <div class="row" style="margin-top:5px">
        <div class="col s12 m12 l6 xl6 mercados zoom">
            <div class="contenedor">
              <div class="transfo" id="overlay" style="border-radius:10px"></div>
              <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_logistica"></h5><b class="titulo_logistica"> <span style="position:relative;z-index:2">Coberturas  <br/>de Riesgos</span></b><b> </b>
                <hr class="animacion"/>
              </div><img class="mercadosimagen" src="img/CB_INSURANCE_100322.jpg" alt="" style="border-radius:10px"/>
            </div></div>
        <div class="col s12 m12 l6 xl6">
          <h6>
            <p class="Tipografia--general letranegro General--Cuerpo">Chemical Broker considera en su política de Servicio Integral y Riesgo “0” ofrecer a sus socios de negocios una Logística Global libre de riesgos externos, por medio de la contratación de coberturas de seguros con las principales casas aseguradoras en el mundo, previniendo eventos desafortunados como desastres naturales, delincuencia o cualquier otra situación que afecte la integridad del producto.</p>
            <p class="arrowblue Tipografia--general letranegro" style="color:rgba(2 146 238 /99%);"><b class="arrowblue"><a href="Proximamente.php" style="color:rgba(2 146 238 /99%) !important;">Leer Mas</a><span class="arrowblue desaparece">...</span></b></p>
          </h6>
        </div>
      </div>
