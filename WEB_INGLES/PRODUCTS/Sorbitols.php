...
<head>
  ...
  <title>Chemical Broker | Sorbitol del Fabricante Cargill</title>
  <meta name="description" content="Los ácidos grasos se derivan de grasas y aceites animales como el sebo de res y de diversos aceites vegetales.">
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/pasta-dientes-fluor.jpg" alt="" style="height:400px;">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Sorbitoles</b>
            </div>
          </li>
        </ul>
      </div>
...
5780
          ...
          <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;margin-bottom:0px;">Entre los diferentes endulzantes o edulcorantes se
          encuentran aquellos sin calorías y otro sub-grupo denominado azúcares alcoholes o polialcoholes dentro de los
          cuales se encuentra el <b style="color: #262137;">Sorbitol.</b></p>

           
        <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;;margin-bottom:0px;">El <b style="color: #262137;">Sorbitol</b> es un
          endulzante utilizado en la industria alimenticia, cosmética y farmacéutica. Es un polialcohol o azúcar alcohol
          junto al xilitol y maltitol; de allí su alta estabilidad ante temperaturas elevadas o el calor, así como
          resistente a la acción de diferentes microorganismos, razón por la cual tiene mayor vida útil que el azúcar.
        </p>

        <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;margin-bottom:0px;">Por estas razones el
          <b>Sorbitol</b> es una opción muy
          valiosa para usar en la industria alimenticia y también para saborizar fármacos o pastas dentales, tiene menor
          poder cariogénico que los azúcares comunes de allí su ventaja en productos para la higiene bucal.</p>

          <h5 style="margin-top:50px;"><b class="Tipografia--general letranegro Titulos">Uso</b></h5>

          <p class="Tipografia--general letranegro General--Cuerpo" style="margin-bottom:0px;">El <b style="color: #262137;">Sorbitol</b> se utiliza
          en la industria alimentaria como edulcorante. Legalmente está calificado como aditivo alimentario, con el
          código E-420 en los países de la Unión Europea.</p>

          <p class="Tipografia--general letranegro General--Cuerpo" style="margin-bottom:0px;margin-top:50px;">Su hidrofilicidad hace que
          ...
          cuando se utiliza como humectante.</p>

          <h5 style="margin-top:50px;margin-bottom:0px;"><b class="Tipografia--general letranegro Titulos">Empleo</b></h5>

          
        <p class="Tipografia--general letranegro General--Cuerpo" style="margin-bottom:0px;">El <b
            style="color: #262137;">Sorbitol</b> se emplea
          como edulcorante en los alimentos dietéticos. Se le califica como edulcorante nutritivo porque cada gramo
          contiene 2,4 calorías, bastante menos que las 4 de la sacarosa o el almidón. Es el edulcorante que contienen
          generalmente los chicles "sin azúcar", dado que como no puede ser metabolizado por las bacterias bucales, no
          induce la aparición de caries. El organismo humano absorbe el <b>Sorbitol</b> lentamente, por lo que la
          ingestión de grandes cantidades puede producir problemas gastrointestinales, especialmente diarrea osmótica.
          En Estados Unidos, aquellos productos cuyo consumo habitual pueda llevar a ingerir más de 50 gramos de
          <b>Sorbitol</b> al día deben llevar la advertencia “El consumo excesivo puede tener un efecto laxante”.
        </p>
          
        <h5 style="margin-top:50px;"><b class="Tipografia--general letranegro Titulos">Propiedades</b></h5>

        
        <ol style="margin-bottom:0px;">
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Absorbente,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Acondicionador,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Agente anti-cristalizante,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Agente Corporal,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Agente de carga,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Agente de Enmascaramiento del sabor,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Agente Secuestrante,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Aglutinante,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Anti-fermentación,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Emoliente,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Emulsionante,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Estabilizante,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Formador de películas,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Hidrosoluble,</li>
          <br>
          <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;">Humectante.</li>
        </ol>

        <h5 style="margin-bottom:0px;margin-top:50px;"><b class="Tipografia--general letranegro Titulos">Industrias y Aplicaciones</b></h5>
        ...
        <ol style="list-style-type: disc;margin-bottom:0px;">
          ...
          <ol style="list-style-type: disc;margin-top:15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Cremas de uso típico,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Jarabes,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Pastillas para la tos,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Supositorios,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Utilizado para combatir glaucoma,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Utilizado para combatir hidrocefalia,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Vitamina C.</li>
          </ol>
        </ol>
        ...
        <ol style="list-style-type: disc;margin-top:50px;margin-bottom:0px">
          ...
          <ol style="list-style-type: disc;margin-top:15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Bebidas preparadas,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Caramelos blandos,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Chicle,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Chocolates,</li>
            <br>
            ...
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Mezclas para hornear,</li>
            <br>
            ...
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Soda light,</li>
          </ol>
        </ol>
        ...
        <ol style="list-style-type: disc;margin-top:50px;margin-bottom:0px;">
          <li class="Tipografia--general letranegro Elementos--Listas"><b>Nutrición Animal:</b></li>
          <ol style="list-style-type: disc;margin-top:15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Alimento para perros,</li>
            <br>
        ...
        <ol style="list-style-type: disc;margin-bottom:0px;margin-top:50px;">
          <li class="Tipografia--general letranegro Elementos--Listas"><b>Pintura y Recubrimientos:</b></li>
          <ol style="list-style-type: disc;margin-top:15px;">
            <li class="Tipografia--general letranegro Elementos--Listas">Adhesivos,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Espuma rígida,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Pinturas,</li>
            <br>
            <li class="Tipografia--general letranegro Elementos--Listas">Termoplásticos.</li>
          </ol>
        </ol>

        <h5 class="center-align" style="margin-top:50px;margin-bottom:0px;"><b class="Tipografia--general letranegro">"El Sorbitol es un edulcorante no
        ...
        <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;margin-bottom:0px;"><b>Fabricante:</b></h5>

        <img src="img/Cargill-Logo_2.png" alt="Cargill Logo" class="cargill-logo">

        <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;margin-bottom:0px;"><b>Línea de Productos Cargill</b></h5>


        <ol style="list-style-type:circle;margin-top:50px;margin-bottom:0px;">
          <a href="C-PHARM_SORBIDEX_SORBITOL.php"><li class="Tipografia--general letranegro Elementos--Listas arrowblue" style="color:rgba(2 146 238 /99%);">C-PHARM™SORBIDEX SORBITOL &nbsp<span class="arrowblue desaparece">Leer Mas...</span></li></a>
          <br>
          <a href="C-SORBIDEX_SORBITOL.php"><li class="Tipografia--general letranegro Elementos--Listas arrowblue" style="color:rgba(2 146 238 /99%);">C-SORBIDEX™ SORBITOL &nbsp<span class="arrowblue desaparece">Leer Mas...</span></li></a>
        </ol>

        <hr style="border: 1px solid #a7a7a7;margin-top:50px;margin-bottom:0px">
        <h5><b class="Tipografia--general letranegro Titulos">Referencias:</b></h5>
        <ol style="margin-bottom:0px;">
          <li class="Tipografia--general letranegro Elementos--Listas">Escobar Gutiérrez A.J. 1995. Photosynthèse,
            partition du carbone et métabolisme du sorbitol dans les feuilles adultes de pêcher (Prunus persica (L.)
            Batsch). Thèse de Doctorat de l'Université de Poitiers, France.</li>
            <br>
          <li class="Tipografia--general letranegro Elementos--Listas">Sorbitol. Calorie Control Council</li>
        </ol>
