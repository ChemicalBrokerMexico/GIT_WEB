...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Regulatory Framework</a></li>
        ...
        <section class="breditem--inicio"><a class="breditem active" href="index.php"
            ...
            href="Productos_news.php" style="color:#262137 !important;margin-left:-2px"><b>Productos</b><b> >
              ...
              style="color:#262137 !important;margin-left:-2px"><b
                class="Tipografia--general letranegro Subtitulos breadcrumb">Colágeno Hidrolizado</b></a></section>
        </section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
        ...
        <p class="letranegro Tipografia--general General--Cuerpo" style="margin-top:50px;">También tiene un efecto sobre las articulaciones, ya que las hidrata, lo que retrasa su proceso de degeneración.</p>
