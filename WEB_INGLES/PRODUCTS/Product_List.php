...
<head> 
    ...
    <link href="css/catalogue_prods.css" type="text/css" rel="stylesheet" media="screen,projection">
...
<div class="container" style="margin-top:50px;">
    ...
    <thead>
        <tr>
            <th class="center-align" style="background-color:#071637;color:white;border-right: 1px solid white;border-radius:10px;">Familia</th>
            <th class="center-align" style="background-color:#071637;color:white;border-right: 1px solid white;border-radius:10px;">Producto</th>
            <th class="center-align" style="background-color:#071637;color:white;border-right: 1px solid white;border-radius:10px;">CAS</th>
        </tr>
    </thead>
    <tbody>
       <?php
