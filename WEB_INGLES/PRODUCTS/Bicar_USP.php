    ...
    <div class="container-fluid">
        <div class="slider slider-prueba" style="margin-top:0px">
            <ul class="slides slides-pruea">
                <li> <img src="img/CB_BICAR_USP.jpg" alt=""  class="img-bicar-usp">
                    <div class="caption center-align"><br><br><br><br>
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b
                            class="segundotitulo" style="font-size: 26px;">BICAR® USP </b>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                ...
                <ol>
                    <li class="Elementos--Listas" style="list-style-type:disc;">Leudante,</li>
                    <br>
                ...
                <ol>
                    <li class="Elementos--Listas" style="list-style-type:disc;"><b style="color:#071637;">Farmaceutica</b>
                        <ol style="margin-top:15px;">
                            ...
                            <br>
                            <li class="Elementos--Listas" style="list-style:disc;">Alcalinizantes Urinarios,</li>
                            <br>
                            <li class="Elementos--Listas" style="list-style:disc;">Quemaduras por Ácidos,</li>
                        </ol>
                    </li>
                </ol>
                    ...
                    <li class="Elementos--Listas" style="list-style-type:disc;margin-top:50px;"><b style="color:#071637;">Nutrición Humana</b>
                        <ol>
                            <li class="Elementos--Listas" style="list-style-type:disc;margin-top:15px;">Panificacion
                                <ol style="margin-top:15px;">
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Repostería,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Galletas,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Bollería,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Postres,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Tartas,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Pastelería,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Pastas,</li>
                                    <br>
                                    <li class="Elementos--Listas" style="list-style-type:disc;">Cereales.</li>
                                </ol>
                            </li>
                        </ol>
                </ol>
                <ol style="margin-bottom:0px;">
                    <li class="Elementos--Listas" style="list-style-type:disc;margin-top:50px;">Lácteos
                        <ol style="margin-top:15px;">
                            <li class="Elementos--Listas" style="list-style-type:disc;">Cremas,</li>
                            <br>
                            <li class="Elementos--Listas" style="list-style-type:disc;">Quesos,</li>
                            <br>
                ...
                <ol style="margin-top:15px;margin-bottom: 0px;">
                    <li class="Elementos--Listas" style="list-style-type:disc;margin-top:50px;">Confiteria
                        <ol>
                            <li class="Elementos--Listas" style="list-style-type:disc;margin-top:15px">Dulces.</li>
                        </ol>
                ...
                <ol style="margin-top:50px;margin-bottom:0px;">
                    <li class="Elementos--Listas" style="list-style-type:disc;margin-top:15px;"><b style="color:#071637;">Cuidado Personal</b>
                        <ol style="margin-top:15px;">
                            ...
                            <br>
                            <li class="Elementos--Listas" style="list-style-type:disc;">Pastas Dentales,</li>
                        </ol>
                    </li>
                </ol>
                ...
                <h5 class="Tipografia--general letranegro Titulos" style="margin-top:50px;"><b>Proovedor:</b></h5>


                <table>
                    <tr style="border:none;">
                        <td>
                            <img src="img/SAOLVAY_LOGO.jpg" alt="Solvery Logo" class="SOLVEY_LOGO"
                    ...
                    <tr style="border:none;">
                        <td>
                            <h5 class="Tipografia--general letranegro"><a
                                    href="PDF/CATALOGUES/SOLVAY_TDS_BICAR-USP-FG-1-POWDER.pdf" style="">
                                    <li class="Tipografia--general letranegro Elementos--Listas"
                                        style="list-style-type:disc;color:rgba(2 146 238 /99%);margin-top:30px">
                                        SOLVAY_TDS_BICAR-USP-FG-1-POWDER.pdf</li>
                                </a></h5>
                            <h5 class="Tipografia--general letranegro"><a
                                    href="PDF/CATALOGUES/SOLVAY_PDS_BICAR-USP-GRADE-1.pdf">
                                    <li class="Tipografia--general letranegro Elementos--Listas"
                                        style="list-style-type:disc;color:rgba(2 146 238 /99%);margin-top:30px">
                                        SOLVAY_PDS_BICAR-USP-GRADE-1.pdf</li>
                                </a></h5>
                ...
                <!-- <h5 class="Tipografia--general letranegro Titulos" style="margin-top:50px;margin-bottom:0px;"><b>Catálogos</b></h5>

<a href="PDF/CATALOGUES/SOLVAY_FLYER_OPTIMOX-BHA.pdf"><li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type:disc;color:rgba(2 146 238 /99%);margin-top:30px">SOLVAY_FLYER_OPTIMOX-BHA.pdf</li></a> -->
