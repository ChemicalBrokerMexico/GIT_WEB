        ...
        <section class="breditem--inicio"><a class="breditem active" href="index.php"
            ...
            href="Productos_news.php" style="color:#262137 !important;margin-left:-2px"><b>Productos</b><b> >
              ...
              style="color:#262137 !important;margin-left:-2px"><b
                class="Tipografia--general letranegro Subtitulos breadcrumb">Dextrosa</b></a></section>
        </section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <table class="display" id="table_id2" name="table_id2" style="width:100%;border-spacing:2px 2px;border:none;margin-top:30px;margin-bottom:0px;margin-left:0px;margin-right:0px;">
        <tr>
          <td style="border:1px solid #c0c0c0;background-color:#071637;width:50%;color:white;font-size:18px"><b>Descripción Química:</b></td>
          <td style="border:1px solid #c0c0c0;font-size:18px">Dextrosas</td>
        </tr>
        <tr>
          <td style="border:1px solid #c0c0c0;background-color:#071637;color:white;font-size:18px"><b>Formula Estructural:</b></td>
        ...
        <tr>
          <td style="border:1px solid #c0c0c0;background-color:#071637;color:white;font-size:18px"><b>Formula Molecular:</b></td>
      ...
      <ol>
        ...
        <br>
        <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">No sujeto a inversión de azúcar</li>
        <br>
        <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Ligero calor negativo de solución.</li>
        <br>
        <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Alta fermentabilidad</li>
        <br>
      ...
      <br>
      <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Ingrediente para preparaciones de cultivo medio.</li>
      <br>
      <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Soporte para granulación de productos de fermentación.</li>
      <br>
      <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Bloque de construcción químico para tensioactivos de poliglucósido de alquilo</li>
      <br>
      <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Bloque de construcción químico para N-metilglucamina y sus derivados</li>
      <br>
      <li class="Tipografia--general letranegro General--Cuerpo" style="list-style-type:disc;">Bloque de construcción químico para el ácido glucoheptónico</li>
      <br>
