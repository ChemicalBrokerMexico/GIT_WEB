...
<meta name="description" content="Los alcoholes son compuestos orgánicos formados a partir de los hidrocarburos mediante la sustitución de uno o más grupos hidroxilo por un número igual de átomos de hidrógeno.">
<title>Chemical Broker | Alcoholes</title>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<section style="margin-top:30px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   > &nbsp</b></a><a class="breditem active" href="Productos_news.html" style="color:#262137 !important;margin-left:-2px"><b>Productos</b><b>   > &nbsp</b><a class="breditem active" href="Productos_news.html" style="color:#262137 !important;margin-left:-2px"><b>Alcoholes</b></a></section></section>
</div>
</div>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<h5><b class="Tipografia--general letranegro Titulos">Alcoholes</b></h5>
</div>
<div class="col s12 m12 l6 xl6">
<img src="img/ANTIOXIDANTS_051121.jpg" alt="" style="width:100%;margin-top:23px;">
</div>
<div class="col s12 m6 l6 xl6" style="margin-top:3px;">
<p  class="Tipografia--general letranegro General--Cuerpo">Los alcoholes son compuestos orgánicos formados a partir de los hidrocarburos mediante la sustitución de uno o más grupos hidroxilo por un número igual de átomos de hidrógeno. El término se hace también extensivo a diversos productos sustituidos que tienen carácter neutro y que contienen uno o más grupos alcoholes. </p>
<p  class="Tipografia--general letranegro General--Cuerpo">Estan formados por cadenas de carbono e hidrogeno donde al menos uno de los enlaces es un hidroxilo. Para reconocerlos basta con encontrar en la etiqueta los compuestos con terminacion -ol.</p>
<p class="Tipografia--general letranegro General--Cuerpo">Se utilizan como productos químicos intermedios y disolventes en las industrias de textiles, colorantes, química general, detergentes, perfumes, alimentos, bebidas, cosméticos, pinturas y barnices. Algunos compuestos se utilizan también en la desnaturalización del alcohol, en productos de limpieza, aceites y tintas de secado rápido, anticongelantes, agentes espumógenos y en la flotación de minerales.</p>
</div>
</div>

<div class="row">
<!-- <div class="col s12 m12 l12 xl12">
<p class="Tipografia--general letranegro General--Cuerpo">Se entendiéndose por oxidación no solo el ataque del oxígeno a una sustancia, sino más bien una reacción química por la cual se transfieren electrones desde una sustancia donante de electrones a otra susceptible de aceptarlos. La oxidación es por tanto una pérdida de electrones y tiene que ir acoplada a una reducción o aceptación de los electrones cedidos.</p>
<p class="Tipografia--general letranegro General--Cuerpo">Los antioxidantes desempeñan un papel fundamental garantizando que los alimentos mantengan su sabor y su color y puedan consumirse durante más tiempo. Su uso resulta especialmente útil para evitar la oxidación de las grasas y los productos que las contienen.</p>
</div> -->

<div class="col s12 m12 l12 xl12" style="margin-top:30px;">
<h5 class="Tipografia--general letranegro Titulos"><b>Historia</b></h5>
<p class="tipografia--general letranegro General--Cuerpo">La palabra alcohol proviene del árabe al Kuhul que significa sutil. Sin embargo, no se reconoce con precisión cuando se usó por primera vez, aunque se cree que es la droga más antigua y usada del mundo. </p>
<p class="Tipografia--general letranegro General--Cuerpo">El alcohol en estado puro no tiene color. Las bebidas alcohólicas contienen agua y alcohol etílico , toman su color de acuerdo con el ingrediente que se use para hacerlas. Los ingredientes utilizados con más frecuencia son frutas, vegetales o granos. También se pueden utilizar otras plantas.</p>
</div>

<div class="col s12 m12 l12 xl12" style="margin-top: 30px;">
<h5 class="Tipografia--general letranegro Titulos"><b>Propiedades</b></h5>
<ol style="list-style-type: disc;margin-top:30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Disolvente</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Germicida</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Solubles</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Oxidantes</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Colorante</li>
</ol>
</div>
...
<div class="col s12 m12 l12 xl12" style="margin-top:30px;">
<h5 class="Tipografia--general letranegro Titulos"><b>Industrias y Aplicaciones</b></h5>
<ol style="list-style-type:disc;margin-top:60px;">
...
<li class="Tipografia--general letranegro Elementos--Listas">Desinfectantes.</li>
<li class="Tipografia--general letranegro Elementos--Listas">Antidotos.</li>
<li class="Tipografia--general letranegro Elementos--Listas">Enjuagues Bucales.</li>
<li class="Tipografia--general letranegro Elementos--Listas">Diluyente de activos farmacéuticos</li>
<li class="Tipografia--general letranegro Elementos--Listas">Preservativo en fármacos</li>
<li class="Tipografia--general letranegro Elementos--Listas">Tratamiento para piojos</li>
<li class="Tipografia--general letranegro Elementos--Listas">Tónicos</li>
<li class="Tipografia--general letranegro Elementos--Listas">Mascarillas purificantes</li>
...
<ol style="list-style-type: disc;margin-top:30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Ambientadores.</li>
<li class="Tipografia--general letranegro Elementos--Listas">Quita esmaltes.</li>
<li class="Tipografia--general letranegro Elementos--Listas">Lociones</li>
<li class="Tipografia--general letranegro Elementos--Listas">Perfumes</li>
</ol>
</ol>
...
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Blanqueadores.</li>
</ol>
</ol>
</div>
</div>
...
<div class="col s12 m12 l12 xl12">
<h5 class="Tipografia--general letranegro Titulos"><b>Proveedores</b></h5>
<img src="img/PORTAFOLIO_GLICERINAS_V2.png" alt="" class="Tabla_productos_glicerina" style="margin-top: 30px;">
</div>
