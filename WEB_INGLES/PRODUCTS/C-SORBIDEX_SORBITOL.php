...
<div class="row">
<div class="col s12 m12 l6 xl6">
<img src="img/DONUTS_281221.jpg" class="IMAGE--SORBITOLS" alt="SORBITOLES">
</div>
...
<p class="Tipografia--general letranegro General--Cuerpo"><b>C-Sorbidex™</b> tiene un valor energético de 2,4 kcal / g, en comparación con las 4 kcal / g de edulcorantes de calorías completas. Control de humedad y humedad.</p>
<p class="Tipografia--general letranegro General--Cuerpo"><b>C-Sorbidex™</b> es un humectante excelente que proporciona una textura y una sensación en la boca suaves. Ayuda a mantener los productos suaves y húmedos durante una vida útil prolongada.</p>
</div>
</div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12">
        <h5><b class="Tipografia--general letranegro Titulos" style="border-bottom: 3px solid #00e2f8;color:#262137;">Marcas</b></h5>
        <ol>
            <li class="Tipografia--general letranegro Elementos--Listas">C- Sorbidex™ P,/li>
            <li class="Tipografia--general letranegro Elementos--Listas">C-Sorbidex™ S.</li>
        </ol>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12">
            <h5 style="margin: 0px;"><b class="Tipografia--general letranegro Titulos">Aplicaciones</b></h5>
            <ol style="margin-bottom: 0px;">
                <li class="Tipografia--general letranegro Elementos--Listas">Panificación,</li>
                <li class="Tipografia--general letranegro Elementos--Listas">Confitería,</li>
                <li class="Tipografia--general letranegro Elementos--Listas">Cocina Culinaria,</li>
                <li class="Tipografia--general letranegro Elementos--Listas">Lácteos,</li>
                <li class="Tipografia--general letranegro Elementos--Listas">Helados base Crema,</li>
                <li class="Tipografia--general letranegro Elementos--Listas">Frutas Procesadas.</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12">
        <p style="margin: 0px;"><b class="Tipografia--general letranegro General--Cuerpo">Proceso de producción:</b></p>
<ol>
    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type: disc;">El sorbitol se encuentra naturalmente en frutas como ciruelas y peras y repollo. Sin embargo, su extracción no es un método de producción viable.</li>
    <li class="Tipografia--general letranegro Elementos--Listas" style="list-style-type: disc;">El sorbitol se obtiene por hidrogenación de azúcares, derivados del almidón de maíz o trigo.</li>
</ol>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <tbody>
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;">Sorbitol 98%</td>
            <td style="text-align:center;" id="prueba35">Powder</td>
            <td style="text-align:center;width:120px;"></td>
            <td style="text-align:center;width:180px"><b>C- Sorbidex ™ P</td>
            ...
            <td style="text-align: center;"><ol style="padding-left: 24px;padding-right: 12px;">
                ...
                <li style="list-style-type: disc;">Agente edulcorante</li>
            </ol></td>
            ...
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Bakery</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Mixes</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Panificación</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Confitería</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Cocina Culinaria</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Lácteos</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Helados base Crema</li>
            <li class="center-align letranegro Elementos--Listas Tipografia--general" style="list-style-type:disc;">Frutas Procesadas</li>
            </ol>
            </td>
          </tr>
          ...
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;">Sorbitol 98%</td>
            <td style="text-align:center;" id="prueba35">Granular</td>
            <td style="text-align:center;"></td>
            <td style="text-align: center;width:180px"><b>C-Sorbidex™S</td>
            <td style="text-align: center;">Cargill</td>
            ...
            <td style="text-align: center;"><ol style="padding-left: 24px;padding-right: 12px;">
            <li class="center-align">Bakery</li>
            <li class="center-align">Mixes</li>
            </ol></td>
          </tr>
        </tbody>
      </table>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l12 xl12">
            ...
            <ul>
                <li>https://www.cargill.com/food-bev/emea/sweeteners/c-sorbidex-sorbitol</li>
            </ul>
        </div>
    </div>
</div>
