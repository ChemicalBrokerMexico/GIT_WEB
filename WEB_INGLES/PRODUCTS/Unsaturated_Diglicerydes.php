...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Unsaturated Mono and Diglecerydes of Fatty acids</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   >&nbsp</b></a><a class="breditem active" href="Antioxidantes.html" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Unsaturated Mono and Diglecerydes of Fatty acids</b></a></section></section>
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        ...
        <tbody>
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">° Unsaturated Mono and Diglycerides of Fatty Acids 42% </b></a>
            </td>
            ...
            <td style="text-align:center" rowspan="3">° Bakery <br>° Dairy & Non Dairy<br>° Potato Snacks<br> ° Cereals<br> ° Pasta<br> ° Yeast & Dry Yeast<br> ° Oil & Fats<br> ° Sports & Dietary Nutrition<br> ° Meat Productos<br> ° Food Flavours<br> ° Congfectionery<br> °Processing Aids
            </td>
          </tr>
          <tr style="background-color:#fcece8"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Unsaturated Mono and Diglycerides of Fatty Acids 50%</b></a><br>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
            ...
            <td style="text-align:center" class="quitar">
            </td>
          </tr>
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Unsaturated Mono and Diglycerides of Fatty Acids 90%</b></a>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
