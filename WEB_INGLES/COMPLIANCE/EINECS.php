...
<html lang="es">
  <head> 
    ...
    <title>Chemical Broker | EINECS </title><link rel="shortcut icon" href="img/CB_ICON.ico" />
        ...
        <ul class="slides">
          <li> <img src="img/" style="height:800px;">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker</b><br></h3><b class="segundotitulo" style="font-size:26px">EINECS</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          ...
          <p class="Tipografia--general letranegro General--Cuerpo">La farmacopea oficial de los Estados Unidos publicada junto con el National Formulary(formulario nacional de medicamentos) como la USP-NF, La United States Pharmacopeial Convention (también llamada comúnmente USP) es una organización sin ánimo de lucro que posee la marca registrada y los derechos de autor de la USP-NF y publica todos los años medicamentos recetados y de venta libre y otros productos para el cuidado de la salud vendidos en Estados Unidos están obligados a seguir las normas de la USP-NF. La USP también establece estándares para los ingredientes de los alimentos y suplementos dietéticos.</p>
          <h5 class="Titulos Tipografia--general letranegro" style="margin-top:30px"> <b>Nosotrosla USP</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">En USP, se encargan de ayudar, proteger y mejorar la salud de las personas en todo el mundo. Desde los estándares que crean hasta las asociaciones que fomentan.</p>
          <h5 class="Titulos Tipografia--general letranegro" style="margin-top:30px"> <b>Misión </b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Mejorar la salud global a través de estándares públicos y programas relacionados que ayudan a garantizar la calidad, la seguridad y el beneficio de los medicamentos y alimentos.</p>
          <h5 class="Titulos Tipografia--general letranegro" style="margin-top:30px"> <b>Visión </b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">USP imagina un mundo en el que todos tengan acceso a medicamentos y alimentos de alta calidad, seguros y beneficios. USP aborda esta visión con un sentido de urgencia y propósito, fortalecido por su cuadro de voluntarios dedicados, miembros y personal, y trabajando en colaboración con las principales partes interesadas de todo el mundo.</p>
        </div>
      </div>
    </div>
