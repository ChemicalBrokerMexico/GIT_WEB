...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">GMP ICH Q7</b></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <!-- <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_GMP_120422.jpg" alt=""s style="margin-top: -50px;"> -->
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"> <b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo" style="text-align: justify;">El termino manufacturar hace referencia a incluir todas las operaciones de recepción de material, producción, empaquetado, etiquetado, control de calidad, liberación de almacén y distribución de principios activos y controles relacionados.</p>
          <p class="Tipografia--general letranegro General--Cuerpo" style="text-align: justify;">Esta certificación aplica a la fabricacion de formulaciones químicas, extracción, recuperación de recursos naturales o alguna combinación de estos procesos.</p>
        </div>
    </div>
  </div>
