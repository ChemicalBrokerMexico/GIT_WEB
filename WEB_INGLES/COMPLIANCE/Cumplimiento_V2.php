...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                ...
                <p>Introduccion a definir por compliance</p>

                <h5>¿Porque Chemical Broker tiene un area de cumplimiento?</h5>
                <p>Definir con Aaron Sanchez</p>
    ...
    <div class="row">
        ...
        <div class="col s12 m12 l12 xl12 center-align">
            <div class="col s12 m12 l6 xl6">Prueba</div>
            <div class="col s12 m12 l6 xl6">Prueba</div>
            <div class="col s12 m12 l6 xl6">Prueba</div>
            <div class="col s12 m12 l6 xl6">Prueba</div>
        </div>
