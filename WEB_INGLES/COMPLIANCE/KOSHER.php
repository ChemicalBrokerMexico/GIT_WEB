...
<head>
  ...
  <title>Chemical Broker | Kosher</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="KOSHER.php" style="color:#262137 !important"><b class="breadcrumb">Kosher</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_KOSHER_LOGO_V2_180422.jpg" alt=""s style="margin:auto;width:70%;" class="Cumplimiento_Kosher">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">La palabra hebrea “Kosher” significa apto, adecuado o conveniente. Los alimentos kosher son los alimentos que se preparan de acuerdo con normas dietéticas judías, las cuales son permisibles para el consumo, puesto que cumplen con los requisitos de la dieta de la biblia hebrea. Las leyes de kashrut (ley dietética judía) regula dos aspectos principalmente:</p>
          <ol>
              <li style="list-style-type: disc;">Los alimentos permitidos</li>
              <li style="list-style-type: disc;">Las preparaciones de estos alimentos</li>
          </ol>
          <p class="Tipografia--general letranegro General--Cuerpo">En cuanto a la comida permitida, existen regulaciones que rigen la carne, el pescado y los productos lácteos. En la categoría de la carne los únicos mamíferos admitidos para el consumo son los que mastican su bolo alimenticio (rumiantes) y son de pezuñas hendidas. Esto significa que la carne de cerdo y liebres (entre otros) está prohibida. Pollo, pavo, pato y ganso y los peces con aletas y escamas, se puede consumir, mientras que todos los mariscos están prohibidos.</p>
        </div>
    </div>
  </div>
