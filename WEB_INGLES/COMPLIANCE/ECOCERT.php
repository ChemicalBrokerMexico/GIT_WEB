...
<head>
  ...
  <title>Chemical Broker | ECOCERT</title>
  <meta name="description" content="Durante casi 30 años, hemos asistido a numerosos actores en la implementación y promoción de prácticas sostenibles mediante servicios de certificación.">
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="ECOCERT.php" style="color:#262137 !important"><b class="breadcrumb">ECOCERT</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/ecocert_logo_030522.png" alt=""s style="margin:auto;width:70%;">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Durante casi 30 años, hemos asistido a numerosos actores en la implementación y promoción de prácticas sostenibles mediante servicios de certificación, consultoría y capacitación. Comprometida con la agricultura ecológica desde su creación, Ecocert ha extendido sus esfuerzos a muchos otros sectores.</p>
