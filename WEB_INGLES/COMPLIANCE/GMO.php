...
<head>
  ...
  <title>Chemical Broker | GMO</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="GMO.php" style="color:#262137 !important"><b class="breadcrumb">GMO</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_GMO_180422.jpg" alt="" style="margin:auto;width:70%;" class="Cumplimiento_GMO">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Un organismo modificado contiene ADN que ha sido alterado mediante ingeniería genética. Los animales genéticamente modificados se utilizan principalmente para fines de investigación, mientras que las plantas genéticamente modificadas son comunes en el suministro de alimentos de hoy.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">Durante miles de años, los humanos han utilizado métodos de reproducción para modificar organismos. El maíz, el ganado e incluso los perros han sido criados selectivamente durante generaciones para tener ciertos rasgos deseados. Sin embargo, en las últimas décadas, los avances modernos en biotecnología han permitido a los científicos modificar directamente el ADN de microorganismos, cultivos y animales.</p>
        </div>
    </div>
  </div>
