...
<head>
  ...
  <title>Chemical Broker | USP</title>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="USP.php" style="color:#262137 !important"><b class="breadcrumb">USP</b></a></section>
      </div>
    </div>
  </div>
