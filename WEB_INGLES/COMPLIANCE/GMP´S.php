...
<head>
  ...
  <title>Chemical Broker | Buenas Practicas de Manufactura</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="GMP´S.php" style="color:#262137 !important"><b class="breadcrumb">GMP´S</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_GMP_120422.jpg" alt="" style="margin:auto;" class="Cumplimiento_GMP_P">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Las normas GMP <b style="color:#262137;">(Good Manufacturing Practices)</b> es la denominación internacional de las normas de correcta fabricación <b style="color:#262137;">(NCF)</b>.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">Las NCF <b style="color:#262137;">(normas de correcta fabricación)</b> de la agencia española del medicamento y productos sanitarios <b style="color:#262137;">(AEMPS)</b> son una trasposición de las europeas.  </p>
          <h5 class="Titulos letranegro Tipografia--general" style="margin-top:30px"> <b>Objetivo </b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Son normas de estricto cumplimiento para los fabricantes de medicamentos </p>
          <p class="Tipografia--general letranegro General--Cuerpo"> Las NCF se definen como la parte de la garantía de calidad que asegura que los medicamentos son elaborados y controlados de acuerdo con las normas de calidad. Apropiadas para el uso al que están destinados, controlando todas las variables que pueden afectar en la calidad final del medicamento.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">El disponer de un sistema de autorizaciones de fabricación garantiza que todos los medicamentos que hay en el mercado europeo han sido fabricados únicamente por fabricantes autorizados, cuyas actividades son inspeccionadas regularmente por las autoridades competentes.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">Estas normas tienen como fin último salvaguardar la salud de los pacientes</p>
        </div>
    </div>
  </div>
