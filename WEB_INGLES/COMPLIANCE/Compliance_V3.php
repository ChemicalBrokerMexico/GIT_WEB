...
</p>   <li><a class="arrowblue Tipografia--general Subtitulos" href="../Politics/Politica_Calidad.php">Politica de Calidad &nbsp <i class="fas fa-long-arrow-alt-right desaparece"
                                                        id="aparece"></i></a></li>
</ul>
</section>
</div>
...
<div class="container">
    <div class="row">
        <div class="col s12 m12 l6 xl6">
            <img src="img/CB_ALCOHOL_ISOPROPILICO.jpg" alt="" style="width:100%;">
        </div>
        <div class="col s12 m12 l6 xl6">
            <p class="Tipografia--general letranegro General--Cuerpo">Esto es una prueba de diseño</p>
            <a href="prueba_diseño.php" style="color:black;"><b>Leer Mas</b></a>
        </div>
    </div>
    <div class="row">
        <div class="col s12 m12 l6 xl6">
...
<div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px"><a href="pharmaceutical.php" style="cursor:pointer;">
              <div class="contenedor">
                ...
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado"></h5><b class="titulo_submercado"> <span style="position:relative;z-index:2">Cerficaciones </span></b><b> </b>
                  <hr class="animacion">
              ...
              <div class="contenedor">
                <div class="transfo" id="overlay" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado"></h5><b class="titulo_submercado"> <span style="position:relative;z-index:2">Reglamentos</span></b><b> </b>
                  <hr class="animacion">
                  <p><b style="color:white !important">
                      <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">
              ...
              <div class="contenedor">
                <div class="transfo" id="overlay" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado"></h5><b class="titulo_submercado"> <span style="position:relative;z-index:2">Grados y Calidades</span></b><b> </b>
                  <hr class="animacion">
                  <p><b style="color:white !important">
                      <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">
              ...
              <div class="contenedor">
                <div class="transfo" id="overlay" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado"></h5><b class="titulo_submercado"> <span style="position:relative;z-index:2">Farmacopeas</span></b><b> </b>
                  <hr class="animacion">
                  <p><b style="color:white !important">
                      <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                </div><img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">
