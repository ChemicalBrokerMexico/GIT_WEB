...
<html lang="es"> 
  <head> 
    ...
    <title>Chemical Broker JP</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px"/>
            <div class="caption center-align"><br/><br/><br/><br/>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br/></h3><b class="segundotitulo" style="font-size:26px">Japanesse Pharmacopoeia </b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"></section><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp<b>  >&nbsp </b></b><a class="breditem active" href="Cumplimiento.php" style="color:#262137 !important;margin-left:-2px"><b> Cumplimiento</b><b>   >&nbsp</b></a><a class="breditem active" href="JP.html" style="color:#262137 !important;"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Japanesse Pharmacopoeia </b></a></a>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          ...
          <p class="Tipografia--general letranegro General--Cuerpo">La farmacopea japonesa es un documento oficial que define las especificaciones, criterios y métodos de prueba estándares necesarios para asegurar de manera adecuada la calidad de los medicamentos en Japón.</p>
          <h5 class="Titulos Tipografia--general letranegro" style="margin-top:30px"><b>Que contempla</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">El Japaneese Pharmacopeia ha sido preparado con la ayuda del conocimiento y la experiencia de muchos profesionales en el campo farmacéutico. Por lo tanto, el JP debe tener las características de un funcionario estándar, que podría ser ampliamente utilizado por todas las partes interesadas, debe desempeñar un papel apropiado en la distribución de la información y comprensión sobre la calidad de los productos farmacéuticos al público. Además, como estándar de calidad farmacéutica, debería contribuir, promover y mantener la vanguardia, así como consistencia internacional y armonización de los requisitos técnicos de la comunidad internacional. Eso también se acordó que los artículos de JP deberían cubrir    </p>
        </div>
      </div>
    </div>
