                ...
                <li> <img src="img/CB_MANAGEMENT_220322.jpg" alt="" style="height:600px;filter:brightness(0.7);">
                    <div class="caption center-align"><br><br><br><br>
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b
                            class="segundotitulo" style="font-size: 26px;">Cumplimiento</b>
                    </div>
                </li>
            </ul>
        </div>
...
href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">Cumplimiento</b></section>
</div>
</div>
</div>
...
<div class="container">
    <div class="row">
        ...
        <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
            style="color:#262137;">Cumplimiento</b></h5>
            <p class="Tipografia--general letranegro General--Cuerpo">Coordinar los aspectos administrativos y de control, en el marco de implementar, mejorar y mantener los procesos necesarios del sistema de gestión integral; de acuerdo con los requisitos de la norma ISO 9001 y los programas de mejora de la gestión de las áreas involucradas en el proceso.</p>
        
            <h5 class="Tipografia--general letranegro Titulos"><b>Conocimientos y Habilidades</b></h5>
            <ol>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Conocimiento Legal</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Gestión de Personal</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Presentación de Propuestas y Resultados</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Conocimiento y Aplicacion de Software</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Norma ISO 9001:2015</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Sistema de Gestion de Calidad</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Sistema de Gestion Integrales</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Realización y Presentación de Informes Ejecutivos</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Gestión de Proyectos</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Mejora Continua</li>
                <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Manejo de Paqueteria Office</li>
            </ol>
        </div>
