...
<head>
  ...
  <title>Chemical Broker | FDA</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="FDA.php" style="color:#262137 !important"><b class="breadcrumb">FDA</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_FDA_120422.png" alt=""s style="margin:auto;width:75%;" class="Cumplimiento_FDA">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">La administración de alimentos y medicamentos es una agencia federal del departamento de salud y servicios humanos de los Estados Unidos, es uno de los departamentos del ejecutivo federal de los Estados Unidos. La FDA es responsable de proteger y promover la salud pública a través del control y la supervisión de la inocuidad de los alimentos, los productos del tabaco, los suplementos dietéticos, los medicamentos de venta o receta de venta libre (medicamentos), las vacunas, los productos biofarmacéuticos, transfusiones de sangre, dispositivos médicos, de radiación electromagnética dispositivos emisores de luz (ered), cosméticos, alimentos de origen animal y productos veterinarios.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">La FDA fue autorizada por el congreso de los Estados Unidos para hacer cumplir la ley federal de alimentos, medicamentos y cosméticos. Que sirve como el foco principal de la agencia; La FDA también hace cumplir otras leyes en particular la sección 361 de la ley de servicios de salud pública y las regulaciones asociadas, muchas de las cuales no están directamente relacionadas con los alimentos o las drogas. Estos incluyen la regulación de los láseres, los teléfonos celulares, los condones y el control de enfermedades en productos que van desde ciertas mascotas domésticas, hasta la donación de espermas para reproducción asistida.</p>
        </div>
    </div>
  </div>
