...
<head>
  ...
  <title>Chemical Broker | RSPO</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="RSPO.php" style="color:#262137 !important"><b class="breadcrumb">RSPO</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/RSPO_LOGO_030522.jpg" alt=""s style="margin:auto;width:70%;">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Es una organización sin fines de lucro que une a los interesados de los 7 sectores de la industria del aceite de palma: productores, procesadores o comerciantes de palma aceitera, fabricantes de bienes de consumo, minoristas, bancos / inversores y organizaciones no gubernamentales (ONG) ambientales y sociales. Para desarrollar e implementar estándares globales para el aceite de palma sostenible.</p>
