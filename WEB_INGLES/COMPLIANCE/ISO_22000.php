...
<head>
  ...
  <title>Chemical Broker | ISO 22000</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="ISO_22000.php" style="color:#262137 !important"><b class="breadcrumb">ISO 220000</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/ISO_22000_LOGO_030522.png" alt="" style="margin:auto;width:70%;" class="Cumplimiento_ISO_22000">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Es la norma internacional de sistemas de gestión de seguridad alimentaria que especifica los requisitos que se deben cumplir en su totalidad de la cadena de suministros de alimentos, para asegurar que lleguen en perfecto estado al consumidor.</p>
          <p class="General--Cuerpo Tipografia---general">La ISO 22000 se crea con el objetivo básico de garantizar la seguridad alimentaria. De forma paralela, se mejora la protección del consumidor y se fortalece su confianza. Así mismo, se establecen requisitos y parámetros de gestión eficaces y se mejora el rendimiento de los costos a largo plazo de la cadena alimentaria.</p>
        </div>
    </div>
  </div>
