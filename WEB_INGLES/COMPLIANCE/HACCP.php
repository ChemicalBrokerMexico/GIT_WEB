...
<head>
  ...
  <title>Chemical Broker | HACCP</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="HACCP.php" style="color:#262137 !important"><b class="breadcrumb">HACCP</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_HACCP_120422_V1.png" alt="" style="margin:auto;" class="Cumplimiento_HACCP_P">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"> <b>Introducción</b></h5>
         <p class="Tipografia--general letranegro General--Cuerpo">El sistema de HACCP, que tiene fundamentos científicos y de carácter sistemático, permite identificar peligros específicos y medidas para su control con el fin de garantizar la inocuidad de los alimentos. Es un instrumento para evaluar los peligros y establecer sistemas de control que se centran en la prevención en lugar de basarse principalmente en el ensayo del producto final. Todo sistema de HACCP es susceptible de cambios que pueden derivar de los avances en el diseño del equipo, los procedimientos de elaboración o el sector tecnológico.</p>
         <p class="Tipografia--general letranegro General--Cuerpo">El sistema de HACCP puede aplicarse a lo largo de toda la cadena alimentaria, desde el productor primario hasta el consumidor final, y su aplicación deberá basarse en pruebas científicas de peligros para la salud humana, además de mejorar la inocuidad de los alimentos, la aplicación del sistema de HACCP puede ofrecer otras ventajas significativas,</p> 
        </div>
    </div>
  </div>
