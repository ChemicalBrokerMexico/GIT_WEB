...
<head>
  ...
  <title>Chemical Broker | Nom 059</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
              ...
              <tbody class="center-align">
                ...
                <tr>
                  <td style="border:hidden;background-color:#262137"> <a href="Servicios.php"
                      style="color:white !important;border:hidden">Logistica Global</a></td>
                </tr>
                <tr>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="nom_59.php" style="color:#262137 !important"><b class="breadcrumb">NOM 59</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_NOM59_120422.png" alt="" style="margin:auto;width:65%;" class="Cumplimiento_NOM059">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Establece los requisitos mínimos necesarios para el proceso de fabricación de los medicamentos para uso humano comercializado en el país y con fines de investigación.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">Esta norma es de observancia obligatoria para todos los establecimientos dedicados a la fabricación e importación de medicamentos para uso humano comercializados en el país y con fines de investigación, así como los laboratorios de control de calidad, almacenes de acondicionamiento, depósito y distribución de medicamentos y materias primas para su elaboración.</p>
        </div>
    </div>
  </div>
