...
<html lang="es">
  <head> 
    ...
    <title>Chemical Broker | IPEC</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
        ...
        <ul class="slides">
          <li> <img src="img/" style="height:800px;">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker</b><br></h3><b class="segundotitulo" style="font-size:26px">IPEC</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <h5 class="letranegro Tipografia--general Titulos"> <b>Introducción</b></h5>
          <p class="letranegro Tipografia--general General--Cuerpo">La federación IPEC es una organización global que promueve la calidad y la seguridad de los excipientes farmacéuticos. Los excipientes desempeñan un papel fundamental en la seguridad en los excipientes farmacéuticos. Los excipientes desempeñan un papel fundamental en la fabricación de medicamentos al ayudar a preservar la eficacia, la seguridad y la estabilidad de los ingredientes farmacéuticos activos (API) y al garantizar que brinden los beneficios prometidos a los pacientes.</p>
        </div>
      </div>
    </div>
