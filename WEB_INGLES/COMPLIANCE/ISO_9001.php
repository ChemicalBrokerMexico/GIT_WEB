...
<html lang="es">
  <head> 
    ...
    <title>Chemical Broker | ISO 9001</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
  ...
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="row">
      <div class="slider slider-prueba">
        <ul class="slides">
          <li> <img src="img/" style="height:800px;" class="Cumplimiento_ISO_9001">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker</b><br></h3><b class="segundotitulo" style="font-size:26px">ISO 9001</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          ...
          <P class="Tipografia--general letranegro General--Cuerpo">La norma ISO 9001 es un conjunto de directrices y herramientas sobre la gestión de la calidad y mejora continua orientadas a que los productos y servicios estén enfocados al mercado y las exigencias de los clientes.</P>
        </div>
      </div>
    </div>
