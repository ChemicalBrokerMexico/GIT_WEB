...
<head>
  ...
  <title>Chemical Broker | GDP'S</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="GDP´S.php" style="color:#262137 !important"><b class="breadcrumb">GDP´S</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_GDP_120422_V2.jpg" alt="" style="margin:auto;" class="Cumplimiento_GDP_P">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"> <b>Introducción</b></h5>
         <p class="Tipografia--general letranegro General--Cuerpo">Las buenas prácticas de distribución, describen los estándares mínimos que debe cumplir un distribuidor mayorista para garantizar que se mantenga la calidad y la integridad de los medicamentos a lo largo de la cadena de suministro.</p>
         <p class="Tipografia--general letranegro General--Cuerpo">Las buenas prácticas de distribución se extienden más allá de la distribución del producto terminado e incluyen el abastecimiento, el almacenamiento y el transporte de API y otros ingredientes antes de la fabricación.</p> 
        </div>
    </div>
  </div>
