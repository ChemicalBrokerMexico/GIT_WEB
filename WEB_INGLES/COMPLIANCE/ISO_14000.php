...
<head>
  ...
  <title>Chemical Broker | ISO 14000</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="ISO_14000.php" style="color:#262137 !important"><b class="breadcrumb">ISO 14000</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/ISO_14000_LOGO_030522.png" alt="" style="margin:auto;width:70%;" class="Cumplimiento_ISO_14000">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Son una familia de normas que regula todo lo relativo a los sistemas de gestión ambiental. La norma más implementada de esta serie es la norma ISO 14001, que recoge los requisitos para certificar esta norma.</p>
          <p class="General--Cuerpo Tipografia---general">La misión de la familia de normas ISO 14000 no es otra que reducir el impacto medioambiental por medio de las medidas legalmente previstas en esta materia sobre medioambiente. Al igual que las normas ISO 9000 e ISO 9001, la certificación ISO 14000 constituye la implementación de sistema de calidad en una empresa.</p>
        </div>
    </div>
  </div>
