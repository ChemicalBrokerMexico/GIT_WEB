...
<head>
  ...
  <title>Chemical Broker | REACH</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="REACH.php" style="color:#262137 !important"><b class="breadcrumb">Reach</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
     <img src="img/CERTIFICACIONES_CUMPLIMIENTO/REACH_140622.png" alt=""s style="margin:auto;width:70%;">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">Es un reglamento de la Unión Europea, adoptado para mejorar la protección de la salud humana y el medio ambiente de los riesgos que pueden presentar los productos químicos, al tiempo que mejora la competitividad de la industria química de la UE. También promueve métodos alternativos para la evaluación del peligro de las sustancias con el fin de reducir el número de pruebas en animales. </p>
