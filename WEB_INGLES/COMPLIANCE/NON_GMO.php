...
<head>
  ...
  <title>Chemical Broker | NON-GMO</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="NON_GMO.php" style="color:#262137 !important"><b class="breadcrumb">NON-GMO</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_NONGMO_180422.jpg" alt=""s style="margin:auto;width:70%;" class="Cumplimiento_NONGMO">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">No todos los alimentos modificados genéticamente son buenos para el ser humano, algunos estudios indican que explica que las modificaciones de ADN de los alimentos procesados pueden ser transferidos al sistema digestivo e incorporarse por medio de las corrientes sanguíneas a células de órganos vitales.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">Lo que señala “The cell research laboratory” es el daño que significa la ingesta de los alimentos con ADN modificado para nuestro organismo, pudiendo impactar sobre los órganos reproductivos, afectando la fertilidad tanto en mujeres como en hombres, además puede afectar el hígado elevando los índices de colesterol LDL (lipoproteína encargada de transportar el colesterol del hígado a los distintos tejidos y órganos del cuerpo, también denominado colesterol malo) este tipo de alimentos a su vez afectan en general la salud de las células, la respuesta inmunológica y las células que combaten el cáncer.</p>
        </div>
    </div>
  </div>
