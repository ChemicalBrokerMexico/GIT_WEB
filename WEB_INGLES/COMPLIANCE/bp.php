...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="USP.php" style="color:#262137 !important"><b class="breadcrumb">British Pharmacopoeia</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/british-pharmacopoeia-logo.png" alt="" style="margin:auto;width:80%" class="Cumplimiento_BP">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">La farmacopea británica es una herramienta de referencia vital para todas las personas y organizaciones involucradas en la industria farmacéutica en temas de:</p>
          <ul>
              <li class="Tipografia--general letranegro Cuerpo-general" style="list-style-type: disc;">Investigación,</li>
              <li class="Tipografia--general letranegro Cuerpo-general" style="list-style-type: disc;">Desarrollo,</li>
              <li class="Tipografia--general letranegro Cuerpo-general" style="list-style-type: disc;">Fabricación</li>
              <li class="Tipografia--general letranegro Cuerpo-general" style="list-style-type: disc;">Control de calidad y análisis</li>
          </ul>
        </div>
    </div>
  </div>
