...
<head>
  ...
  <title>Chemical Broker | Halal</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="HALAL.php" style="color:#262137 !important"><b class="breadcrumb">Halal</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_HALAL_LOGO_180422.png" alt="" style="margin:auto;width:70%;" class="Cumplimiento_HALAL">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">La certificación Halal determina que un producto o servicio cumple con lo que establece la Ley Islámica (Shaira) para que este sea consumido, esto garantiza que los productos agroalimentarios cumplen con el conjunto de prácticas permitidas por la religión musulmana. Se refiere también a todo aquello que esta permitido, Aquello que es benéfico y saludable para el ser humano ya que aporta mejoras en la calidad de vida y reduce riesgos para la salud.</p>
          <p class="Tipografia--general letranegro General--Cuerpo">El proceso de certificación del instituto garantiza la trazabilidad completa de la cadena alimentaria, desde la granja hasta el plato. No solo cubre la verificación de los ingredientes, también incluye la del proceso de producción, la higiene, la manipulación, los materiales de embalaje, el almacenamiento, el transporte y la distribución de la marca de garantía Halal es una marca de calidad.</p>
        </div>
    </div>
  </div>
