...
<html lang="es">
  <head> 
    ...
    <title>Chemical Broker</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          ...
          <p class="letranegro Tipografia--general General--Cuerpo">Los bienes de consumo de movimiento rápido o FMCG (también conocidos como bienes de consumo envasados o CPG) so, por lo general productos de bajo valor con una alta rotación regular de productos.</p>
        </div>
      </div>
    </div>
