...
<div class="container">
  <div class="row">
    <div class="col s12 m12 l12 xl12">
      <h5 class="letranegro Tipografia--general General--Cuerpo">Certificaciones</h5>
    </div>
    <div class="row center-align">
      <div class="col s12 m12 l4 xl3" style="margin-top:2%;">
        <h1 style="font-size:40px;">GMP</h1>
      </div>
      <div class="col s12 m12 l4 xl7" style="margin-top:5%;">
      <p class="Tipografia--general letranegro General--Cuerpo">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit accusantium tempora non autem accusamus! Aut aliquam laborum, temporibus rem vel facilis impedit incidunt? Quisquam maiores modi atque rem suscipit placeat.</p>
      </div>
      <div class="col s12 m12 l4 xl2">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_GMP_120422.jpg" alt="" style="width:100%;">
      </div>
    </div>
    <hr>
    <div class="row center-align">
      ...
      <div class="col s12 m12 l4 xl7">
      <p class="Tipografia--general letranegro General--Cuerpo">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit accusantium tempora non autem accusamus! Aut aliquam laborum, temporibus rem vel facilis impedit incidunt? Quisquam maiores modi atque rem suscipit placeat.</p>
      </div>
      <div class="col s12 m12 l4 xl2">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/CB_GMP_120422.jpg" alt="" style="width:50%;">
      </div>
    </div>
  </div>
</div>
