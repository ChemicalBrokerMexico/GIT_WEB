...
<head>
  ...
  <title>Chemical Broker | OHSAS</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="OHSAS.php" style="color:#262137 !important"><b class="breadcrumb">OHSAS</b></a></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CERTIFICACIONES_CUMPLIMIENTO/OHASAS_LOGO_030522.png" alt="" style="margin:auto;width:70%;" class="Cumplimiento_OHSAS">
      </div>
    <div class="col s12 m12 l6 xl6">
          <h5 class="Titulos letranegro Tipografia--general"><b>Introducción</b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">El estándar OHSAS fue diseñado para promover los requisitos sobre el correcto cumplimiento de los estándares de seguridad y salud laboral, pudiendo ser aplicada indistitamente a cualquier organización sin importar su tamaño, sector de actividad o localización geográfica. Un sistema de seguridad y salud en el trabajo fomenta un entorno de trabajo seguro para los empleados, pero también permite la participación proactiva de los trabajadores en relación con la prevención de los accidentes y riesgos derivados de la propia actividad, encaminando la cultura preventiva global de la organización a preservar las mejores practicas de salud y seguridad.</p>
        </div>
    </div>
  </div>
