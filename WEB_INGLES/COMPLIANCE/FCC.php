...
<html lang="es"> 
  <head> 
    ...
    <title>Chemical Broke | FCC</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> </li><img src="img/" alt="" style="height:650px"/>
          <div class="caption center-align"><br/><br/><br/><br/>
            <h3 class="primertitulo"><b>Chemical Broker </b><br/></h3><b class="segundotitulo" style="font-size:26px;color:white">Food Chemical Codex</b>
          </div>
        </ul>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"></section><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>  >&nbsp </b></a><a class="breditem active" href="Cumplimiento.php" style="color:#262137 !important;margin-left:-2px"><b>Cumplimiento</b><b>  >&nbsp </b></a><a class="breditem active" href="FCC.php" style="color:#262137 !important"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Food Chemical Codex</b></a>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          ...
          <p class="Tipografia--general letranegro General--Cuerpo">El Food Chemicals Codex (FCC) es una colección de estándares internacionalmente reconocidos para la pureza e identidad de los ingredientes alimentarios. Cuenta con aproximadamente 1200 Monografías, que incluyen productos químicos de grado alimenticio, auxiliares tecnológicos, alimentos como (aceites vegetales, fructosa, suero y aminoácidos), agentes aromatizantes, vitaminas e ingredientes funcionales (como licopeno, olestra y cadena corta). Fructooligosacáridos. La FCC también contiene ingredientes, como sacarosa y aceites esenciales, que no se encuentran con frecuencia en otros recursos de estándares de aditivos alimentarios.</p>
          <h5 class="Titulos Tipografia--general letranegro" style="margin-top:30px"> <b>Publicación </b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo">La FCC sea publicado desde 1966. Proporciona criterios esenciales y métodos analíticos para autenticar y determinar la calidad de los ingredientes alimentarios. Los estándares de la FCC se usan como estándares acordados entre proveedores y fabricantes en las compras y decisiones de compra y suministro en curso. La convención farmacopeica de los estados unidos adquirió la FCC en 2006. La FCC se publica cada dos años en formato impreso y en línea y se ofrece como una suscripción que incluye una edición principal y suplementos intermedios. </p>
          <p class="Tipografia--general letranegro General--Cuerpo">La FCC tiene secciones principales: monografias y apéndices. Las monografias se enumeran alfabética y generalmente cubren un solo ingrediente. Las monografias, cuando correspondan, brindan información sobre cada ingrediente como:
            <ol> </ol>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Estructura química, </li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Formula quimia,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Peso molecular,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Numero de INS,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Número de registro CAS,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Función,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Definición,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Embalaje,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Almacenamiento,</li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Requisitos de etiquetado, </li>
            <li class="Tipografia--general letranegro General--Cuerpo" style="font-size:16px">Espectros IR</li>
          </p>
        </div>
      </div>
    </div>
