...
<html> 
  <head> 
    ...
    <meta name="description" content="La industria agroquimica se encarga de la produccion de fertilizantes, plaguicidas y reguladores del crecimiento vegetal">
    <title>Chemical Broker | Agroquimicos</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/AGRICULTURE_310122.jpeg" alt="" style="height:400px;filter:brightness(0.8)"/>
            <div class="caption center-align"><br/><br/><br/><br/>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker</b><br/></h3><b class="segundotitulo" style="font-size:26px">Agroquimicos </b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Inicio&nbsp </b><b>  >&nbsp </b></a><a class="breditem active" href="Mercados.php" style="color:#262137 !important"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Mercados&nbsp </b><b>   >&nbsp </b></a><a class="breditem active" href="Alimentos.php" style="color:#262137 !important;margin-left:-2px"><b class="breadcrumb">Agroquimicos </b></a></section>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <p class="Tipografia--general General--Cuerpo" style="color:#006600;">La industria Agroquímica es de suma importancia a nivel global, debido a que la mayor parte de ingredientes naturales para la preparación de alimentos, depende de ella para tener un correcto desarrollo</p>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row center-align">
        <div class="col s12 m12 l6 xl6 mercados zoom"><a href="Proximamente.php" style="cursor:pointer;">
            <div class="contenedor">
              ...
              <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_submercado"><b class="titulo_submercado">Insecticidas</b><b> </b>
                  <hr class="animacion"/>
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom "><a href="Proximamente.php" style="cursor:pointer;">
            <div class="contenedor">
              <div class="transfo" id="overlayagro" style="border-radius:10px"></div>
              <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_submercado"><b class="titulo_submercado">Pesticidas </b><b> </b>
                  <hr class="animacion"/>
                  <p> <b style="color:white !important">
                      <p class="leer_mas_mercados"> Leer Mas</p></b></p>
                </h5>
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom columna2"><a href="Proximamente.php" style="cursor:pointer;">
            <div class="contenedor">
              <div class="transfo" id="overlayagro" style="border-radius:10px"></div>
              <div class="centrado_sub" style="position:absolute;z-index:2">
                <h5 class="titulo_submercado"><b class="titulo_submercado">Fertilizantes </b><b> </b>
                  <hr class="animacion"/>
                  <p> <b style="color:white !important">
                      <p class="leer_mas_mercados">  Leer Mas </p></b></p>
                </h5>
              </div><img class="mercadosimagen " src="img/FERTILIZANTES.jpg" alt="" style="border-radius:10px"/>
            </div></a></div>
      </div>
    </div>
    <div class="container">
      ...
      <div class="row">
        <div class="col s12 m12 l6 xl6">
          <h5 class="Tipografia--general letranegro Subtitulos"> <b>Acidos&nbsp <i class="fas fa-long-arrow-alt-right"></i></b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo arrowblue">Acidos</p>
          <hr/>
        </div>
        <div class="col s12 m12 l6 xl6">  
          <h5 class="Tipografia--general letranegro Subtitulos"><b>Edta´s&nbsp<i class="fas fa-long-arrow-alt-right"></i></b></h5>
          <p class="Tipografia--general letranegro General--Cuerpo arrowblue">Edta´s</p>
          <hr/><br/>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12 center-align"><a class="waves-effect waves-light btn " style="margin-top:15px;background-color:#262137;text-transform:none;">Todos los productos de agricultura<br/></a></div>
      </div>
    </div>
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <div class="col s12 m12 l6 xl6">
          <div class="card" style="border-radius:5px">
            <div class="card-content" style="color:black"><span class="card-title Tipografia--general letranegro General--Cuerpo"> </span><b style="border-bottom:2px solid green">Agrochemicals Brochure</b>
              <p> PDF (1.7 MB)</p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12 center-align"><a class="waves-effect waves-light btn" style="background-color:#262137;text-transform: none;">All Downloads  </a></div>
      </div>
    </div>
