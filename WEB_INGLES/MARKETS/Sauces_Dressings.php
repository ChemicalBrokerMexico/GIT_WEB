...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/snacksaderezo.jpg" alt="" style="height:400px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Salsas & Aderezos</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
        <p style="color:#262137">Entre 2010 y 2019 los mexicanos duplicaron su consumo per cápita anual de salsas y chiles, al pasar de 8 a 17 kilogramos, de acuerdo con los datos se la Secretaria de Agricultura y Desarrollo Rural.  
          </p>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row center-align">
        <div class="col s12 m12 l6 xl6 mercados zoom"><a href="Proximamente.php" style="cursor:pointer;">
            ...
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulomercado"><b class="titulomercado">Caldo de Pollo</b>
                <hr class="animacion"/>
                <p> <b style="color:white !important">
                    <p class="leer_mas_mercados">Leer Mas</p></b></p>
              </h5>
            </div><img class="mercadosimagen " src="img/CB_CHIPS.jpg" alt=""/>
          </div>
          </a>
            ...
            <div class="transfo" id="overlayalimentos"></div>
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulomercado"><b class="titulomercado">Caldos de Res</b>
                <hr class="animacion"/>
                <p> <b style="color:white !important">
                    <p class="leer_mas_mercados">Leer Mas</p></b></p>
              </h5>
