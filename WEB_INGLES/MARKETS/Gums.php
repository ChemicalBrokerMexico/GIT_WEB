...
<meta name="description" content="Las gomas clasificadas como aditivos son cadenas más o menos largas de diferentes azúcares y sus derivados. Estas cadenas pueden ser lineales o estar ramificadas.">
<title>Chemical Broker | Gomas</title>
...
<div class="collapsible-header Carreras_altura" style="background-color:black;color:white;border:none;padding:0;margin-right:15px;float:right;height:0px;"><span style="margin-left:15px"><b class="Tipografia--general Desplegables"> <a href="Carreras.php">Carreras  </a></b></span></div>
...
<div class="row">
<div class="col s12 m12 l6 xl6">
<img src="img/CB_GOMAS_221221.jpg" class="IMAGE--SORBITOLS" alt="GOMAS">
</div>
<div class="col s12 m6 l6 xl6" style="margin-top:6px;">
<p class="Tipografia--general letranegro General--Cuerpo">Los hidrocoloides son moléculas muy grandes (macromoléculas) que tienen una gran afinidad por el agua, donde se disuelven en mayor o menor medida y modifican su reología, aumentando la viscosidad del líquido y llegando, en ocasiones, incluso a gelificar dando un aspecto sólido a ese líquido.</p>
<p class="Tipografia--general letranegro General--Cuerpo">Los hidrocoloides son estructuras bien conocidas, como las proteínas (clara de huevo, gelatina) y los almidones, pero se suele guardar este nombre para aquellas fibras con mucha capacidad para atrapar agua y que han sido clasificadas como aditivos (agar, alginato, goma arábiga, pectina) a los que se identifica generalmente con la letra E y un número de tres cifras.</p>
</div>
</div>
</div>
...
<!-- <div class="container">
<div class="row">
<div class="col s12 m12 l12 xl12" style="margin-top:10px;">
<h5><b class="Tipografia--general letranegro Titulos">Sorbitol</b></h5>
<div class="col s6 m12 l6 xl6">
<p class="Tipografia--general letranegro General--Cuerpo">Nombre IUPAC:</p>
<p class="Tipografia--general letranegro General--Cuerpo">Formula:</p>
<p class="Tipografia--general letranegro General--Cuerpo">CAS #:</p>
<p class="Tipografia--general letranegro General--Cuerpo">EINECS #:</p>
<p class="Tipografia--general letranegro General--Cuerpo">Pub Chem:</p>
</div>
<div class="col s6 m12 l6 xl6">
<p class="Tipografia--general letranegro General--Cuerpo">(2S, 3R, 4R, 5R) - Hexano - 1,2,3,4,5,6 - hexol</p>
<p class="Tipografia--general letranegro General--Cuerpo">C6H14O6</p>
<p class="Tipografia--general letranegro General--Cuerpo">50-70-4</p>
<p class="Tipografia--general letranegro General--Cuerpo">200-061-5</p>
<p class="Tipografia--general letranegro General--Cuerpo">5780</p>
</div>
</div>
</div>
</div> -->
...
<div class="row">
<div class="col s12 m12 l12 xl12" style="margin-top: 10px;">
<h5><b class="Tipografia--general letranegro Titulos">Gomas</b></h5>
<p class="Tipografia--general letranegro General--Cuerpo">Las gomas clasificadas como aditivos son cadenas más o menos largas de diferentes azúcares y sus derivados. Estas cadenas pueden ser lineales o estar ramificadas.</p>
<p class="Tipografia--general letranegro General--Cuerpo">para que la goma en cuestión pueda realizar su función, tiene que hidratarse y solubilizarse correctamente. Algunas son solubles en frío y tienden a formar grumos en la dispersión de agua debido a su gran avidez por ella.</p>
</div>
</div>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12" style="margin-top: 10px;">
<h5><b class="Tipografia--general letranegro Titulos">Historia de la Goma Xantana</b></h5>
<p class="Tipografia--general letranegro General--Cuerpo">Descubierta gracias al interés del departamento de agricultura de EEUU, durante la década de 1960 se produjeron unas investigaciones de la bacteria Xanthomonas campestris y para 1964 ya se estaba comercializando y así el xantano se convirtió en el primer producto biopolimérico obtenido por fermentación a base de azúcar de maíz. </p>
</div>
</div>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12" style="margin-top: 10px;">
<h5><b class="Tipografia--general letranegro Titulos">Historia Goma Arabica</b></h5>
<p class="Tipografia--general letranegro General--Cuerpo">Ya los egipcios lo utilizaban en el proceso de la momificación y la elaboración de algunos cosméticos y perfumes. Tras haber caído en olvido fue redescubierto por navegantes europeos en el siglo XV en el África subsahariana. Incluso fue causa de la «Guerra de la Goma» en el siglo XVIII, tras la cual Francia se quedó con el monopolio para el mercado europeo.</p>
</div>
</div>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12" style="margin-top: 10px;">
<h5><b class="Tipografia--general letranegro Titulos">Propiedades</b></h5>
<ol>
<li class="Tipografia--general letranegro Elementos--Listas">Espesantes</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Gelificantes</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Suspensor</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Estabilizante</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Soluble</li>
</ol>
</div>
</div>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12" style="margin-top:10px;">
<h5><b class="Tipografia--general letranegro Titulos">Industrias y Aplicaciones</b></h5>
<ol style="list-style-type: disc;margin-top:30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Farmacéutica:</b></li>
<ol style="list-style-type: disc;margin-top:20px;">
<li class="Tipografia--general letranegro Elementos--Listas">Suspensiones</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Cremas de contenido fármaco</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Aglutinante</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Laxantes</li>
</ol>
</ol>

<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Alimentos</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Cremas pasteleras</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Aderezos</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Bebidas</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Jugos</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Flanes</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Pudines</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Mermeladas</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Merengue</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Confiteria</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Pastas de fruta</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Jugos de fruta</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Helados</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Leche</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Quesos</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Jamón</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Salchichas</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Pastas</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Gelatinas</li>
</ol>
</ol>


<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Cosmética y Cuidado Personal</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
...
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Maquillajes</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Productos de Cuidado capilar</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Dentrificos</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Acondicionadores</li>
</ol>
</ol>


<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Detergencia</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Detergente para ropa</li>

<!-- <li class="Tipografia--general letranegro Elementos--Listas">Alimento para gatos</li>
<br> -->
</ol>
</ol>
...
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Herbicidas</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Insecticidas</li>
</ol>
</ol>


<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Industria química en general</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Fluidos de perforación</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Liquido de Fractura</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Tintas para impresión</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Pegamento para papel</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Fabricación de acuarelas</li>
</ol>
</ol>

<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Industria textil</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Encolado</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Estampado</li>
</ol>
</ol>

<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Industria tabacalera</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Papel de liar tabaco</li>
</ol>
</ol>

<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas"><b>Industria de la polvora</b></li>
<ol style="list-style-type: disc;margin-top: 30px;">
<li class="Tipografia--general letranegro Elementos--Listas">Agente a prueba de agua</li>
<br>
<li class="Tipografia--general letranegro Elementos--Listas">Nitroglicerina</li>
</ol>
</ol>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<h5><b class="Tipografia--general letranegro Titulos" style="float: left !important;">Productos:</b></h5>
<table class="center-align responsive-table" style="margin-top:70px;">
<thead>
<tr>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Chemical Description</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Appearance</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">CAS No.</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Product Brand</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Manufacturer</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Origin</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Grade</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Certificates</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Packing</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Fuctions</th>
<th class="Tipografia--general General--Cuerpo" style="background-color: #262137;color: white;border:1px solid white;text-align: center;">Applications</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align: center;border:1px solid black">prueba1</td>
<td style="text-align: center;border:1px solid black">prueba2</td>
<td style="text-align: center;border:1px solid black">prueba3</td>
<td style="text-align: center;border:1px solid black">prueba4</td>
<td style="text-align: center;border:1px solid black"><a href="#" style="color:rgba(2 146 238 /99%)">Lecithin</a></td>
<td style="text-align: center;border:1px solid black">prueba6</td>
<td style="text-align: center;border:1px solid black">prueba7</td>
<td style="text-align: center;border:1px solid black">prueba8</td>
<td style="text-align: center;border:1px solid black">prueba9</td>
<td style="text-align: center;border:1px solid black">prueba10</td>
<td style="text-align: center;border:1px solid black">prueba11</td>
</tr>
