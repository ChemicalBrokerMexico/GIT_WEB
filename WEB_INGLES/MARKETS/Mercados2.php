  ...
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="container">
        <div class="row">
          <div class="col s12 m12 l12 xl12">
            <p class="Tipografia--general letranegro General--Cuerpo"> <b>Chemical Broker </b> atiende globalmente a sus clientes con la venta de ingredientes químicos catalogados como especialidades y commodities para las industrias:
            </p>
      ...
      <div class="container" style="margin-top:30px">
        <div class="row center-align">
          <div class="col s12 m12 l6 xl3 mercados zoom" style="margin-top:10px"><a href="pharmaceutical.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"></h5><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Farmacéutica </span></b><b> </b>
                  <hr class="animacion">
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna1--mobile"><a href="Alimentos.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Nutrición Humana</span></b><b> </b>
                    <hr class="animacion">
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna2"><a href="Proximamente.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Veterinaria</span></b><b> </b>
                    <hr class="animacion">
                    <p> <b style="color:white !important">
                        <p class="leer_mas_mercados center-align botones">  Leer Mas </p></b></p>
                  </h5>
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna2"><a href="Alimento_Animal.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"><span style="position:relative;z-index:2">Nutricion Animal  </span></b><b> </b>
                    <hr class="animacion">
                    <p><b style="color:white !important">
                        <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                  </h5>
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna3"><a href="Proximamente.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub " style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Agroquímicos</span></b><b> </b>
                    <hr class="animacion">
                    <p><b style="color:white!important">
                        <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                  </h5>
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna3"><a href="Cosmetica_Cuidadopersonal.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Cosmetica<br>& <br>Cuidad Personal  </span></b><b> </b>
                    <hr class="animacion">
                    <p><b style="color:white !important">
                        <p class="leer_mas_mercados center-align botones">  Leer Mas </p></b></p>
                  </h5>
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna4"><a href="Detergencia.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Detergencia</span></b><b> </b>
                    <hr class="animacion">
                    <p><b style="color:white !important">
                        <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                  </h5>
          ...
          <div class="col s12 m12 l6 xl3 mercados zoom columna4"><a href="Proximamente.php" style="cursor:pointer;">
              <div class="contenedor">
                <div class="transfo" id="overlay2" style="border-radius:10px"></div>
                <div class="centrado_sub" style="position:absolute;z-index:2">
                  <h5 class="titulo_submercado2"><b class="titulo_submercado2"> <span style="position:relative;z-index:2">Industria Química</span></b><b> </b>
                    <hr class="animacion">
                    <p><b style="color:white !important">
                        <p class="leer_mas_mercados center-align botones">  Leer Mas</p></b></p>
                  </h5>
