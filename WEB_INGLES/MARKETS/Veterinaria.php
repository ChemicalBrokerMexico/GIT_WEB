...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
    ...
    <div class="container-fluid">
        <div class="slider slider-prueba" style="margin-top:0px">
            <ul class="slides slides-pruea">
                <li> <img src="img/CB_VETERINARIA_070621.jpg" alt="" style="height:400px" />
                    <div class="caption center-align"><br /><br /><br /><br />
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker</b><br /></h3><b
                            class="segundotitulo" style="font-size:26px">Veterinaria </b>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <p class="Tipografia--general General--Cuerpo" style="color:#5f7894;">
                    La medicina veterinaria es la aplicación de tratamientos que permiten preservar y restaurar la salud
                    de los animales domésticos y silvestres enfocándose en:
                </p>
                <ol>
                    <li style="list-style-type: disc;">La prevención</li>
                    <li style="list-style-type: disc;">El diagnostico</li>
                    <li style="list-style-type: disc;">Tratamiento de enfermedades</li>
                    <li style="list-style-type: disc;">Transtornos y Lesiones</li>
                </ol>
            </div>
        </div>
    </div>
