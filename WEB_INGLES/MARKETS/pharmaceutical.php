...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
      ...
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:125px"><a class="breditem active" href="index.php"
            ...
            class="breditem active" href="pharmaceutical.php" style="color:#262137 !important;margin-left:-2px"><b
              class="Tipografia--general letranegro Subtitulos breadcrumb">Farmacéutica </b></a></section>
      </div>
    </div>
  </div>
        ...
        <h2 class="Tipografia--general Titulos" style="color:#262137;margin-top:50px"><b>Funciones</b></h2>
          <ol>
            ...
            <li class="Tipografia--general Elementos--Listas General--Cuerpo"
              ...
              Activo, como lubrificantes, espesantes, deshidratantes y aglutinantes.</li><br />
            <li class="Tipografia--general Elementos--Listas General--Cuerpo"
              style="color:#262137;margin-top:30px;list-style-type: disc;">Mejoran las propiedades organolépticas; es
              decir el sabor, el olor y la apariencia del fármaco como colorantes, edulcorantes, aromatizantes.</li>
            <br />
            <li class="Tipografia--general Elementos--Listas General--Cuerpo"
  ...
  <!-- <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12 center-align"><a class=" btn" href="Productos_news.php"
          style="margin-top:15px;background-color:#262137;text-transform: none;">Todos los Productos de
          Farmaceutica<br /></a></div>
    </div>
  </div> -->
  <!-- <div class="container">
    <div class="row">
      ...
      <div class="col s12 m12 l6 xl6">
        <div class="card" style="border-radius:5px">
          <div class="card-content" style="color:black"><span
              ...
              href="PDF/CATALOGUES/CB_PRODUCT-PORTFOLIO_GLYCERINES_PETER-CREMER_V1.pdf" download="download"
