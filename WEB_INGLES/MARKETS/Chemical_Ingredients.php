  ...
  <div class="container-fluid">
    <div class="slider slider-prueba" style="margin-top:0px">
      <ul class="slides slides-pruea">
        <li> <img src="img/" alt="" class="Banner_Grasos_Palma" style="height:1050px;filter:brightness(0.9);">
          <div class="caption center-align"><br><br><br><br>
            <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo"
              style="font-size: 26px;">Ingredientes Químicos</b>
          </div>
        </li>
      </ul>
    </div>
        ...
        <section class="breditem--inicio"><a class="breditem active" href="index.php"
            ...
            href="Productos_news.php" style="color:#262137 !important;margin-left:-2px"><b>Productos</b><b> >
              ...
              style="color:#262137 !important;margin-left:-2px"><b
                class="Tipografia--general letranegro Subtitulos breadcrumb">Ingredientes Químicos</b></a></section>
        </section>
      </div>
    </div>
  </div>
...
<div class="container" id="Contenedor_dual" name="Contenedor_dual">
  <div class="row">
    <div class="col s12 m12 l6 xl6" style="background-color:#071637;color:white;">
    <?php
    ...
    $consulta = "SELECT * FROM catalogo_productos LIMIT 161";
    ...
    while($mostrar = mysqli_fetch_array($result)){
      ...
      <hr>
      <h5 class="General--Cuerpo Tipografia--General" style="color:white;font-size:15px;"><?php echo $mostrar['Familia']?></h5>
      <div class="col s12 m12 l6 xl6" style="margin-top:-10px;">
        <ol>
        <span><b>Ingrediente Químico</b></span>
          <li style="list-style-type:disc;font-size:15px;"><?php echo $mostrar['Producto']?></li>
        </ol>
      </div>
      <div class="col s12 m12 l6 xl6">
       
        <ol>
        <span style="font-size:15px;"><b>CAS #</b></span>
          <li style="list-style-type:disc;font-size:15px;"><?php echo $mostrar['CAS'] ?></li>
        </ol>
      </div>
...
?>
      ...
      <!-- <div class="col s12 m12 l6 xl6">
        <ol>
        <span><b>CAS #</b></span>
          <li style="list-style-type:disc;"><?php echo $mostrar['CAS'] ?></li>
        </ol>
      </div> -->
    </div>
    <div class="col s6 m6 l6 xl" style="background-color:#071637;opacity:0.8;color:white">
