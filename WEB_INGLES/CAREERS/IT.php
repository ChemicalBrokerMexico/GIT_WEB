...
<head>
    ...
    <meta name="description" content="Analizar, desarrollar, implementar y optimizar técnicas y estrategias en materia de las Tecnologías de la Información.">
    <title>Chemical Broker | IT</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  <li tabindex="0"><a href="../COMPLIANCE/Certificaciones.php" class="Tipografia--general letranegro Subtitulos">Certificaciones</a></li>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <section style="margin-top:40px"><a class="breditem active" href="index.php"
                        ...
                        class="breditem active" href="Carreras.php" style="color:#262137 !important"><b
                            class="breadcrumb">Tecnologías de la Información</b></a></section>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l6 xl6">
                <img src="img/CB_INFORMATION_TECHNOLOGIES_180422_V2.jpg" class="IMAGE--SORBITOLS" alt="">
            </div>
            <div class="col s12 m12 l6 xl6" style="margin-top:6px;">
                <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
                        style="border-bottom:3px solid #262137;color:#262137;">Tecnologías de la Información</b></h5>
                <p class="Tipografia--general letranegro General--Cuerpo">Analizar, desarrollar, implementar y optimizar
                    técnicas y estrategias en materia de las Tecnologías de la Información, con el objetivo de facilitar
                    la obtención y administración de la información a nuestros colaboradores, proveedores y clientes.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="Tipografia--general letranegro Titulos"><b>Áreas y Divisiones</b></h5>
                <ol>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Desarrollo
                    </li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Diseño
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="Tipografia--general letranegro Titulos"><b>Conocimientos y habilidades</b></h5>
                <p class="Tipografia--general letranegro General--Cuerpo">Requerimos ingenieros que sean organizados
                    para mantener un correcto orden en sus procesos para beneficiar al equipo de trabajo; proactivos
                    para aprender con base a la documentación interna y externa oficial previamente aprobada y
                    actualizada que aporte solución a cualquier problema y comunique toda situación a la brevedad. </p>

                <ol>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Conocimiento Intermedio en Redes </li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Realización de Maqueta de Página Web</li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Interpretacion de Código Externo</li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Interpretacion de Código Externo</li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Interpretación y realización de diagramas de flujo</li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Realización de Mantenimiento Preventivo y Correctivo</li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">
                        Requisitos Legales</li>
                    <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Hacking
                        Ético</li>
                </ol>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <?php
        $con = mysqli_connect('localhost','root',"",'rh');
        $query = "SELECT * FROM positions WHERE team = 'Engineering'";
        $result = mysqli_query($con,$query);
        while($mostrar = mysqli_fetch_array($result)){
 
?>
                <table class="display  responsive" id="tableS" name="tableS"
                    style="width:100%;border-spacing:2px 5px;border:none">
                    <thead style="text-align:center">
                        <tr class="Tipografia--general General--Cuerpo">
                        <th id="prueba34"
                                style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137">
                                ID Position</th>
                            <th id="prueba34"
                                style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137">
                                Open Position</th>
                    ...
                    <tbody>
                    <tr>
                        <td style="color: black;" class="center-align"><?php echo $mostrar['id_position']?></td>
                        <td style="color: black;" class="center-align"><?php echo $mostrar['position']?></td>
                        <td style="color: black;" class="center-align"><?php echo $mostrar['role']?></td>
                        <td style="color: black;" class="center-align"><?php echo $mostrar['team']?></td>
                        <td style="color: black;" class="center-align"><?php echo $mostrar['location']?></td>
                    </tr>
