...
<head>
  ...
  <meta name="description" content="Analizar, controlar y priorizar la toma de decisiones en cuanto a la gestión financiera general, de deuda y nuevas oportunidades de inversión.">
  <title>Chemical Broker | Finanzas</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">Finanzas</b></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CB_FINANCE_220322.jpeg" class="IMAGE--SORBITOLS" alt="">
      </div>
      <div class="col s12 m12 l6 xl6" style="margin-top:6px;">
        <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
            style="border-bottom:3px solid #262137;color:#262137;">Finanzas</b></h5>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        ...
        <p class="Tipografia--general letranegro General--Cuerpo">Requerimos talentos enfocados en una visión global estratégica en cuanto al manejo de los Recursos Financieros, con la capacidad de análisis, comunicación y liderazgo para encaminar a la Organización a la toma de decisiones adecuadas que permitan su crecimiento económico.</p>

        <ol>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Mercados Financieros</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Contabilidad</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Estados Financieros</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Tesorería</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Leyes Fiscales</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Habilidades de negociación</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Economia</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Matemáticas</li>
        </ol>
