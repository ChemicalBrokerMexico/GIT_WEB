...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">Ventas</b></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CB_VENTAS_220322.jpg" class="IMAGE--SORBITOLS" alt="">
      </div>
      <div class="col s12 m12 l6 xl6" style="margin-top:6px;">
        <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
            style="border-bottom:3px solid #262137;color:#262137;">Ventas</b></h5>
        <p class="Tipografia--general letranegro General--Cuerpo">Generar y desarrollar oportunidades de negocio que
          provean beneficios económicos y rentables de largo plazo para la organización, contribuyendo al logro de los
          objetivos establecidos, con base a la generación de pronósticos de venta, destacando la ventaja competitiva
          con la que se cuenta y aumentando la satisfacción total del cliente. </p>
      </div>
    </div>
  </div>
            ...
            <div class="contenedor">
              ...
              <div class="centrado_sub" style="position: absolute;z-index:2;">
                <h5 class="titulo_submercado"></h5><b class="titulo_submercado"><span
                    style="position: relative;z-index:2;">Servicio al Cliente</span></b>
                <hr class="animacion">
                <p><b style="color: white !important;">
                    <p class="leer_mas_mercados center-align botones">Leer Mas</p>
                  </b></p>
              </div>
              <img class="mercadosimagen" src="img/CUSTOMER_SERVICE_070922.jpg" alt="" style="border-radius: 10px;">
            </div>
          </a>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        ...
        <p class="Tipografia--general letranegro General--Cuerpo">Requerimos talentos extrovertidos enfocados a
          perseguir el objetivo en común, el cual es posicionar a Chemical Broker como uno de los mejores proveedores de
          ingredientes químicos a nivel global, ocupados en prospectar y satisfacer día a día las necesidades de los
          clientes.</p>

        <ol>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Tecnicas de Venta
          </li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Cierre de Ventas
          </li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Proceso de
            Negociación</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">CRM</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">ERP</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Pronóstico de
            ventas</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Enfoque
            Estratégico </li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Manejo de
