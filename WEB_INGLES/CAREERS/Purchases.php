...
<head>
  ...
  <meta name="description" content="Generar, Analizar y negociar con distintos proveedores a nivel global, los beneficios que se obtienen de relaciones a largo plazo.">
  <title>Chemical Broker | Compras</title>
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">Compras</b></section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CB_PURCHASES_220322.jpg" class="IMAGE--SORBITOLS" alt="">
      </div>
      <div class="col s12 m12 l6 xl6" style="margin-top:6px;">
        <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
            style="border-bottom:3px solid #262137;color:#262137;">Compras</b></h5>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <h5 class="Tipografia--general letranegro Titulos"><b>Áreas</b></h5>
        <ol>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        ...
        <p class="Tipografia--general letranegro General--Cuerpo">Requerimos talentos que desarrollen las habilidades de negociación, habilidades matemáticas, el uso del inglés, análisis de la información, toma de decisiones y todas las actividades que dependen de la Unidad de Negocios de Compras.</p>

        <ol>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Proceso de Negociación</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Importaciones</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Exportaciones</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">INCOTERMS</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Leyes Internacionales de Comercio</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Ley Aduanera</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Regulaciones Internacionales</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Comercio Exterior</li>
          <li style="list-style-type: disc;" class="Tipografia--general letranegro Elementos--Listas">Aranceles</li>
        </ol>
