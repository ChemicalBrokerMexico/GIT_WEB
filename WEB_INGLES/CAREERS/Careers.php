                ...
                <section>
                  <ul>
                    <p style="color:white"><b class="Tipografia--general Titulos">Politicas </b>
                      ...
                      <li><a class="arrowblue Tipografia--general Subtitulos" href="../Politics/Politica_Calidad.php">Politica de
...
<li tabindex="0"><a href="../COMPLIANCE/Marco_Regulatorio.php" class="Tipografia--general letranegro Subtitulos">Marco Regulatorio</a></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        ...
        <p class="Tipografia--general letranegro General--Cuerpo"><b
            class="Tipografia--general letranegro General--Cuerpo;">Chemical Broker</b> es un proveedor mundial de
          servicios de intermediación, comercialización, distribución,
          importación y exportación de productos químicos.</p>

        <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>¿Por qué elegir a
            Chemical Broker?</b></h5>

        <p class="Tipografia--general letranegro General--Cuerpo"><b
            class="Tipografia--general letranegro Genera l--Cuerpo">Chemical Broker</b> es una organización enfocada a
          la
        ...
        <p class="Tipografia--general letranegro General--Cuerpo">Trabajamos sobre una política de “puertas abiertas”,
          con el objetivo
          de estar siempre dispuestos ante temas de seguimiento, trabajo en equipo, presentación de propuestas,
          comunicación efectiva entre la Dirección General y Areas.</p>
              ...
              <div id="test1" class="col s12">
                ...
                <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px"><a href="Proximamente.php"
                    ...
                    <div class="contenedor">
                      ...
                      </div><img class="mercadosimagen" src="img/DIVERSITY_INCLUSION_260623.jpg" alt=""
                        style="border-radius:10px">
                    </div>
                  </a></div>

                <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
                  <p class="Tipografia--general letranegro General--Cuerpo">Día a día existen cambios en la perspectiva
                    de inclusión a nivel mundial, las empresas están implementando nuevas políticas en cuanto a la
                    diversidad de los Recursos Humanos, Chemical Broker a través de la política inclusión y diversidad
                    química apoya el hecho de trabajar con todas las personas que tengan las aptitudes para desempeñarse
                    sin límites en un puesto de trabajo, sin importar raza, credo o religión.</p>
                </div>
              ...
              <div id="test2" class="col s12">
                <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;"><a href="Proximamente.php"
                    ...
                    <div class="contenedor">
                      ...
                      </div><img class="mercadosimagen" src="img/CB_COMPROMISO_060422.jpg" alt=""
                        style="border-radius:10px">
                    </div>
                  </a></div>
                <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
                  <p class="Tipografia--general letranegro General--Cuerpo">
                    A través de nuestra política de puertas abiertas, cada una de las áreas puede realizar sus labores
                    manteniendo estrecha comunicación de forma ascendente, horizontal y descendente con las áreas y
                    departamentos, lo que permite que exista un total compromiso de nuestros colaboradores para el logro
                    de los objetivos.
                  </p>
                </div>
              </div>
              ...
              <div id="test3" class="col s12">
                <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;"><a href="Proximamente.php"
                    ...
                    <div class="contenedor">
                      ...
                      </div><img class="mercadosimagen" src="img/TRABAJO_EQUIPO_260623.jpg" alt=""
                        style="border-radius:10px">
                    </div>
                  </a></div>
                ...
                <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
                  <p class="Tipografia--general letranegro General--Cuerpo">Una organización exitosa persigue un
                    objetivo en común, coopera, colabora y compite con el mismo equipo de trabajo en cada actividad
                    clave, orientado al resultado de excelencia.</p>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- <div id="test1C" class="col s12 m12 l12 xl12">
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top: 10px;">
          <div class="contenedor">
            <div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"><span
                  style="position:relative;z-index:2;color:white;">Legal</span></b><b> </b>
              <hr class="animacion">
            </div>
            <img class="mercadosimagen" src="img/CBM_LEGLA_170823.jpg" alt="" style="border-radius:10px">
          </div>
        </div>
        <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
          <p class="tipografia--general letranegro General--Cuerpo">

            Verificar y Actuar de acuerdo con el derecho según corresponda en los ámbitos de; Recursos Humanos, Derecho
            Comercial o cualquier otro ámbito legal que pudiera ocasionar un problema a la organización

            Utilizando la normativa aplicable para cada uno de los ámbitos mencionados, actualizando las políticas de la
            organización
...
<!-- 
      <div id="test2C" class="col s12">
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            <div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Recursos Humanos</span></b><b> </b>
              <hr class="animacion">

            </div><img class="mercadosimagen" src="img/CB_RECURSOS_HUMANOS_070922.jpg" alt=""
              style="border-radius:10px">
          </div>
        </div>
        <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
      ...
      <div id="test3C" class="col s12">
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            <div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">I.T.</span></b><b> </b>
              <hr class="animacion">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
          <p class="tipografia--general letranegro General--Cuerpo">
            ...
            Analizar, desarrollar, implementar y optimizar técnicas y estrategias en materia de las Tecnologías de la
            Información, con el objetivo de facilitar la obtención y administración de la información a nuestros
      ...
      <div id="test4C" class="col s12">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            ...
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Administración</span></b><b> </b>
              <hr class="animacion">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
          <p class="tipografia--general letranegro General--Cuerpo">
            Diseñar, desarrollar, implementar y controlar los procesos organizacionales que permitan lograr los
      ...
      <div id="test5C" class="col s12">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            ...
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Cumplimiento</span></b><b> </b>
              <hr class="animacion">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
          <p class="tipografia--general letranegro General--Cuerpo">
            ...
            Coordinar los aspectos administrativos y de control, en el marco de implementar, mejorar y mantener los
            procesos necesarios del sistema de gestión integral; de acuerdo con los requisitos de la norma ISO 9001 y
...
<!-- 
      <div id="test6C" class="col s12">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            ...
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Finanzas</span></b><b> </b>
              <hr class="animacion">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom columna1--mobile">
          <p class="tipografia--general letranegro General--Cuerpo">
            Vigilar y controlar el ejercicio del presupuesto a traves de los registros contables y financieoros de las diferetes areas de la institución asi como la ejecucion presupuestaria correspondiente, de manera mensual y anual, con el fin de cumplir la normativa vigente
          </p>
        </div>
      ...
      <div id="test7C" class="col s12">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            ...
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Ventas</span></b><b> </b>
              <hr class="animacion">

            </div><img class="mercadosimagen" src="img/CB_VENTAS_160823 (2).jpg" alt="" style="border-radius:10px">
          </div>
        </div>
      ...
      <div id="test8C" class="col s12">
        ...
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            ...
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Compras</span></b><b> </b>
              <hr class="animacion">

            </div><img class="mercadosimagen" src="img/CB_PURCHASES_220322.jpg" alt="" style="border-radius:10px">
          </div>
        </div>
      ...
      <div id="test9C" class="col s12">
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            <div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Logistica Global</span></b><b> </b>
              <hr class="animacion">

            </div><img class="mercadosimagen" src="img/CB_LOGISTICA_GLOBAL_100322.jpg" alt=""
              style="border-radius:10px">
          </div>
        </div>
...
<!-- 
      <div id="test10C" class="col s12">
        <div class="col s12 m12 l6 xl6 mercados zoom" style="margin-top:10px;">
          <div class="contenedor">
            <div class="transfo" id="overlay_RH" style="border-radius:10px"></div>
            <div class="centrado_sub" style="position:absolute;z-index:2">
              <h5 class="titulo_rh"></h5><b class="titulo_rh"> <span
                  style="position:relative;z-index:2;color:white;">Mercadotecnia</span></b><b> </b>
              <hr class="animacion">
