...
<div class="container" style="margin-top:150px;">
    ...
    <h5 class="Tipografia--general letranegro General--Cuerpo breadfosfatos" style="background-color:#FF6600;padding:10px;color:white;font-size:30px;border-radius:10px"><b>Pirofosfato Tetrasodico Anhidro</b></h5>
...
<script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
    ...
    <link rel="canonical" href="https://chemicalbroker.mx/Pirofosfato_Tetrasodico_Anhidro.php">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
