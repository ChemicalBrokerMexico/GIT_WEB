...
// if(mysqli_num_rows($resultado)>1){
    ...
    <nav style="background-color:white;height:25px;margin-top:auto;">
        <div class="nav-wrapper flex" style="float: right;padding-right:60px;"><a class="sidenav-trigger" href="#"
            ...
            <ul class="hide-on-med-and-down">
                <li style="margin-right:20px;"><i class="material-icons letranegro dropdown-trigger"
                        data-target="dropdown3" id="aparece">notifications</i>
                    <ul id="dropdown3" class="dropdown-content"
                        style="width:300px !important;margin-top:286px !important">
                        <li><a href="Productos_news.php" class="Tipografia--general letranegro Subtitulos"
                                style="width:200px;">Productos</a></li>
                        <li><a href="Listado_Productos.php" class="Tipografia--general letranegro Subtitulos"
                                style="width:200px;">Lista de Productos</a></li>
                    </ul>
                </li>
                <li><i class="material-icons letranegro dropdown-trigger" id="aparece" data-target="dropdown4">account_circle</i>
    ...
    <div class="container">
        ...
        if($mostrar['Abierto_oportunidades'] == 0){
            ...
            document.getElementById('spanprueba').innerHTML = 'Inactivo'; 
        ...
        ?>
                    ...
                    <span style="margin-left: 30px;font-size:16px;font-family:Arial">Se ubica actualmente en <?php echo $mostrar['ubicacion_actual'] ?></span>
                    <span style="margin-left: 30px;font-size:16px;font-family:Arial">Busca Ofertas Como
                        <b><?php echo $mostrar['Posiciones'];  ?></b></span>
                </ol>
                <ol>
                ...
                <div class="container" style="margin-top:30px;">
                    <div class="row">
                        ...
                        <div class="col s12 m12 l12 xl12">
                            ...
                            <p style="margin-left:-120px;font-size:16px;font-family:Arial">
                                <?php echo $mostrar['idiomas']; ?></p>
                        </div>
                        <div class="col s12 m12 l12 xl12">
                            <h5 class="Tipografia--general General--Cuerpo letranegro"
                                style="margin-left: -120px;font-size:16px;font-family:Arial">
        ...
        Back-End Developer
            ...
            <div id="test2" class="col s12 m12 l12 xl12">
                ...
                <div class="container" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col s12 m12 l12 xl12">
                            <h5 style="font-size:16px;font-family:Arial;margin-left:-120px;"><b>No Tienes Postulaciones
                                    Actualmente</b></h5>
                        </div>
                    </div>
                </div>
