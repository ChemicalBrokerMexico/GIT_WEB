...
<head>
  ...
  <title>Chemical Broker | Anestesicos y Sedantes</title>
  <meta name="description" content="Ofrecemos compuestos activos, excipientes farmaceuticos, estabilizantes, solventes grados USP y reguladores de pH que permiten formular anestesicos y sedantes con perfiles farmacocinéticos predecibles, adecuada biodisponibilidad y estabilidad durante el almacenamiento"> 
  <link rel="shortcut icon" href="img/CB_ICON.ico" />
  <link rel="canonical" href="https://chemicalbroker.mx/Anestesicos_Sedantes.php">
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/anestesia_veterinaria.jpg" style="height:500px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Anestesicos y Sedantes</b><br></h1>
              <div class="container">
    ...
    <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Mercados.php"><b class="Tipografia--general Subtitulos" style="color:black;">Mercados > </b></a><a class="active" href="Mercados.php"><b class="Tipografia--general Subtitulos" style="color:red;">Anestesicos y Sedantes</b></a></section>
                ...
                <ol>
                    <li class="Elementos--Listas" style="margin-top:50px;"><b>Clasificación de los anestésicos y sedantes:</b>
                            ...
                            <li class="Elementos--Listas" style="margin-top:30px;"> Anestésicos:
                                <ol>
                                    <li class="Elementos--Listas" style="margin-top:30px;">Locales: Bloquean temporalmente la conducción nerviosa en una región específica.
                                        <ol>
                                            <li class="Elementos--Listas" style="margin-top:30px;">Uso: Suturas, procedimientos dentales menores.</li>
                                            <li class="Elementos--Listas">Ejemplo: Lidocaína, Bupivacaína, Procaína.</li>
                                        </ol>
                                    </li>
                                </ol>
                            </li>
                        ...
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;"> Generales: Inducen una pérdida total de conciencia y sensibilidad al dolor.
                                <ol>
                                    <li class="Elementos--Listas" style="margin-top:30px;">Uso: Cirugías mayores y procedimientos invasivos.</li>
                                    <li class="Elementos--Listas">Ejemplo: Propofol, Ketamina, Isoflurano.</li>
                                </ol>
                            </li>
                        </ol>
                    </li>
                    ...
                    <li class="Elementos--Listas" style="margin-top:50px;">  Sedantes y tranquilizantes:
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;"> Inducen relajación y reducen la ansiedad sin causar pérdida total de conciencia.
                                <ol>
                                    <li class="Elementos--Listas" style="margin-top:30px;">Uso: Controles veterinarios, transporte o manejo de mascotas ansiosas.</li>
                                    <li class="Elementos--Listas">Ejemplo: Dexmedetomidina, Diazepam, Acepromacin</li>
                                </ol>
                            </li>
                        </ol>
                    </li>
                    ...
                    <li class="Elementos--Listas" style="margin-top:50px;">  Analgésicos adyuvantes:
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Usados en combinación con anestésicos o sedantes para controlar el dolor.
                                <ol>
                                    <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Opioides como Buprenorfina, Fentanilo.</li>
                                </ol>
                            </li>
                        </ol>
                    </li>
