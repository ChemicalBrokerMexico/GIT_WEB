...
<li> <a class="elemennav-secun Tipografia--general letranegro Subtitulos dropdown-trigger" href="#!" data-target="dropdown3"><b>Productos<i class="material-icons right">arrow_drop_down</i></b></a></li>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/TORTILLAS_SNACKS_210521.jpg" alt="" style="height:400px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Tortillas & Snacks</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
        <p style="color:#262137">En México de acuerdo con datos del INEGI (Instituo Nacional de Estadistica y Geografía) los snacks fritos generan un mercado cuyo valor asciende a USD 3.232 millones y una produccion de 22.558 toneladas
        Dentro de los datos de la agencia de investigacion de mercados Euromonitor Internacional, en la categoria de snacks han predominado los empaques individuales o mas pequeños,  
          </p>
        </div>
      </div>
    </div>
