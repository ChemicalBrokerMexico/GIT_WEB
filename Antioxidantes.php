...
<head>
  ...
  <title>Chemical Broker | Antioxidantes (BHA, TBHQ, BHT)</title>
  <meta name="description" content="Protege y prolonga la vida útil de tus productos con antioxidantes de alto rendimiento. Ideales para aplicaciones alimentarias, cosméticas e industriales. Mejora la calidad y estabilidad de tus formulaciones. ¡Compra antioxidantes efectivos y versátiles al mejor precio!."> 
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/ANTIOXIDANTES_020823.jpg" style="height:800px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Antioxidantes</b><br></h1>
              <div class="container">
      ...
      <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Antioxidantes.php"><b class="Tipografia--general Subtitulos" style="color:red;">Antioxidantes</b></a></section>
        ...
        <ol>
          <li style="list-style-type:disc;margin-left:-23px;"><a href="BHA.php"
              ...
              <br>
          <li style="list-style-type:disc;margin-left:-23px;"><a href="BHT.php"
              style="color:rgba(2 146 238 /99%);list-style-type:disc;">Butil Hidroxitolueno (BHT)</a></li>
              <br>
          <li style="list-style-type:disc;margin-left:-23px;"><a href="TBHQ.php"
