...
<head>
    ...
    <link rel="canonical" href="https://chemicalbroker.mx/Family_Products.php">
    ...
    <div class="container-fluid">
        <div class="slider slider-prueba" style="margin-top:0px">
            <ul class="slides slides-pruea">
                <li><img src="img/ACEITES_GRASAS_050825.png" style="height:550px;margin-top:-150px;"
                        alt="Historia Ascendente">
                    <div class="caption center-align"><br><br><br><br>
                        <h1 class="primertitulo"><b class="boldbanner">Aceites y Grasas</b><br></h1>
                        <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                ...
                <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:30px;">Nuestra Unidad de Negocios "Foods" crea valor
                    y soluciones para sus clientes. Estamos comprometidos con un sistema de negocio concentrado en
                ...
                <h3 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:30px;"><b style="color:#BF8F00;margin-top:30px;">Fabricante</b></h3>

                <ol style="margin-top:50px;">
                    <a href="#" style="color: black;" class="arrowblue"><img src="img/Cargill-Logo_2.png" alt=""
                            class="logo_lecitinas_secundarias"></a>
                ...
                <div class="container" style="margin-top:30px">
                    <div class="row center-align">
                        <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                href="Aceite_Canola.php" style="cursor:pointer;">
                            ...
                            <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                ...
                                <div class="contenedor">
                                    ...
                                    <img class="mercadosimagen" src="img/Palma_Aceite_281124.jpg" alt="" style="border-radius:10px" />
                                    <!-- <img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">  -->
                                </div>
                            </a></div>
                            ...
                            <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                ...
                                <div class="contenedor">
                                    ...
                                    <img class="mercadosimagen" src="img/PALMISTE_RBD.jpg" alt="" style="border-radius:10px" />
                                    <!-- <img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">  -->
                                </div>
                            </a></div>
                            ...
                            <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                ...
                                <div class="contenedor">
                                    ...
                                    <img class="mercadosimagen" src="img/ACEITE_RBD_211223.jpg" alt="" style="border-radius:10px" />
                                    <!-- <img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">  -->
                                </div>
                            </a></div>
                            ...
                            <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                ...
                                <div class="contenedor">
                                    ...
                                    <img class="mercadosimagen" src="img/CB_ESTEARINA_PALMA_281223.png" alt="" style="border-radius:10px" />
                                    <!-- <img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">  -->
                                </div>
                            </a></div>
                            ...
                            <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                href="Proximamente.php" style="cursor:pointer;">
                                <div class="contenedor">
                                    <div class="transfo" id="overlay" style="border-radius:10px"></div>
                                    <div class="centrado_sub" style="position:absolute;z-index:2">
                                        <h5 class="titulo_submercado"></h5><b class="titulo_submercado"> <span
                            ...
                            <div class="col s12 m12 l4 xl4 mercados zoom" style="margin-top:10px"><a
                                ...
                                <div class="contenedor">
                                    ...
                                    <img class="mercadosimagen" src="img/CB_SEBO_ALTO_HIDROGENADO.jpg" alt="" style="border-radius:10px" />
                                    <!-- <img class="mercadosimagen" src="img/FARMACEUTICA_CB.jpg" alt="" style="border-radius:10px">  -->
                                </div>
                            </a></div>
                    </div>
                ...
                <!-- <ol>
            <li class="Elementos--listas Tipografia--general" style="list-style-type:disc;"></li>
            <li class="Elementos--listas Tipografia--general" style="list-style-type:disc;"></li>
            <li class="Elementos--listas Tipografia--general" style="list-style-type:disc;"></li>
            <li class="Elementos--listas Tipografia--general" style="list-style-type:disc;"></li>
            <li class="Elementos--listas Tipografia--general" style="list-style-type:disc;"></li>
            ...
            <li class="Elementos--listas Tipografia--general" style="list-style-type:disc;"></li>
                ...
                <!-- <span class="arrowblue">Ver Más...</span> -->
