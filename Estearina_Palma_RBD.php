  ...
  <div class="container" style="margin-top:130px;">
    <div class="row">
      ...
      <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Historia_Hechos.php"><b class="Tipografia--general Subtitulos" style="color:red;">Estearina de Palma Alto Hidrogenado (RBD)</b></a></section>
        ...
        <h5 class="Tipografia--general letranegro Titulo">Estearina de Palma RBD</h5>

        <p class="Tipografia--general letranegro General--Cuerpo">La Estearina de Palma Refinada, Blanqueada y Desodorizada (RBD) es una fracción sólida que se obtiene del aceite de palma a través de un proceso de fraccionamiento, en el que el aceite de palma se separa en 2 fracciones principales:</p>

        <ol>
            <li class="Elementos--Listas" style="margin-top:30px;">Oleína de palma: Es la fracción líquida del aceite de palma, rica en ácidos grasos insaturados, que se utiliza principalmente en la industria alimentaria para frituras y otros procesos.</li>
            <li class="Elementos--Listas" style="margin-top:30px;">Estearina de palma: Es la fracción sólida del aceite de palma, rica en ácidos grasos saturados, especialmente ácido palmítico y esteárico.</li>
        </ol>

        <h5 class="Tipografia--general letranegro Titulo">Caracteristicas</h5>

        <ol>
            <li class="Elementos--Listas" style="margin-top:30px;">Refinada: Se eliminan las impurezas, ácidos grasos libres y otros compuestos no deseados, obteniendo un producto puro y de mayor calidad.</li>
            <li class="Elementos--Listas" style="margin-top:30px;">Blanqueada: Se eliminan los pigmentos naturales (como el caroteno) para obtener un color más claro, generalmente blanco o amarillento pálido.</li>
            <li class="Elementos--Listas" style="margin-top:30px;">Desodorizada: Se eliminan los olores y sabores residuales mediante procesos como el tratamiento con vapor a altas temperaturas.</li>
            <li class="Elementos--Listas" style="margin-top:30px;">Fracción sólida: Se obtiene del aceite de palma a través de procesos que separan los componentes sólidos (estearina) de los líquidos (oleína).</li>
            <li class="Elementos--Listas" style="margin-top:30px;">Punto de fusión elevado: Es ideal para aplicaciones que requieren una estructura sólida a temperatura ambiente.</li>
        </ol>

        <h5 class="Tipografia--general letranegro Titulo">Funciones</h5>

        <ol>
            <li>Industria Alimentaria:
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;">Aportar estructura y consistencia. - Proporciona solidez a productos como margarinas, mantecas y grasas para hornear.</li>
                    <li class="Elementos--Listas" style="margin-top:30px;">Mejora la estabilidad térmica. - Evita que los productos grasos se derritan fácilmente a temperatura ambiente.</li>
                    <li class="Elementos--Listas" style="margin-top:30px;">Extender la vida útil. - Ayuda a mantener frescos productos horneados y fritos durante más tiempo.</li>
                    <li class="Elementos--Listas" style="margin-top:30px;">Control del punto de fusión. - Permite fabricar alimentos que tienen texturas específicas y propiedades de fusión deseadas (ej., chocolates que se derriten en la boca y no en las manos).</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li> Industria Cosmética y de Cuidado Personal:
                <ol>
                    <li>Endurecimiento de productos sólidos. - Se utiliza en jabones para mejorar su dureza y durabilidad.</li>
                    <li>Emulsionante natural. - Facilita la mezcla de agua y aceites en cremas y lociones, mejorando su consistencia.</li>
                    <li>Formación de espuma. - Mejora la capacidad de jabones y geles para generar espuma, ideal para productos de limpieza personal.</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li> Industria Química:
                <ol>
                    <li>Producción de biocombustibles. - Sirve como materia prima para fabricar biodiésel debido a su alto contenido de triglicéridos.</li>
                    <li>Fabricación de velas. - Aporta rigidez y consistencia, haciendo velas más duraderas y con mejor quemado.</li>
                    <li>Lubricante. - Se usa como agente lubricante en la fabricación de algunos plásticos o productos industriales.</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li>Propósitos técnicos y ambientales:
                <ol>
                    <li>Estabilidad estructural. - Aporta propiedades mecánicas a diversos productos sólidos, como adhesivos y ceras.</li>
                    <li>Sostenibilidad energética. - Su uso en biocombustibles ayuda a reducir la dependencia de combustibles fósiles.</li>
                </ol>
            </li>
        </ol>

        <h5 class="Tipografia--general letranegro Titulo">Aplicaciones</h5>

        <ol>
            <li> Industria alimentaria:
                <ol>
                    <li>Margarinas y mantecas. - Se utiliza como ingrediente clave para dar estructura y estabilidad.</li>
                    <li>Productos de panadería. - Aporta la textura deseada en galletas, bizcochos y pasteles.</li>
                    <li>Frituras. - Ideal para aceites de fritura debido a su resistencia a la oxidación y capacidad para soportar altas temperaturas.</li>
                    <li>Confitería. - Se emplea en la fabricación de chocolates, cubiertas y caramelos, proporcionando un punto de fusión adecuado para un consumo agradable.</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li> Industria Cosmética y del Cuidado Personal:
                <ol>
                    <li>Jabones sólidos. - Mejora la dureza, duración y capacidad de formación de espuma en jabones.</li>
                    <li>Cremas y lociones. - Actúa como un emulsionante que estabiliza la mezcla de aceites y agua, mejorando la textura del producto.</li>
                    <li>Velas aromáticas y decorativas. - Proporciona rigidez, prolonga el tiempo de quemado y reduce el goteo.</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li> Industria Química e Industrial:
                <ol>
                    <li>Producción de biocombustibles. - Utilizada como materia prima para biodiésel debido a su contenido de triglicéridos.</li>
                    <li>Fabricación de lubricantes. - Usada como componente en lubricantes industriales o automotrices ecológicos.</li>
                    <li>Adhesivos y ceras. - Mejora las propiedades mecánicas y la estabilidad en estos productos.</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li>Industria Farmacéutica:
                <ol>
                    <li>•	Base para excipientes. - Se emplea en la fabricación de cápsulas, supositorios y otros medicamentos sólidos o semisólidos debido a su compatibilidad con otros ingredientes.</li>
                </ol>
            </li>
        </ol>

        <ol>
            <li>Velas y productos decorativos:
                <ol>
                    <li>Velas sólidas. - La estearina de palma proporciona una combustión más limpia, sin humo y reduce la formación de humo o residuos.</li>
                </ol>
            </li>
        </ol>
        ...
        <ol>
            <li> Alimento Animal:
                <ol>
                    <li>Aditivos para alimentación animal. - Utilizada en la formulación de alimentos balanceados para incrementar el contenido energético y mejorar la digestión de lípidos en rumiantes.</li>
                </ol>
            </li>
        </ol>
        ...
        <ol>
            <li> Agroquímicos:
                <ol>
                    <li>Fertilizantes. - como aditivo como recubrimiento en fertilizantes granulados para controlar la liberación de nutrientes.</li>
                </ol>
            </li>
        </ol>
