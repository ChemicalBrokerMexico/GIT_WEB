...
boton_question1.addEventListener('click', function () {
    ...
    if(question1.style.display == 'block'){
        ...
        preguntasall1.style.display = 'none';
        preguntasall2.style.display = 'none';
        preguntasall3.style.display = 'none';
        preguntasall4.style.display = 'none';
        preguntasall5.style.display = 'none';
        preguntasall6.style.display = 'none';
        preguntasall7.style.display = 'none';
        preguntasall8.style.display = 'none';
        preguntasall9.style.display = 'none';
        preguntasall10.style.display = 'none';
        preguntasall11.style.display = 'none';
        preguntasall12.style.display = 'none';
        preguntasall13.style.display = 'none';
        preguntasall14.style.display = 'none';
        preguntasall15.style.display = 'none';
        enviartest.style.display = 'none';
        question2.style.display = 'none';
    }else{
