...
<ul class="slides">
<li> <img src="img/Suplementos_veterinaria.jpg" style="height:500px;" alt="Industria Quimica">
<div class="caption center-align"><br><br><br><br>
<h1 class="primertitulo"><b class="primertitulo">Suplementos Nutricionales</b></h1>
...
<div class="container" style="margin-top:150px;">
    <div class="row">
        ...
        <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b>Inicio&nbsp>&nbsp </b></a><a class="active" href="Mercados.php"><b class="Tipografia--general Subtitulos" style="color:black           ;">Mercados > </b></a><a class="active" href="Suplementos_Nutricionales.php"><b class="Tipografia--general Subtitulos" style="color:red;">Suplementos Nutricionales</b></a></section>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"> Suplementos para la salud articular:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;"> Ayudan a prevenir o tratar problemas articulares, como la artritis.
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;"> Ingredientes clave:
                                    <ol>
                                        <li class="Elementos--Listas" style="margin-top:30px;">Glucosamina y Condroitina (reparación de cartílago).</li>
                                        <li class="Elementos--Listas" style="margin-top:30px;">MSM (Metilsulfonilmetano) (antiinflamatorio).</li>
                                        <li class="Elementos--Listas" style="margin-top:30px;">Colágeno hidrolizado.</li>
                                    </ol>
                                </li>
                            </ol>
                        </li>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"> Ácidos grasos esenciales:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;"> Fuente de Omega-3 y Omega-6.
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Aceite de pescado, aceite de linaza, aceite de kril.</li>
                                <li class="Elementos--Listas" style="margin-top:30px;">Uso: Mejora la salud de la piel, el pelaje y el sistema cardiovascular.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"> Pro y prebióticos:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;"> Mejoran la salud intestinal y el sistema digestivo.
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;"> Ejemplo:
                                    <ol>
                                        <li class="Elementos--Listas" style="margin-top:30px;">Probióticos: Lactobacillus acidophilus, Bifidobacterium.</li>
                                        <li class="Elementos--Listas" style="margin-top:30px;">Prebióticos: Inulina, FOS (fructooligosacáridos).</li>
                                    </ol>
                                </li>
                            </ol>
                        </li>
            ...
            <ol>
                <li class="Elementos--Listas" style="margin-top:30px;"> Suplementos para el sistema inmunológico:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;"> Apoyo para mascotas con enfermedades crónicas o mayores.
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ingredientes clave: Beta-glucanos, Lisina, Vitamina C.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
            ...
            <li class="Elementos--Listas" style="margin-top:30px;"> Antioxidantes:
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;"> Ayudan a combatir el estrés oxidativo y envejecimiento celular.
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Vitamina E, Selenio, Coenzima Q10, Astaxantina.</li>
                        </ol>
                    </li>
                </ol>
            </li>
            ...
            <li class="Elementos--Listas" style="margin-top:30px;"> Suplementos para la ansiedad y comportamiento:
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;"> Ingredientes calmantes para reducir el estrés en mascotas.
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Triptofano, Melatonina, Raíz de valeriana.</li>
                        </ol>
                    </li>
                </ol>
            </li>
                ...
                <ol>
                    <li class="Elementos--Listas" style="margin-top:30px;"> Productos dirigidos a enfermedades o condiciones específicas.
                        <ol>
                            <li class="Elementos--Listas" style="margin-top:30px;"> Ejemplo:
                                <ol>
                                    <li class="Elementos--Listas" style="margin-top:30px;">SAMe (S-adenosilmetionina) para soporte hepático.</li>
                                    <li class="Elementos--Listas" style="margin-top:30px;">Cranberry (arándano rojo) para salud del tracto urinario.</li>
                                </ol>
                            </li>
                        </ol>
                    </li>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"> Macronutrientes esenciales:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;"> Proteínas hidrolizadas: Facilitan la digestión y son utilizadas en animales con alergias.
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Hidrolizados de pollo o pescado.</li>
                            </ol>
                        </li>
                    </ol>
                    <ol>
            ...
            <ol>
                <li class="Elementos--Listas" style="margin-top:30px;"> Vitaminas y cofactores:
                    <ol>
                        ...
                        <li class="Elementos--Listas" style="margin-top:30px;">Biotina: Salud del pelaje y las uñas.</li>
                    </ol>
                </li>
            </ol>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"> Minerales esenciales:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;">Quelatos de minerales: Mejoran la absorción.
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Quelato de zinc, Quelato de hierro.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
                ...
                <li class="Elementos--Listas" style="margin-top:30px;"> Aditivos funcionales y auxiliares:
                    <ol>
                        <li class="Elementos--Listas" style="margin-top:30px;"> Conservantes naturales:
                            <ol>
                                <li class="Elementos--Listas" style="margin-top:30px;">Ejemplo: Tocoferoles (vitamina E), Extracto de romero.</li>
                                <li class="Elementos--Listas" style="margin-top:30px;">Uso: Aumentar la vida útil de los suplementos.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
