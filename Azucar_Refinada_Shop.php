...
<div class="row">
<div class="col s12 m12 l12 xl12">
<section style="margin-top:75px"><a class="active" href="#" style="color:black !important"><b class="Tipografia--general Subtitulos">Inicio&nbsp</b><b class="Tipografia--general Subtitulos" style="color:black;"> >&nbsp  </b></a><a class="breditem active" href="index.php" style="color:red !important;margin-left:-2px"><b class="Tipografia-general Subtitulos">Azucar Refinada > </b></a><a class="breditem active" href="Azucar_Refinada_Shop.php" style="color:red !important;margin-left:-2px"><b class="Tipografia-general Subtitulos">Azucar Refinada Shop</b></a></section>

<p class="Tipografia--general letranegro General--Cuerpo">El Azúcar Refinada, es sacarosa casi pura (≈99.9%), obtenida principalmente de la caña de azúcar o de la remolacha azucarera, que pasa por un proceso industrial para eliminar impurezas, color, minerales y humedad.</p>
