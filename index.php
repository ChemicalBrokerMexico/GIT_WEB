...
<p class="Tipografia--general letranegro General--Cuerpo"><b style="color:#200142">Chemical Broker</b> comenzó hace más de 9 años, nos basamos en una historia aún más larga de innovación y crecimiento.</p>
...
<p class="Tipografia--general letranegro General--Cuerpo"><b style="color:#200142">Chemical Broker</b> es un proveedor mundial de servicios de intermediación, comercialización, distribución, importación y exportación de ingredientes químicos.</p>
...
<table id="TablaPresentacionDesktop" name="TablaPresentacionDesktop">
  ...
  <tr>
    <th style="background-color:#200142;color:white;border:1px solid white;" class="center-align"><p style="margin:0px 3px;font-size:18px">Fabricante</p><p style="margin:3px;font-size:18px;">(Proveedor)</p></th>
    <th style="background-color:#200142;color:white;border:1px solid white;" class="center-align"><p style="color:yellow;margin:0px;font-size:18px">Compra</p>  <p style="color:rgba(2 146 238 /99%);margin:0px -10px;font-size:18px">Ingredientes</p><p style="color:rgba(2 146 238 /99%);margin:0px;font-size:18px">QuÍmicos</p></th>
    <th style="background-color:#200142;color:white;border:1px solid white;font-size:18px" class="center-align">Chemical Broker</th>
    <th style="background-color:#200142;color:white;border:1px solid white;font-size:18px" class="center-align"><div style="display:block;"><p style="color:yellow;margin:0px;">Venta</p>  <p style="color:rgba(2 146 238 /99%);margin:0px -10px;">Ingredientes</p><p style="color:rgba(2 146 238 /99%);margin:0px;">QuÍmicos</p></th>
    <th style="background-color:#200142;color:white;border:1px solid white;font-size:18px" class="center-align"><div style="display:block;"><p style="margin:0px -14px;">Consumidor</p><p style="margin:0px;">(Cliente)</p></th>
  </tr>
  <tr>
...
<tr>
  <td class="Tipografia--general Cuerpo--General" style="background-color:#200142;color:white;text-align:center;border-bottom:1px solid white;"><b>Fabricante<br>(Proveedor)</b></td>
</tr>
<tr>
  <td class="Tipografia--general Cuerpo--General" style="background-color:#200142;color:white;text-align:center;border-bottom:1px solid white;"><span style="color:yellow;"><b>Compra</b></span><br><span style="color:rgba(2 146 238 /99%);"><b>Ingredientes</b></span><br><span style="color:rgba(2 146 238 /99%);"><b>Químicos</b></span></td>
</tr>
<tr>
  <td class="Tipografia--general Cuerpo--General" style="background-color:#200142;color:white;text-align:center;border-bottom:1px solid white;"><b>Chemical Broker</b></td>
</tr>
<tr>
  <td class="Tipografia--general Cuerpo--General" style="background-color:#200142;color:white;text-align:center;border-bottom:1px solid white;"><span style="color:yellow;"><b>Venta</b></span><br><span style="color:rgba(2 146 238 /99%);"><b>Ingredientes</b></span><br><span style="color:rgba(2 146 238 /99%);"><b>Químicos</b></span></td>
</tr>
<tr>
  <td class="Tipografia--general Cuerpo--General" style="background-color:#200142;color:white;text-align:center;border-bottom:1px solid white;"><b>Consumidor</b><br><b>(Cliente)</b></td>
</tr>
<tr>
