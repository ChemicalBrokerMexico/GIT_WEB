...
<html>
  <head> 
    ...
    <meta name="description" content="Optimiza tus helados con ingredientes químicos premium: mayor cremosidad, mejor estabilidad y excelente rendimiento. Soluciones ideales para la industria."> 
    <title>Chemical Broker | Helados | Proveedor Global y Nacional de ingredientes quimicos para la Industria Alimentaria</title>
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/CB_ICECREAM_190521.jpg" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Helado</b>
            </div>
          </li>
        </ul>
      </div>
