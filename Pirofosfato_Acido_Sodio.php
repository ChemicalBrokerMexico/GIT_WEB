...
<head>
  ...
  <title>Chemical Broker | Pirofosfato Acido de Sodio</title>
  <link rel="shortcut icon" href="img/CB_ICON.ico" />
  <meta name="description"
    content="Los fosfatos se pueden definir como productos quimicos versatiles y multifuncionales que se comercializan ampliamente en diversas industiras debido a sus propiedades beneficiosas y aplicaciones variadas">
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  <link href="css/materialize.css?n=1" type="text/css" rel="stylesheet" media="screen">
  <link href="css/styles.css?n=1" type="text/css" rel="stylesheet" media="screen">
  <link rel="canonical" href="https://chemicalbroker.mx/Pirofosfato_Acido_Sodio.php">
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  ...
  <div class="modal" id="modal1" style="overflow-y:auto">
    ...
    <div class="modal-footer" style="height:25px">
      <div class="row center-align">
            ...
            <div class="modal-content">
              ...
              <div class="row">
                <div class="col s12 m12 l12 xl12" style="margin-top:16px"><a
                    ...
                    style="padding:10px;float:left">Permitir Todo </a></div>
              </div>
              ...
              <ul class="collapsible elementos--cookies">
                <li>
                  <div class="collapsible-header letranegro Tipografia--general Botones">Cookies estrictamente
                    necesarias
                    <label>
                      <input class="filled-in float-right" type="checkbox" checked="checked" disabled><span
        ...
        <div class="col s12 m12 l4 xl4 elementos--cookies"><a class="close_hover letranegro Tipografia--general Botones"
            href="#!" onclick="denegarCookies();">No Estoy de Acuerdo </a></div>
  ...
  <div class="row">
    <ul class="collapsible">
      <li>
        <div class="collapsible-header color--blanco color--fondo--negro"
          style="border:none;padding:0;margin-top:-9px;margin-left:-1px;margin-right:-1px" id="chefle"><span
            style="margin-left:15px"><b class="Tipografia--general Desplegables">Chemical Broker </b></span><i
            class="medium material-icons rigth" id="rotar">arrow_drop_down</i></div>
        <div class="collapsible-header color--fondo--negro color--blanco Carreras_altura"
          style="border:none;padding:0;margin-right:15px;float:right;height:0px"><span style="margin-left:15px">
            <!-- <p>
      <label>
      ...
      <label style="margin-right:25px;">
        ...
        <div class="collapsible-header color--fondo--negro color--blanco Carreras_altura"
          style="border:none;padding:0;margin-right:15px;float:right;height:0px"><span style="margin-left:15px"><b
              class="Tipografia--general Desplegables"> <a href="Carreras.php">Carreras </a></b></span></div>
            ...
            <div class="col s12 m12 l6 xl6">
              ...
              <section style="margin-top:-17px">
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col s12 m12 l10 xl10 sections">
                      <h6 class="Tipografia--general Titulos color--blanco" style="padding-top:5px;">Enfoque de Negocios
                      </h6>
                      <p class="Tipografia--general General--Cuerpo" style="color: #a7a7a7;">Nuestros negocios brindan
                        servicio a nuestros clientes en las industrias&nbsp Farmacéutica, Alimentaria y Nutrición
                        Humana, Alimentaria y Nutrición Animal, Agroquímicos, Cosmética y Cuidado Personal, Detergencia,
                        Industria Química</p>
                    </div>
                  </div>
                </div>
                ...
                <section>
                  <ul>
                    ...
                    <ul> <a class="arrowblue Tipografia--general Subtitulos" href="index.php">Nosotros <i
                        ...
                        class="arrowblue Tipografia--general Subtitulos" href="Historia_Hechos.php">Historia y Hechos <i
                          class="fas fa-long-arrow-alt-right desaparece" id="aparece"></i></a><br><a
                  ...
                  <ul>
                    <p class="color--blanco"><b class="Tipografia--general Titulos">Politicas </b>
                      ...
                      <li> <a class="arrowblue Tipografia--general Subtitulos" href="Code_of_Conduct.php">Codigo de
                          Conducta Organizacional <i class="fas fa-long-arrow-alt-right desaparece"
                            id="aparece"></i></a></li>
                ...
                <!-- <section>
                  <ul>
                    <p class="color--blanco"><b class="Tipografia--general Titulos" style="margin-top:0px">Empleados
                      ...
                      <hr class="hr">
                      <li> <a class="arrowblue Tipografia--general Subtitulos" href="VISTA/Principal.php">Intranet&nbsp
                          <i class="fas fa-long-arrow-alt-right desaparece" id="aparece"></i></a></li>
                    </p>
                  </ul>
                </section>
                <section>
                  <ul>
                    ...
                    <hr class="hr">
                    <li> <a class="arrowblue Tipografia--general Subtitulos"
                        href="https://forms.gle/5n6TRNdamEHYYrFw8">Canal de denuncias, quejas y sugerencias&nbsp; <i
                          class="fas fa-long-arrow-alt-right desaparece" id="aparece"></i></a></li>
                    <p></p>
                  </ul>
                </section> -->
  ...
  <nav style="background-color:white;height:25px;margin-top:-19px">
    <div class="nav-wrapper flex"><a class="sidenav-trigger" href="#" data-target="mobile-demo"><i
      ...
      <ul class="hide-on-med-and-down">
        <li><a class="elemennav-secun Tipografia--general letranegro Subtitulos" href="index.php"><b>Nosotros</b></a>
        </li>
          ...
          <div class="col s12 m12 l12 xl12 search" id="search">
            ...
            <table class="search-table" id="searchTable" style="width:100%">
              ...
              <tbody class="center-aling">
                ...
                <tr>
                  <td class="border--hidden"><a class="letranegro border--hidden" href="Historia_Hechos.php">Historia y
                      Hechos</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="border--hidden"><a class="letranegro border--hidden" href="Servicio_Total.php">Servicio
                      Integral</a></td>
                </tr>
                <tr>
                  <td class="border-hidden"><a class="letranegro border--hidden" href="Code_of_Conduct.php">Codigo de
                      Conducta</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="border--hidden"><a class="letranegro border--hidden" href="Cumplimiento.php">Sistema de
...
<td class="border--hidden"><a class="letranegro" href="https://docs.google.com/forms/d/e/1FAIpQLScRNCAuH7KNNX6VGxRfLjKib0OsLdAJacf7pEjuu4eynxzD5A/viewform" style="border:hidden">Codigo de Conducta Organizacional</a></td>
          ...
          <div class="col s12 m12 l12 xl12 center-align"><a href="#" onclick="cerrarsearch();"><i
                class="material-icons letranegro" style="font-size:45px;">keyboard_arrow_up</i></a></div>
        </div>
      </div>
    </li>
  </ul>
              ...
              <tbody class="center-align">
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="index.php" style="border-bottom:1px solid white;">Nosotros</a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Historia_Hechos.php" style="border-bottom:1px solid white;">Historia y Hechos</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Valores.php" style="border-bottom:1px solid white;">Valores </a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="color--blanco border--hidden"
                      href="Premisas.php" style="border-bottom:1px solid white;">Premisas </a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Servicio_Total.php" style="border-bottom:1px solid white;">Servicio Integral </a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Code_of_Conduct.php" style="border-bottom:1px solid white;">Codigo de Conducta </a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Mercados.php" style="border-bottom:1px solid white;">Mercados </a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"> <a class="border--hidden color--blanco"
                      href="Servicios.php" style="border-bottom:1px solid white;">Servicios</a></td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Cumplimiento.php" style="border-bottom:1px solid white;">Sistema de Gestión Integral </a>
                  </td>
                </tr>
                <tr>
                  <td class="fondo--color--corporativo border--hidden"><a class="border--hidden color--blanco"
                      href="Contact.php" style="border-bottom:1px solid white;">Contacto </a></td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  <div class="container" style="margin-top:150px;">
    ...
    <section><a class="active" href="#" style="color:black !important"><b
      ...
      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Agente Leudante: Se utiliza en productos de panadería,
          como pasteles y galletas, para ayudar a la masa a levantarse. Reacciona con bicarbonato de sodio para liberar
          dióxido de carbono, lo que provoca que la masa se expanda y adquiera una textura esponjosa.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Regulador de Acidez: Ayuda a mantener la estabilidad del
          pH en alimentos procesados, asegurando que no se vuelvan demasiado ácidos o básicos.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Conservante: Se utiliza para prevenir la descomposición y
          el deterioro de los alimentos, ayudando a extender su vida útil.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Mejora de la Textura: En productos cárnicos y embutidos,
          mejora la textura al mantener la humedad y evitar la formación de cristales de hielo durante el almacenamiento
          y la congelación.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Agente de Retención de Agua: Ayuda a mantener la humedad
          en alimentos procesados, lo cual es crucial en productos como las carnes y los mariscos.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Industria de Productos de Limpieza</li>
      </ol>


      <h5 class="letranegro General--Cuerpo Tipografia--general" style="margin-top:50px;"><b
          style="color:#000020;">Detergentes:</b></h5>

      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Actúa como un agente quelante que se une a los iones de
          calcio y magnesio, mejorando la eficacia de los detergentes en agua dura. Esto previene la formación de
          depósitos minerales en superficies lavadas.</li>
      </ol>


      <h5 class="letranegro General--Cuerpo Tipografia--general" style="margin-top:50px;"><b
          style="color:#000020;">Suavizantes de Agua:</b></h5>

      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Se utiliza en productos de lavandería y limpieza para
          suavizar el agua, lo que aumenta la eficacia de los detergentes y reduce el consumo de jabón.</li>
      </ol>


      <h5 class="letranegro General--Cuerpo Tipografia--general" style="margin-top:50px;"><b
          style="color:#000020;">Tratamiento de Agua:</b></h5>

      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Prevención de Incrustaciones y Corrosión: Se utiliza en
          sistemas de tratamiento de agua potable y en torres de enfriamiento para prevenir la formación de
          incrustaciones y la corrosión de las tuberías.</li>
      </ol>

      <h5 class="letranegro General--Cuerpo Tipografia--general" style="margin-top:50px;"><b
          style="color:#000020;">Industria Farmacéutica:</b></h5>

      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Control de la Acidez Estomacal: En la formulación de
          antiácidos, ayuda a controlar la acidez estomacal neutralizando el exceso de ácido en el estómago.</li>
      </ol>

      <h5 class="letranegro General--Cuerpo Tipografia--general" style="margin-top:50px;"><b
          style="color:#000020;">Otras Aplicaciones:</b></h5>

      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Cerámicas y Vidrios: Utilizado en la producción de
          cerámicas y vidrios especiales por su capacidad para modificar las propiedades térmicas y mecánicas del
          material final.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Textiles: En la industria textil, se utiliza en ciertos
          procesos de acabado para mejorar la calidad del tejido.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Acondicionadores de Suelo: Puede ser utilizado en
          productos para el tratamiento de suelos, mejorando la disponibilidad de nutrientes y la estructura del suelo.
        </li>
      </ol>
      ...
      <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Tratamiento de aguas: Se utiliza en el tratamiento de
          aguas para precipitar metales pesados y otras impurezas.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Industria del papel: Empleado en ciertos procesos de
          fabricación de papel para mejorar la calidad del producto final.</li>
      </ol>
    </div>
  </div>
...
<div class="container">
  ...
  <table>
    ...
    <tr>
      ...
      <td class="Tipografia--general letranegro General--Cuerpo" style="text-align:center;"><b>Na2H2P2O7</b></td>
    </tr>
    <tr>
      <td class="Tipografia--general letranegro General--Cuerpo" style="text-align:center;">
      Peso Molecular:
    ...
    Vida de Anaquel:
      ...
      <td class="Tipografia--general letranegro General--Cuerpo" style="text-align:center;">
    <b>- Se utiliza como levadura rápida, agente de retención de humedad, mejorador de calidad para pan, galletas y otros alimentos horneados y carne, producto acuático.</b>
      </td>
    </tr>
  </table>
  </div>
