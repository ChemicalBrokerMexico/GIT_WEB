...
<html lang="es"> 
  <head> 
    ...
    <meta name="description" content="Polisorbato 60 de alta calidad, ideal como emulsionante y estabilizante en las industrias alimentaria, farmaceutica y cosmetica. Compra segura y confiable">
    <title>Chemical Broker | Polisorbato 60 (Tween 60) | Proveedor Global | Compra</title><link rel="shortcut icon" href="img/CB_ICON.ico" />
    <link rel="canonical" href="https://chemicalbroker.mx/Polisorbato_60_Shop.php">
...
<b class="segundotitulo" style="float:right;color:white;margin-top:200px;margin-right:150px;">Polioxietileno (60) Sorbitan Monoestearate<br> Polisorbato 60 | Tween 60</b>
...
<div class="container" style="margin-top:100px">
    <div class="row">
        ...
        <div class="col s6 m6 l6 xl6">
            <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Polioxitileno (60) Sorbitan Monoestearato Polisorbato 60 | Tween 60</b></h2>
            <!-- <table>
                <tr>
        ...
        <div class="col s6 m6 l6 xl6">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width ="50%" class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">Polioxietileno (60) Sorbitan Monoestearato</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="Tipografia--general General--Cuerpo letranegro" style="border-bottom:1px solid white;border-right:1px solid white;background-color:#a7a7a7;color:white;">Tambor 213Kg <br> Granel </td>
                </tr>
                <tr>
