    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li> <img src="img/CB_SOFT.jpg" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Suavizantes</b>
            </div>
          </li>
        </ul>
      </div>
...
<div class="container">
  <div class="row">
    <div class="col s12 m12 l12 xl12">
      <h1 class="Tipografia--general letranegro General--Cuerpo"><b>Mercado de Suavizantes de Ropa</b></h1>
      <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Naturaleza del Mercado</b></h2>
      <p class="Tipografia--general letranegro General--Cuerpo" >Los suavizantes <b>(fabric softeners)</b> son productos de cuidado textil complementarios al detergente, diseñados para:</p>
      <ol>
        <li class="Elementos--Listas">Reducir la aspereza de las fibras</li>
        <li class="Elementos--Listas">Disminuir la electricidad estática</li>
        <li class="Elementos--Listas">Aportar fragancia</li>
        <li class="Elementos--Listas">Facilitar el planchado</li>
      </ol>

      <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Ingredientes Químicos Utilizados en Suavizantes</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Agentes Suavizantes</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo">Funciones:</h2>

      <ol>
        <li class="Elementos--Listas">Se adhieren a la fibra textil (carga positiva)</li>
        <li class="Elementos--Listas">Forman una película lubricante</li>
        <li class="Elementos--Listas">Reducen fricción entre fibras</li>
      </ol>

      <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Emulsionantes</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo">Funciones:</h2>

      <ol>
        <li class="Elementos--Listas">Estabillizan la Formulación</li>
        <li class="Elementos--Listas">Evitan Separación</li>
      </ol>

      <h2 class="Tipografia--general letranegro General--Cuerpo">Ejemplos:</h2>

      <ol>
        <li class="Elementos--Listas">Alcoholes grasos etoxilados</li>
        <li class="Elementos--Listas">Co-emulsionantes catiónicos</li>
      </ol>

      <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Solventes / Vehiculos</b></h2>

      <h2 class="Tipografia--general letranegro General--Cuerpo">Ejemplos:</h2>

      <ol>
        <li class="Elementos--Listas">Alcoholes Ligeros</li>
        <li class="Elementos--Listas">Glicoles</li>
      </ol>
