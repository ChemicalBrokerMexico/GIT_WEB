...
<body>
    ...
    <div class="container-fluid">
        <div class="slider slider-prueba" style="margin-top:0px">
            <ul class="slides slides-pruea">
                <li> <img src="img/" alt="" style="height:500px;filter:brightness(0.7);">
                    <div class="caption center-align"><br><br><br><br>
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
          <h5>Día a Día en las Instalaciones</h5>
    </div>

    <div class="col s12 m12 l4 xl4" style="margin-top:30px;">
          <div class="card">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="img/CB_MARKETS_200422.jpg">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Control de Actividades<i class="material-icons right">more_vert</i></span>
      <p><a href="#">This is a link</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Interacción entre Procesos<i class="material-icons right">close</i></span>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati magni cum molestias repellat ab reprehenderit cupiditate nemo quibusdam tenetur architecto numquam molestiae, quaerat ex harum. Labore illo a ut quis!
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi reprehenderit fugit fuga at nemo, ipsum similique consectetur adipisci error cupiditate. Fugit voluptate dolorum impedit quasi ipsum voluptas, similique porro vel?
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus deserunt provident repellat harum at! Incidunt nostrum, placeat quos non accusantium modi animi commodi eos, ipsa sed vitae nobis, temporibus alias!
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor error culpa delectus ullam voluptatibus, voluptatum veniam ea ipsa aliquid placeat eius fugit corporis id. Totam architecto adipisci ipsa accusamus et!
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime adipisci laudantium iure illum harum, fugiat laboriosam. Adipisci iusto quia odio reprehenderit, sit aliquid necessitatibus ex quasi consectetur facilis quae aperiam.
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Non nihil atque tenetur commodi ipsum quia enim repudiandae, quisquam qui error voluptas odit velit placeat a voluptatibus maiores suscipit recusandae vel.
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Unde consectetur, corporis ratione iusto neque ipsum veniam eum inventore possimus ducimus quod ad error id architecto itaque reprehenderit repellat velit dolorem.
      </p>
    </div>
  </div>
    </div>
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Interacción entre Procesos<i class="material-icons right">more_vert</i></span>
      <p><a href="#">This is a link</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">KPI´S<i class="material-icons right">close</i></span>
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Reuniones Ejecutivas<i class="material-icons right">more_vert</i></span>
      <p><a href="#">This is a link</a></p>
    </div>
    <div class="card-reveal">
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">Habilidades Blandas Necesarias<i class="material-icons right">more_vert</i></span>
      <p><a href="#">This is a link</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">KPI´S<i class="material-icons right">more_vert</i></span>
      <p><a href="#">This is a link</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Card Title<i class="material-icons right">close</i></span>
