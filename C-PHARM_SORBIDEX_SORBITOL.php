                            ...
                            <ul class="collapsible elementos--cookies">
                                ...
                                <li>
                                    <div class="collapsible-header Tipografia--general Botones letranegro">Cookies de
                                        rendimiento
                                        <label>
                                            <input class="filled-in float-right" type="checkbox" disabled><span
                                        ...
                                        <p class="color--blanco"><b class="Tipografia--general Titulos">Politicas </b>
                                            ...
                                            <li><a class="arrowblue Tipografia--general Subtitulos"
                                                    href="Politica_Calidad.php">Politica de Calidad &nbsp <i
                                                        ...
                                                        id="aparece"></i></a></li>
                                            <li><a class="arrowblue Tipografia--general Subtitulos"
                                                    href="../PDF/CBM_CODCONDUCT_PROVEEDORES.pdf"
                                                    download>Código de Conducta de Proveedores &nbsp <i
                                                        class="fas fa-long-arrow-alt-right desaparece"
                                                        id="aparece"></i></a></li>
                                            <li><a class="arrowblue Tipografia--general Subtitulos"
                                                    href="../PDF/CBM_CODCONDUCT_CLIENTES.pdf"
        ...
        <div class="nav-wrapper flex"><a class="sidenav-trigger" href="#" data-target="mobile-demo"><i
            ...
            <ul class="hide-on-med-and-down">
                <li><a class="elemennav-secun Tipografia--general letranegro Subtitulos"
                        href="index.php"><b>Nosotros</b></a></li>
                <li> <a class="elemennav-secun Tipografia--general letranegro Subtitulos"
                    ...
                    <div class="col s12 m12 l12 xl12 search" id="search">
                        ...
                        <table class="search-table" id="searchTable" style="width:100%">
                            ...
                            <tbody class="center-aling">
                                <tr>
                                    <td class="border--hidden"><a class="letranegro border--hidden" href="index.php"
                                            style="border-bottom:1px solid white;">Nosotros</a></td>
                                </tr>
                                <tr>
                                ...
                                <!-- <tr>
<td class="border--hidden"><a class="letranegro" href="https://docs.google.com/forms/d/e/1FAIpQLScRNCAuH7KNNX6VGxRfLjKib0OsLdAJacf7pEjuu4eynxzD5A/viewform" style="border:hidden">Canal de denuncias, quejas y sugerencias</a></td>
</tr>
<tr>
<td class="border--hidden"><a class="letranegro" href="https://docs.google.com/forms/d/e/1FAIpQLScRNCAuH7KNNX6VGxRfLjKib0OsLdAJacf7pEjuu4eynxzD5A/viewform" style="border:hidden">Codigo de Conducta Organizacional</a></td>
</tr> -->
                            ...
                            <tbody class="center-align">
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="index.php"
                                            style="border-bottom:1px solid white;">Nosotros</a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Historia_Hechos.php"
                                            style="border-bottom:1px solid white;">Historia y Hechos</a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a href="Marca.php"
                                            style="border-bottom:1px solid white;"></a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Valores.php"
                                            style="border-bottom:1px solid white;">Valores </a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="color--blanco border--hidden" href="Premisas.php"
                                            style="border-bottom:1px solid white;">Premisas </a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Servicio_Total.php"
                                            style="border-bottom:1px solid white;">Servicio Integral </a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Code_of_Conduct.php"
                                            style="border-bottom:1px solid white;">Codigo de Conducta </a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Mercados.php"
                                            style="border-bottom:1px solid white;">Mercados </a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"> <a
                                            class="border--hidden color--blanco" href="Servicios.php"
                                            style="border-bottom:1px solid white;">Servicios</a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Cumplimiento.php"
                                            style="border-bottom:1px solid white;">Sistema de Gestión Integral </a></td>
                                </tr>
                                <tr>
                                    <td class="fondo--color--corporativo border--hidden"><a
                                            class="border--hidden color--blanco" href="Contact.php"
                                            style="border-bottom:1px solid white;">Contacto </a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<p style="margin-top:50px"><b class="Tipografia--general letranegro General--Cuerpo">Aplicaciones:</b></p>
    ...
    <div class="row">
        ...
        <thead style="text-align:center">
          <tr class="Tipografia--general General--Cuerpo">
            <th id="prueba34" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Chemical Description</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Apparence</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Cas No.</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Product Brand</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Manufacturer</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Origin</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Grade</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Certificates</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Packing</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Functions</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#262137;border-right: 1px solid white">Applications</th>
          </tr>
        </thead>
        <tbody>
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;border-right:1px solid white;">Sorbitol 70% NC</td>
            <td style="text-align:center;border-right:1px solid white;" id="prueba35">Liquid</td>
            <td style="text-align:center;width:120px;border-right:1px solid white;">68425-17-2</td>
            <td style="text-align: center;width:180px;border-right:1px solid white;"><b>C-PhaRM Sorbidex C </td>
            <td style="text-align: center;border-right:1px solid white;">Cargill</td>
            <td style="text-align: center;border-right:1px solid white;">Germany</td>
            <td style="text-align: center;border-right:1px solid white;"><ol style="padding-left: 24px;padding-right: 12px;">
                <li style="list-style-type: disc;border-right:1px solid white;">USP</li>
                <li style="list-style-type: disc;border-right:1px solid white;">FCC</li>
            </ol></td>
            <td style="text-align: center;border-right:1px solid white;"><ol style="padding-left:24px;padding-right:12px;">
          ...
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;border-right: 1px solid white;">Sorbitol C 70%</td>
            <td style="text-align:center;border-right: 1px solid white;" id="prueba35">Liquid</td>
            <td style="text-align:center;border-right: 1px solid white;">68425-17-2</td>
            <td style="text-align: center;width:180px;border-right: 1px solid white;"><b>C-Pharm Sorbidex C</td>
            <td style="text-align: center;border-right:1px solid white;">Cargill</td>
            <td style="text-align: center;border-right:1px solid white;">Germany<br>Italy</td>
            <td style="text-align: center;border-right:1px solid white;"><ol style="padding-left: 24px;padding-right: 12px;">
          ...
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align: center;border-right: 1px solid white;"></td>
            <td style="text-align:center;border-right: 1px solid white;" id="prueba35">Compressible Powder</td>
            <td style="text-align:center;border-right: 1px solid white;"></td>
            <td style="text-align: center;width:180px;border-right:1px solid white;"><b>C-Pharm Sorbidex P</td>
            <td style="text-align: center;border-right:1px solid white;">Cargill</td>
            <td style="text-align: center;border-right:1px solid white;">Germany</td>
            <td style="text-align: center;border-right:1px solid white;"><ol style="padding-left: 24px;padding-right: 12px;">
                <li style="list-style-type: disc;">USP</li>
            ...
            <td style="text-align: center;border-right:1px solid white;" rowspan="2"><ol style="padding-left: 24px;padding-right: 12px;">
            ...
            <td style="text-align: center;border-right:1px solid white;" rowspan="2">
        <ol>
            <li class="Tipografia--general letranegro Elementos--Listas">Formas de dosificación Sólidas:
        ...
        <ol>
                ...
                <ol>
                <li class="Tipografia--general letranegro Elementos--Listas">Confitería Medicada</li>
                </ol>
          ...
          <tr style="background-color:#E6E6E6" class="Tipografia--general General--Cuerpo"> 
            <td style="text-align:center;border-right: 1px solid white;" id="prueba35">Powder</td>
            <td style="text-align:center;border-right: 1px solid white;"></td>
            <td style="text-align: center;width:180px;border-right:1px solid white;"><b>C-Pharm Sorbidex S</td>
            <td style="text-align: center;border-right: 1px solid white;">Cargill</td>
            <td style="text-align: center;border-right: 1px solid white;">Germany</td>
            <td style="text-align: center;border-right: 1px solid white;"><ol style="padding-left: 24px;padding-right: 12px;">
                <li style="list-style-type: disc;">USP</li>
