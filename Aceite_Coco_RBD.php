  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/ACEITE_COCO_RBD.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Aceite de Coco RBD</b><br></h1><b class="segundotitulo" style="font-size:26px"></b>
...
<div class="container" style="margin-top:130px;">
    ...
    <ol>
        <li class="Elementos--Listas" style="margin-top:30px;">Refinado: Se elimina la mayor parte de las impurezas y componentes no deseados, lo que garantiza un aceite puro y estable.</li>
        <li class="Elementos--Listas" style="margin-top:30px;">Blanqueado: Este proceso asegura que el aceite tenga un color claro, eliminando pigmentos naturales o partículas.</li>
    ...
    <ol>
        ...
        <li class="Elementos--Listas" style="margin-top:30px;">Nutrientes: El RBD puede perder algunos antioxidantes y compuestos beneficiosos durante la refinación.</li>
