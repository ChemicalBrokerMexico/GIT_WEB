...
<li> <a class="elemennav-secun Tipografia--general letranegro Subtitulos dropdown-trigger" href="#!" data-target="dropdown3"><b>Productos<i class="material-icons right">arrow_drop_down</i></b></a></li>
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><br></h3><b class="boldbanner" style="font-size: 26px;">Chemical Broker </b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   >&nbsp</b></a><a class="breditem active" href="Antioxidantes.html" style="color:#262137 !important;margin-left:-2px"><b>Gums</b></a></section></section>
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        ...
        <tbody>
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"><a href="VenderBHA.php"><b style="color:#262137">° Carrageenans</b></a>
            </td>
            <td style="text-align:center;" id="prueba35">° 9000-30-0</td>
            <td style="text-align:center;" id="prueba35">° Bag 25 Kg
            </td>
            <td style="text-align:center;">° Food
            </td>
            <td style="text-align:center;">° Kosher<br> ° Halal
            </td>
            <td style="text-align:center">° Thickener<br> ° Suspensor<br> ° Gelifyng
            </td>
            <td style="text-align:center">° Dairy <br>° Chantilly Cream<br>° Meat
            </td>
          </tr>
          <tr style="background-color:#fcece8"> 
            <td style="text-align: center;"><a href="VenderBHA.php"><b style="color:#262137">° Sodium Alginate</b></a>
            </td>
            ...
            <td style="text-align:center">° Thickener
            </td>
            <td style="text-align:center">° Dairy <br>° Ice Cream<br>° Chantilly Cream
            </td>
          </tr>
        </tbody>
      </table>
