    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/SYRUP_280421.jpeg" style="height:800px;" alt="Historia Ascendente">
            ...
            <div class="row">
                ...
                <section style="margin-top:0px;"><a href="index.php" style="color:black !important;"><b class="Tipografia--general Subtitulos">Inicio&nbsp>&nbsp </b></a><a href="Mercados.php" style="color:black !important;"><b class="Tipografia--general Subtitulos">Mercados&nbsp>&nbsp </b></a><a href="pharmaceutical.php" style="color:black !important;"><b class="Tipografia--general Subtitulos">Farmaceutica&nbsp>&nbsp </b></a><a class="active" href="Jarabes.php"><b class="Tipografia--general Subtitulos" style="color:red;">Jarabes</b></a></section>
                    ...
                    <ol style="margin-top:30px;">
                        <li style="list-style-type: disc;">Variedad de productos: La industria de los jarabes ofrece una amplia variedad de productos para satisfacer las necesidades del mercado. Esto incluye jarabes simples, como jarabe de maíz y jarabe de azúcar, así como jarabes especializados, como jarabe de arce, jarabe de agave y jarabe de maltitol, que se utilizan en productos específicos o en la formulación de alimentos y bebidas para dietas especiales.</li>
                        <li style="list-style-type: disc;margin-top:30px;">roducción y formulación: Los jarabes se producen mediante la mezcla de diferentes ingredientes, como azucares (como jarabe de maíz, jarabe de glucosa, jarabe de sacarosa) agua y en ocasiones otros aditivos como saborizantes, colorantes y conservantes.</li>
                        <li style="list-style-type: disc;margin-top:30px;">Ingredientes y aditivos: Los ingredientes principales de los jarabes son los azucares, que pueden provenir de diversas fuentes como la caña de azúcar, la remolacha, el maíz, el arroz y el trigo y otros cereales. Además de los azucares se pueden agregar otros ingredientes y aditivos para mejorar las características organolépticas.</li>
                    </ol>
                    <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Ingredientes químicos mas importantes de los jarabes:</b></h5>
                    <ol>
                        <li class="Elementos--Listas colornegro" style="margin-top:30px;">Agua: El agua es un componente esencial en la mayoría de los jarabes, ya que se utilizan a disolver los ingredientes y ajustar la viscosidad del producto final.</li>
                        <li class="Elementos--Listas colornegro" style="margin-top:30px;">Ácidos: Algunos jarabes pueden contener ácidos como acido cítrico o ácido málico, que se utilizan para equilibrar el sabor y proporcionar acidez.</li>
                        <li class="Elementos--Listas colornegro" style="margin-top:30px;">Saborizantes y colorantes: Se pueden agregar saborizantes y colorantes naturales o artificiales para mejorar el sabor y la apariencia del jarabe. Estos pueden incluir extractos de frutas, aromas artificiales y colorantes alimentarios. </li>
                        <li class="Elementos--Listas colornegro" style="margin-top:30px;">Conservantes: En algunos casos, se pueden agregar conservantes como el benzoato de sodio o el sorbato de potasio para prolongar la vida útil del jarabe al inhibir el crecimiento de microorganismos.</li>
                        <li class="Elementos--Listas colornegro" style="margin-top:30px;">Espesantes y estabilizantes: Para controlar la viscosidad y estabilidad del jarabe, se pueden agregar espesantes y estabilizantes como la goma guar, la goma xantana y la carragenina.</li>
                        <li class="Elementos--Listas colornegro" style="margin-top:30px;">Edulcorantes artificiales: En los jarabes diseñados para ser bajos en calorías o sin azúcar, se pueden utilizar edulcorantes artificiales como el aspartamo, la sucralosa o el acesulfamo de potasio para proporcionar dulzor sin agregar calorías.</li>
                    </ol>
                    
                    <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Tipos de Jarabes</b></h5>
                    <ol>
                        <li class="Elementos--Listas">Jarabes Aromáticos (Jarabes no medicamentosos</li>
                        <ol style="margin: top 30px;;">
                            <li class="Elementos--Listas" style="margin-top:30px;">Sirven como vehículos de preparación extemporáneas,</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Como punto de partida de jarabes medicamentos,</li>
                            <li class="Elementos--Listas" style="margin-top:30px;">Jarabe simple, jarabe de zumos</li>
                        </ol>
                    </ol>
                    <ol>
                        <li class="Elementos--Listas">Jarabes medicamentosos</li>
                        <ol>
                            <li style="margin-top:30px;" class="Elementos--Listas">Jarabe Antihistamínico</li>
                        </ol>
                    </ol>
                    <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b>Aplicaciones</b></h5>

                    <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:30px;"><b>Industria Alimentaria</b></h5>
                    <p class="Tipografia--general General--Cuerpo letranegro">Edulcorantes: Los jarabes se utilizan como edulcorantes en una variedad de productos alimenticios, incluyendo bebidas, productos horneados, cereales, postres y dulces. El jarabe de maíz alto en fructosa (HFCS) es uno de los edulcorantes mas utilizados en la industria alimentaria debido a su bajo costo y su capacidad para mejorar la textura y la estabilidad de los alimentos.</p>
                    <p class="Tipografia--general General--Cuerpo letranegro" style="margin-top:50px;">Espesantes y estabilizadores: Algunos jarabes como el jarabe de glucosa y el jarabe de maltosa, se utilizan como agentes espesantes y estabilizadores en productos como salsas, aderezos y helados para mejorar la textura y la consistencia.</p>
                    <p class="Tipografia--general General--Cuerpo letranegro" style="margin-top:50px;">Agentes humectantes y conservantes: Los jarabes también se utilizan como agentes humectantes para mantener la humedad en los productos horneados y como conservantes para prolongar la vida útil de los alimentos.</p>
                    <p class="Tipografia--general General--Cuerpo letranegro" style="margin-top:50px;">Saborizantes: En algunos casos, los jarabes se utilizan como saborizantes para agregar sabor y dulzura a los alimentos y bebidas</p>
                    <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Industria Farmacéutica</b></h5>
                    <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:0px;">Vehículos para medicamentos líquidos: Los jarabes se utilizan como vehículos para administrar medicamentos líquidos, especialmente aquellos destinados para niños y personas que tienen dificultad para tragar pastillas. Estos jarabes pueden contener ingredientes activos así como aditivos para mejorar el sabor y la textura.</p>
                    <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Excipientes en formulaciones farmacéuticas: Además de servir como vehículos para medicamentos líquidos, los jarabes también se utilizan como excipientes en la formulación de tabletas, capsulas y otros productos farmacéuticos para mejorar la estabilidad y la palatabilidad de los medicamentos.</p>
                    <h5 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;"><b>Otras aplicaciones</b></h5>
                    <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:0px;">Industria cosmética: Algunos jarabes se utilizan en la industria cosmética como ingredientes en productos para el cuidado de la piel y el cabello debido a sus propiedades humectantes.</p>
                    <p class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px;">Industria química: En la industria química, los jarabes pueden utilizarse como materia prima en la producción de productos químicos y biocombustibles.</p>
                </div>
            </div>
        </div>
