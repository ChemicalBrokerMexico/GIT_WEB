...
<head>
  ...
  <meta name="description" content="Para Chemical Broker es importante minimizar el riesgo en cualquier operacion realizada, preservando de esta forma nuestros intereses / los de nuestros clientes."> 
  <title>Chemical Broker | Cobertura de Riegos</title>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;margin-left:188px;">search</i></a></li>
    ...
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <section style="margin-top:40px"><a class="breditem active" href="index.php"
            ...
            href="Carreras.php" style="color:#262137 !important"><b class="breadcrumb">Coberturas de Riesgos</b>
        </section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l6 xl6">
        <img src="img/CB_INSURANCE_100322.jpg" class="IMAGE--SORBITOLS" alt="">
      </div>
      <div class="col s12 m12 l6 xl6" style="margin-top:6px;">
        <h5 class="Tipografia--general letranegro Titulos" style="margin-top:19px;"><b
            style="border-bottom:3px solid #262137;color:#262137;">Coberturas de Riesgos</b></h5>
        <p class="Tipografia--general General--Cuerpo letranegro">La Servicios de ingredientes químicos conlleva
          el recorrido de largas distancias. Por este motivo es importante asegurar todos los costos implícitos en su
          operación para llevarlos de un lugar a otro en tiempo y forma.</p>
        <p class="Tipografia--general General--Cuerpo letranegro">Como parte de su política de Servicio Integral y
          Riesgo “0”, <b style="color: #262137;">Chemical Broker</b> ofrece a sus socios de negocios una Logística
          Global libre de riesgos externos que afecten la operación de compra y venta de productos químicos, por medio
          de la contratación de coberturas de riesgos con las principales casas aseguradoras en el mundo, como
          prevención a eventos desafortunados; como desastres naturales, delincuencia o cualquier situación que ponga en
          riesgo la integridad del producto.</p>
      </div>
    </div>
  </div>
  ...
  <div class="container" style="margin-top:0px;padding-top:0px">
    <div class="row" style="margin-top:0px;padding-top:0px">
      <div class="col s12 m12 l12 xl12">
        <h5 class="Tipografia--general General--Cuerpo"><b style="border-bottom:1.5px solid #b12729;">Cobertura</b></h5>
        <p class="Tipografia--general General--Cuerpo letranegro">Una solución bien planificada siempre reduce la
          ocurrencia de situaciones criticas. Para ello tomamos en cuenta los siguientes aspectos:</p>
        <ol>
          <li class="Tipografia--general General--Cuerpo" style="list-style-type:disc;">Definimos escenarios de riesgos,
            cuál sería su impacto y determinamos si se compensa con la protección brindada.</li>
          <br>
          <li class="Tipografia--general General--Cuerpo" style="list-style-type:disc;">Conocemos a la perfección los
            distintos instrumentos de cobertura para cada caso, sus beneficios y limitantes.</li>
          <br>
          <li class="Tipografia--general General--Cuerpo" style="list-style-type:disc;">Evaluamos el costo de cada
            medida en función de las ventajas que aporta o la perdida que evita.</li>
          <br>
          <li class="Tipografia--general General--Cuerpo" style="list-style-type:disc;">Planificamos en su totalidad
            cada operación, asegurando el resultado.</li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 xl12">
        <p class="Tipografia--general General--Cuerpo"><b style=color:#262137>Chemical Broker</b> ofrece sus coberturas
          de riesgo de la siguiente forma:</p>
        <p class="Tipografia--general General--Cuerpo">Puerta a Puerta.- Producto, contenedor, impuesto no trasladable,
          Gastos Logísticos, Gastos de Comercio Exterior, Deducible.</p>
        <ol>
          <li class="Tipografia--general General--Cuerpo" style="list-style:disc;">All Risk Terrestre 105%,</li>
          <li class="Tipografia--general General--Cuerpo" style="list-style:disc;">All Risk Maritimo 110%,</li>
          <li class="Tipografia--general General--Cuerpo" style="list-style:disc;">All Risk Aereo 110%.</li>
        </ol>
        <p class="Tipografia--general General--Cuerpo">Según el ámbito de operación</p>
        <ol>
          <li class="Tipografia--general General--Cuerpo">Nacional,</li>
          <li class="Tipografia--general General--Cuerpo">Internacional,</li>
          <li class="Tipografia--general General--Cuerpo">Mixto.</li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <!-- <div class="container">
      <div class="row">
          <div class="col s12 m12 l12 xl12">
          <h5 class="Tipografia--general letranegro Titulos"><b></b></h5>
          <ol>
