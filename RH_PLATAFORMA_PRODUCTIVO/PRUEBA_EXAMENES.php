...
<div class="container" id="Question10" style="display:none;">
    ...
    <footer style="margin-top:730px;">
        ...
        <div class="container-fluid center-align" style="margin-top:-50px">
            <p class="Tipografia--general letranegro center-align Pie--Pagina" id="footer_dark">© 2014 | Chemical Broker Todos los Derechos Reservados. | <a href="Contact.php" style="color:black !important;font-size:16px">Contacto
