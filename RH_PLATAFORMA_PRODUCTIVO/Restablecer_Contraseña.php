...
<head>
    ...
    <title>Chemical Broker Restablecer Contraseña</title>
    <!-- CSS  -->
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="Tipografia--general colornegro General--Cuerpo center-align" style="padding:20px;">
                    <b>Restablecimiento de Contraseña</b></h5>
            </div>
        </div>
    </div>
                ...
                <div class="col s12 m12 l12 xl12" style="margin-top: -120px;">
                    <div class="container contlog center-align"
                        ...
                        <img src="img/CB_LOGOTIPO_FONDO-BLANCO_V0.jpg" alt="" class="center-align"
                            style="max-width:100%;">
                        <form div="div-form" role="form">
                            <div class="input-field col s12 m12 l12 xl12">
                                <input type="password" id="txtContrasena" name="txtContrasena"
                                    placeholder="Nueva Contraseña" class="login-inputs center-align" /><a href="#"
                            ...
                            <div>
                                <div class="row">
                                    <div class="input-field col s12 m12 l12 xl12">
                                        <input type="password" id="txtContrasena_Confirmacion"
                                            name="txtContrasena_Confirmacion" placeholder="Confirmar Contraseña"
                                            class="login-inputs center-align" /><a href="#" style="color: black;"
                                            id="eyeon2"><i class="material-icons prefix"
                                                style="font-size:25px;padding-top:10px"
                                                onclick="mostrarcontra2();">visibility</i></a><a href="#"
                                            style="color: black;display: none;" id="eyeoff2"><i
                                                class="material-icons prefix" style="font-size:25px;padding-top:10px"
                                                onclick="mostrarcontra2();">visibility_off</i></a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field- col s12 m12 l12 xl12">
                                        <input type="hidden" id="usuarioupdate" name="usuarioupdate"
                                            value="<?php echo $_REQUEST['usuario']; ?>">
                                    </div>
                                </div>
                            </div>
<!-- 
                             <button type="submit" id="btnUpdatecontrasena" class="btn center-align" style="background-color: #262137;">Actualizar
                                Contraseña</button> -->
                                <center><a href="#" id="btnUpdatecontrasena" class="waves-effect btn center-align"
                                            style="background-color:#262137;color:white;width:250px;">Actualizar Contraseña</a>
                                    </center>
                        </form>
    ...
    <script>
        ...
        function cambio() {
            $("#btnUpdatecontrasena").click(ActualizarContrasena)
        }

        function ActualizarContrasena() {
            var contrasenActual = $("#txtContrasena").val();
            var contrasenaRemplazo = $("#txtContrasena_Confirmacion").val();
            var usuarioget = $("#usuarioupdate").val();
            $.ajax({
                url: "Update_Contraseña.php",
                ...
                data: {
                    txtContrasena: contrasenActual,
                    txtContrasena_Confirmacion: contrasenaRemplazo,
                    usuarioupdate: usuarioget
                },
                type: "POST"
            });
        }
