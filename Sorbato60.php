...
<head>
  ...
  <title>Chemical Broker | Polisorbato 60 | Proveedor Global y Nacional de Sorbato 60</title>
...
<li class="ul-independiente right"><a class="btn-search-desktop1" href="Buscador_CB.php" id="busquedaprueba"><i class="material-icons left search-desktop-icon letranegro" style="font-size:24px;font-weight:500;position:absolute;z-index:1;">search</i></a></li>
  ...
  <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/SORBATO60_BANNER.jpg" style="height:615px;margin-top:-1px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Sorbato 60</b><br></h1>
              <div class="container">
  ...
  <div class="container" style="margin-top:130px;">
    <div class="row">
      ...
      <section style="margin-top:30px;"><a href="index.php" style="color:black !important;"><b class="Tipografia--general Subtitulos">Inicio&nbsp>&nbsp </b></a><a class="active" href="Productos_news.php"><b class="Tipografia--general Subtitulos" style="color:black;">Productos > </b></a><a class="active" href="Glycerins.php"><b class="Tipografia--general Subtitulos" style="color:red;">Sorbato 60</b></a></section>
      </div>
  </div>
  </div>
...
<div class="row">
    ...
    <h2 class="Tipografia--general letranegro General--Cuerpo"><b style="color:#C5E0B3">Mono Estearato de Sorbitano | Sorbato 60 | Span 60</b></h2>

<p class="Tipografia--general letranegro General--Cuerpo">El <b style="color:#C5E0B3">Mono Estearato de Sorbitan</b>, también conocido como <b style="Color:#C5E0B3">Sorbato 60 o Span 60</b>, es un emulsionante no iónico derivado del sorbitol y el ácido esteárico. Se utiliza ampliamente en las industrias alimentaria, cosmética y farmacéutica por su capacidad para estabilizar emulsiones de agua en aceite (W/O).</p>

<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b style="color:#C5E0B3">Caracteristicas Físicas y Químicas</b></h2>

<ol>

<li class="Elementos--Listas"><b>Nombre químico:</b> Éster de sorbitán y ácido esteárico (Span 60).</li>
<li class="Elementos--Listas"><b>Fórmula molecular:</b> C₂₄H₄₆O₆</li>
<li class="Elementos--Listas"><b>Peso molecular:</b> Aproximadamente 430.6 g/mol</li>
<li class="Elementos--Listas"><b>Apariencia:</b> Sólido ceroso, de color blanco a amarillo pálido</li>
<li class="Elementos--Listas"><b>Olor:</b> Ligero o casi inodoro</li>
<li class="Elementos--Listas"><b>Punto de fusión:</b> Entre 50°C y 55°C</li>
<li class="Elementos--Listas"><b>Solubilidad:</b>
    <ol>
        <li class="Elementos--Listas">Insoluble en agua</li>
        <li class="Elementos--Listas">Soluble en aceites y disolventes orgánicos no polares</li>
    </ol>
</li>
<li class="Elementos--Listas"><b>Índice HLB:</b> ~4.7 (indica que es lipofílico, ideal para emulsiones de agua en aceite - W/O)</li>

</ol>


<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b style="color:#C5E0B3">Propiedades Funcionales</b></h2>

<ol>
<li class="Elementos--Listas"><b>Emulsionante:</b> Facilita la mezcla de sustancias que normalmente no se combinan, como agua y aceite.</li>
<li class="Elementos--Listas"><b>Estabilizador:</b> Mejora la estabilidad de emulsiones, evitando la separación de fases.</li>
<li class="Elementos--Listas"><b>Agente humectante:</b> Ayuda a retener la humedad en productos cosméticos.</li>
<li class="Elementos--Listas"><b>Dispersante:</b> Favorece la distribución uniforme de partículas en suspensiones.</li>
<li class="Elementos--Listas"><b>Espesante:</b> Puede influir en la viscosidad de productos formulados.</li>
</ol>

<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b style="color:#C5E0B3">Aplicaciones</b></h2>
...
<li class="Elementos--Listas"><b>Emulsionante (E491):</b> Se utiliza para estabilizar mezclas de agua y grasa en productos como:
    <ol>
        <li class="Elementos--Listas">Margarinas y mantequillas</li>
        <li class="Elementos--Listas">Helados (mejora la textura y reduce la formación de cristales de hielo)</li>
        <li class="Elementos--Listas">Productos de panadería (mejora la esponjosidad y la vida útil del pan)</li>
        <li class="Elementos--Listas">Chocolates y confitería (previene la separación de grasas)</li>
    </ol>
</li>
</ol>
...
<ol>
<li class="Elementos--Listas"><b>Mejorador de textura:</b> Ayuda a mantener la suavidad en productos horneados.</li>
</ol>

<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b>Industria Cosmética y de Cuidado Personal</b></h2>

<ol>
    <li class="Elementos--Listas"><b>Cremas y lociones:</b> Estabiliza emulsiones de agua en aceite (W/O), proporcionando una textura suave.</li>
    <li class="Elementos--Listas"><b>Maquillaje:</b> Se usa en bases líquidas, barras de labios y polvos compactos para mejorar la uniformidad.</li>
    <li class="Elementos--Listas"><b>Protectores solares:</b> Facilita la dispersión de filtros UV en la fase oleosa.</li>
    <li class="Elementos--Listas"><b>Productos para el cabello:</b> Aporta suavidad y mejora la aplicación de acondicionadores y cremas para peinar.</li>
</ol>

<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b>Industria Farmacéutica</b></h2>

<ol>
    <li class="Elementos--Listas"><b>Vehículo en sistemas de liberación controlada:</b> Facilita la liberación sostenida de fármacos en cápsulas y tabletas.</li>
    <li class="Elementos--Listas"><b>Cremas y pomadas medicinales:</b> Mejora la estabilidad de los principios activos en emulsiones tópicas.</li>
    <li class="Elementos--Listas"><b>Formulación de vacunas:</b> Puede actuar como adyuvante en la dispersión de antígenos.</li>
</ol>

<h2 class="Tipografia--general letranegro General--Cuerpo" style="margin-top:50px"><b>Otras Aplicaciones Industriales</b></h2>

<ol>
    <li class="Elementos--Listas"><b>Industria textil:</b> Actúa como agente antiestático y suavizante en el procesamiento de telas.</li>
    <li class="Elementos--Listas"><b>Plásticos y caucho:</b> Mejora la dispersión de aditivos en polímeros.</li>
    <li class="Elementos--Listas"><b>Productos de limpieza:</b> Emulsionante en detergentes industriales y domésticos.</li>
    <li class="Elementos--Listas"><b>Tintas y pinturas:</b> Facilita la dispersión uniforme de pigmentos.</li>
</ol>
