        ...
        <ul class="slides slides-pruea">
          <li><img src="img/FOSFATOS_BANNER_110724.jpg" style="height:400px;" alt="Historia Ascendente">
            <div class="caption center-align"><br><br><br><br>
              <h1 class="primertitulo"><b class="boldbanner">Sulfato de Aluminio y Sodio</b><br></h1>
              <div class="container">
    </div>
            </div>
          </li>
...
<div class="container" style="margin-top:100px">
    <div class="row">
        ...
        <div class="col s6 m6 l6 xl6">
            <h2 class="Tipografia--general letranegro General--Cuerpo"><b>Sulfato de Aluminio y Sodio K</b></h2>
        </div>
        <div class="col s6 m6 l6 xl6">
