...
<div class="row">
<div class="col s12 m12 l12 xl12">
<section style="margin-top:50px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   / &nbsp</b></a><a class="breditem active" href="Productos_news.html" style="color:#262137 !important;margin-left:-2px"><b>Productos</b><b>   / &nbsp</b></a><a class="breditem active" href="Sorbitols Cargil" style="color:#262137 !important;margin-left:-2px" id="Mercado"><b>Glicerinas Peter Cremer</b></a></section></section>
</div>
</div>
</div>
...
<h5 style="margin-top:10px;">Edulcorantes</h5>
<hr style="border:1px solid blue;">
<p style="text-align: justify;">Los edulcorantes o sustitutos de azúcar son sustancias que se utilizan en lugar de los endulzantes con azúcar (sacarosa) o alcoholes del azúcar. También se pueden denominar edulcorantes artificiales, edulcorantes no nutritivos (NNS, por sus siglas en ingles).</p>

<a href="#" style="color: blue;" onclick="mostrartexto();" id="readm">Read More</a>
...
<a href="#">
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:70px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="hovercard" style="font-size:12px;margin-top:120px !important;font-weight:750;">Azucar Glass <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:70px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">Azucar Glass Refinado <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:70px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">Azucar Invertida <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:70px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">Azucar Mascabado <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:70px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">Sucralosa <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
