...
<html>
  ...
  <div class="modal overflow-y" id="modal1">
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Oils & Fats </b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   >&nbsp</b></a><a class="breditem active" href="Antioxidantes.html" style="color:#262137 !important;margin-left:-2px"><b>Oils & Fats   </b></a></section></section>
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        ...
        <tbody>
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Palm Olein RBD</b></a>
            </td>
            ...
            <td style="text-align:center">° Fry Oil
            </td>
            <td style="text-align:center">° Dairy <br>° Bakery<br>° Snacks
            </td>
          </tr>
