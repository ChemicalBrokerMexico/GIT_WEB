  ...
  <div class="modal overflow-y" id="modal1">
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Polietilenglicol </b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 2px;border:none">
        ...
        <tbody>
          <tr class="segundotr"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Polyethylene Glycol 1000</b></a>
            </td>
...
<li>Suppositories</li>
          ...
          <tr class="tercertr"> 
            <td style="text-align: center ;"> <a href="VenderBHA.php"> <b style="color:#262137">
            
            Polyethylene Glycol 1500</b></a>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td id="prueba35">
