  ...
  <div class="modal overflow-y" id="modal1">
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Fosfatos</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        ...
        <tbody>
        <tr class="segundotr"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Disodphos AH</b></a><br>(Disodium Phosphate Anhydrous)
            </td>
...
<li>Dairy</li>
<li>Milk Formules</li>
<li>Cream Substitute for Coffe</li>
<li>Creams</li>
<li>Ice Cream</li>
<li>Dairy Productos</li>
<li>Cheeses & Analogs</li>
            </ol>
             
            </td>
          </tr>
          <tr class="tercertr"> 
            <td style="text-align: center;"><a href="VenderBHA.php"><b style="color:#262137">Disodphos DH</b></a><br>(Disodium Phosphate Dihydrated)
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
...
<li>Dairy Productos</li>
          ...
          <tr class="cuartotr"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Vitrafos RC</b></a><br> (Sodium Hexametaphosphate regular chain)
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
...
<li>Halal</li>
          ...
          <tr class="quintotr"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Vitrafos LC</b></a><br>Sodium Hexametaphosphate Long Chain
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35">
            </td>
...
<li>Analog Chesse</li>
          ...
          <tr class="sextotr"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">TSP 12 FG</b></a><br>Trisodium Phosphates Dodecahydrate
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35">
            </td>
...
<li>Increase PH</li>
<li>Emulsifier</li>
<li> Color and Flavor Stabilizer </li>
            </ol>
