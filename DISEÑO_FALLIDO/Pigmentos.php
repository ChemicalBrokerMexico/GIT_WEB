  ...
  <div class="modal overflow-y" id="modal1">
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Pigmentos </b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        ...
        <tbody>
          <tr class="segundotr"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Pretiox® AV 01 FG</b></a>
            </td>
            <td  id="prueba35">
