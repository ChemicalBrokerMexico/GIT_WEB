...
<html>
  ...
  <div class="modal overflow-y" id="modal1">
    ...
    <div class="container-fluid">
      <div class="slider slider-prueba" style="margin-top:0px">
        <ul class="slides slides-pruea">
          <li><img src="img/SYRUP_280421.jpeg" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Jarabes</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <p style="color:#858b92a4">Los <b>Jarabes</b> son una preparación acuosa de uso oral caracterizada por un sabor dulce y consistencia viscosa. Puede contener sacarosa a una concentración de al menos 45% p/p. Su sabor dulce se puede obtener también utilizando otros polioles o agentes edulcorantes. Los jarabes contienen normalmente otros agentes aromatizados o saporíferos.
          </p>
          <p style="color:#858b92a4;"> <b>Chemical Broker </b>cuenta con ingredientes de calidad mundial que permiten a nuestros socios de negocios desarrollar jarabes idoneos para la industria farmaceutica.
          </p>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <h56> <b style="color:#262137;">Productos</b></h5>
        </div>
      </div>
    </div>
    <div class="container" style="margin-top:-50px;">
      <div class="row">
        ...
        <ol>
          <a href="Proximamente.php" style="color:#262137;width: 0px;"><li class="arrowblue">Edulcorantes</li></a>
          <a href="Glycerins.php" style="color:#262137;width: 0px;"><li class="arrowblue">Glicerinas</li></a>
          <a href="Proximamente.php" style="color:#262137;width: 0px;"><li class="arrowblue">Glicoles</li></a>
          <a href="Proximamente.php" style="color:#262137;width: 0px;"><li class="arrowblue">Polioles</li></a>
          <a href="Proximamente.php" style="color:#262137;width: 0px;"><li class="arrowblue">Acidos</li></a>
        </ol>
        </div>
      </div>
    </div>
