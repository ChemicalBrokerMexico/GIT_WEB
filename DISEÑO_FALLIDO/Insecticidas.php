...
<body>
                                    ...
                                    <ul>
                                        ...
                                        <ul> <a class="arrowblue Tipografia--general Subtitulos"
                                                ...
                                                href="Premisas.php">Premisas &nbsp<i
                                                    ...
                                                    id="aparece"></i></a><br><a
                                                class="arrowblue Tipografia--general Subtitulos"
                                                href="Servicio_Total.php">Servicio Total &nbsp<i
    ...
    <nav style="background-color:white;height:25px;margin-top:-19px">
        <div class="nav-wrapper flex"><a class="sidenav-trigger" href="#" data-target="mobile-demo"><i
            ...
            <ul class="hide-on-med-and-down">
                ...
                <li> <a class="elemennav-secun Tipografia--general letranegro Subtitulos"
                        href="Productos_news.php"><b>Productos </b></a></li>
                <li><a class="elemennav-secun Tipografia--general letranegro Subtitulos"
                ...
                <li><img src="img/" alt="" style="height:650px">
                    <div class="caption center-align"><br><br><br><br>
                        <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b
                            class="segundotitulo" style="font-size: 26px;">Insecticidas</b>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <section style="margin-top:125px"><a class="breditem active" href="index.php"
                        style="color:#262137 !important"> <b>Inicio&nbsp </b><b> >&nbsp </b></a><a href="Mercados.php"
                        class="breditem active" style="color:#262137 !important"><b>Mercados ></b></a> <a
                        href="pharmaceutical.php" class="breditem active"
                        style="color:#262137 !important"><b>Agroquímicos ></b></a> <a class="breditem active"
                        href="Spray_Nasal.php" style="color:#262137 !important;margin-left:-2px"><b
                            class="Tipografia--general letranegro Subtitulos breadcrumb">Insecticidas</b></a></section>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="Tipografia--general letranegro General--Cuerpo"><b>Insecticidas</b></h5>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row center-align">
        <div class="col s12 m12 l3 xl3"><img src="" alt="IMAGEN DE MARCA"></div>
        <div class="col s12 m12 l3 xl3"><img src="" alt="IMAGEN DE MARCA"></div>
        <div class="col s12 m12 l3 xl3"><img src="" alt="IMAGEN DE MARCA"></div>
        <div class="col s12 m12 l3 xl3"><img src="" alt="IMAGEN DE MARCA"></div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12 xl12">
                <h5 class="letranegro Tipografia--general Titulos"><b>Downloads</b></h5>
            </div>
            <div class="col s12 m12 l3 xl3">
            <div class="card blue-grey darken-1" style="border-radius:10px">
    ...
    <div class="container" style="border: 1px solid black;margin-top:15px;border-radius:15px">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <div class="col s12 m12 l6 xl6">
            <h5 class="Tipografia--general letranegro Titulos"></h5>
            <p>For more information, please contact our experts. We look</p>
          </div>
          <div class="col s12 m12 l6 xl6">
            ...
            <label for="Solicitud">Requerimiento</label><br/><a class="waves-effect waves-light btn" style="margin-top:15px">Send E-mail</a>
          </div>
        </div>
      </div>
    </div>
