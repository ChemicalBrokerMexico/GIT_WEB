...
<div class="row">
<div class="col s12 m12 l12 xl12">
<section style="margin-top:6%"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   > &nbsp</b></a><a class="breditem active" href="Productos_news.html" style="color:#262137 !important;margin-left:-2px"><b>Productos</b><b>   > &nbsp</b></a><a class="breditem active" href="Sorbitols Cargil" style="color:#262137 !important;margin-left:-2px" id="Mercado"><b>Sorbitol Cargil</b><b> > &nbsp</b></a></section></section>
</div>
</div>
</div>
...
<div class="col s12 m12 l6 xl6" >
<!-- <h5>Acidos</h5> -->
<img src="img/SORBITOL_280721.jpg" alt="" style="max-width:95%;margin-top:25px;">
</div>
<div class="col s12 m12 l6 xl6" style="">
<img src="img/CARGIL_280721.png" alt="" style="max-width:250px;">
<h5 style="margin-top:35px;">C*PHARM™ Sorbidex Sorbitol</h5>
<hr style="border:1px solid green;">
<p style="text-align: justify;">El sorbitol se produce mediante la hidrogenación catalítica de D-glucosa y está disponible como un polvo cristalino de flujo libre y como soluciones acuosas. </p>
<p style="text-align: justify;display: none;" id="textomostrar">Nuestro sorbitol cristalino es un excipiente único para la compresión directa de comprimidos. El sorbitol tiene excelentes propiedades de flujo, lo que garantiza una mezcla uniforme y un peso de tableta constante. Se han desarrollado grados especiales de polvo de polvo de sorbitol con respecto a la distribución del tamaño de partículas, las propiedades de flujo y la minimización de la fuerza y la compresión necesaria para aplicaciones de compresión directa.</p>
<p style="text-align: justify;display: none;" id="textomostrar1">La dulzura, la no reactividad y la compatibilidad del sorbitol con los ingredientes activos lo convierten en un vehículo ideal en las formulaciones matemáticas para mejorar el sabor, el cuerpo y la sensación de la boca.</p>
<b><a href="#" style="color: green;" onclick="mostrartexto();" id="readm">Read More</a></b>
<b><a href="#" style="color: green;display: none;" onclick="ocultartexto();" id="readl">Read Less</a></b>
</div>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<h5><b>Sorbitoles Liquidos</b></h5>
<h5 style="margin-top:30px;"><b>Marcas:</b></h5>
<br>
<div class="row">
<div class="col s12 m6 l4 xl4">
<a href="#">
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Topcithin</span>
</div>
</a>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Leciprime</span>
</div>
</div>
</a>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Metarin</span>
</div>
</div>
</a>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Emulpur</span>
</div>
</div>
</a>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Lecigran</span>
</div>
</div>
</a>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Lecimulthin</span>
</div>
</div>
</a>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">Epikuron</span>
</div>
</div>
</a>
</div>
...
<!-- <div class="col s12 m6 l4 xl4">
<div class="card darken-1" style="border-radius:5px;max-width:350px;">
<div class="card-content black-text">
<span class="card-title" style="font-size:16px;">C☆Pharm™ Sorbidex NC (non-crystallizing)</span>
</div>
<div class="card-action" style="background-color: #262137;font-size:15px !important;border-radius:5px;">
<a href="#" style="color: #b21b27;">Read More</a>
</div>
</div>
</div> -->
</div>
...
<ol>
<li>Humectantes</li>
<li>Agente enmascarador del sabor</li>
<li>Agente edulcorante no cancerigeno</li>
<li>Agente anticristalizante</li>
<li>Agente corporal</li>
<li>Agente de carga</li>
<li>Emoliente</li>
</ol>
<br>
<h5><b>Aplicaciones:</b></h5>
<ol>
<li>Formas de dosificación sólidas</li>
<li>Plastificacion en capsulas de gelatina</li>
<li>Agente de carga para soluciones y jarabes sin azúcar</li>
<li>Edulcorante no cancerígeno</li>
</ol>
</div>
</div>
</div>
