...
<html>
  ...
  <div class="modal overflow-y" id="modal1">
        ...
        <ul class="slides slides-pruea">
          <li> <img src="img/" alt="" style="height:650px">
            <div class="caption center-align"><br><br><br><br>
              <h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br></h3><b class="segundotitulo" style="font-size: 26px;">Saturated Mono and Diglycerides of Fatty Acids</b>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12 xl12">
          <section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b>Inicio&nbsp </b><b>   >&nbsp</b></a><a class="breditem active" href="Antioxidantes.html" style="color:#262137 !important;margin-left:-2px"><b class="Tipografia--general letranegro Subtitulos breadcrumb">Saturated Mono and Diglycerides of Fatty Acids</b></a></section></section>
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col s12  m12 l6 xl4">
          <input type="search" id="UseType" name="UseType" value="<?php echo $_GET["aplicacion"];?>">
      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        <thead style="text-align:center">
          <tr style="font-size:14px;">
            <th style="text-align:center;color:white;padding:10px;background-color:#ed7d31">Chemical Description</th>
            <th id="prueba34" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#ed7d31">CAS #</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#ed7d31">Packing</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#ed7d31">Grade</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#ed7d31">Certifications</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#ed7d31">Function</th>
            <th id="prueba35" style="text-align:center;background-color:#262137;color:white;padding:10px;background-color:#ed7d31">Aplications</th>
          </tr>
        </thead>
        <tbody>
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">° Saturated Mono and Diglycerides of Fatty Acids 40% </b></a>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
            <td style="text-align:center;"> 
            </td>
            <td style="text-align:center;">° GMP+ Feed<br> ° Kosher<br> ° Halal
            </td>
            <td style="text-align:center">
            </td>
            <td style="text-align:center" rowspan="9">° Bakery <br>° Dairy & Non Dairy<br>° Potato Snacks<br> ° Cereals<br> ° Pasta<br> ° Yeast & Dry Yeast<br> ° Oil & Fats<br> ° Sports & Dietary Nutrition<br> ° Meat Productos<br> ° Food Flavours<br> ° Congfectionery<br> °Processing Aids
            </td>
          </tr>
          <tr style="background-color:#fcece8"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Saturated Mono and Diglycerides of Fatty Acids 42%</b></a><br>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
            ...
            <td style="text-align:center" class="quitar"></td>
           
          </tr>
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Saturated Mono and Diglycerides of Fatty Acids 52%</b></a>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
          ...
          <tr style="background-color:#fcece8"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Saturated Mono and Diglicerydes of Fatty Acids 70%</b></a>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
          ...
          <tr style="background-color:#f8d7cd"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Saturated Mono and Diglicerydes of Fatty Acids 90%</b></a>
            </td>
            <td style="text-align:center;" id="prueba35"></td>
            <td style="text-align:center;" id="prueba35"> 
            </td>
