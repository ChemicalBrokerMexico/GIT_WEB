...
<h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br/></h3><b class="segundotitulo" style="font-size: 26px;">Acidos</b>
</div>
</li>
</ul>
</div>
...
<div class="row">
<div class="col s12 m12 l12 xl12">
<section style="margin-top:125px"><a class="breditem active" href="index.php" style="color:#262137 !important"><b class="breadcrumb">Inicio&nbsp </b><b>  > &nbsp</b></a><a class="breditem active" href="Mercados.php" style="color:#262137 !important;margin-left:-2px"><b class="breadcrumb">Mercados   </b><b>   > &nbsp</b></a></a><a class="breditem active" href="Mercados.php" style="color:#262137 !important;margin-left:-2px"><b> </b><b></b></a><a class="breditem active" href="Acids.php" style="color:#262137 !important;margin-left:-2px"><b class="breadcrumb"> Acidos </b></a></section></section>
</div>
</div>
</div>
...
<div class="col s12 m12 l6 xl6">
<!-- <img src="img/GLICERINA/GLYCERIN_PRODUCTS.png" alt="" style="max-width:250px;"> -->
<h4 style="margin-top:30px;" class="Tipografia--general letranegro Titulos">Acidos</h4>
<hr style="border:1px solid green;">
<p class="tipografia--general letranegro General--Cuerpo">La glicerina es un subproducto de grasas y aceites saponificados, hidrolizados o transesterificados. Una vez recuperado en estado crudo, se refina mediante destilación.</p>
<p class="tipografia--general letranegro General--Cuerpo" style="text-align: justify;display: none;" id="textomostrar">Físicamente, la glicerina es un líquido soluble en agua, transparente, incoloro e inodoro, de sabor dulce y viscoso con un alto punto de ebullición. Químicamente, la glicerina es un alcohol trihídrico capaz de reaccionar, pero estable en la mayoría de las condiciones.  Debido a estas propiedades inusuales, su buena compatibilidad con muchas otras sustancias y la facilidad de procesamiento, la glicerina se usa en muchas áreas.</p>
<p class="tipografia--general letranegro General--Cuerpo" style="text-align: justify;display: none;" id="textomostrar1">Tanto si se utiliza en cosmética, medicina, alimentación o en el campo técnico, la glicerina es una materia prima extremadamente útil y versátil.</p>
<b><a href="#" style="color: green;" class="tipografia--general letranegro Botones" onclick="mostrartexto();" id="readm">Read More</a></b>
<b><a href="#" style="color: blue;display: none;" class="tipografia--general letranegro Botones" onclick="ocultartexto();" id="readl">Read Less</a></b>
</div>
</div>
...
<h5 style="margin-top:30px;" class="Tipografia--general letranegro Titulos"><b>Marcas:</b></h5>
<div class="row">
<div class="col s12 m6 l4 xl4">
<a href="#">
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:80px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard Botones" style="font-weight:750;">GL 96.0% USP Kosher <i class="tiny material-icons right letranegro">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:80px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard Botones" style="font-weight:750;">GL 99.7% Technical Grade <i class="tiny material-icons right letranegro">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:80px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">GL 99.7% USP Kosher FPO <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:80px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">GL 99.7% USP Kosher NPO <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:80px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">GL 99.7% USP Tallow Based <i class="tiny material-icons right " style="color:black !important;margin-top:0px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:80px;border-bottom: 6px solid #262137;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:12px;font-weight:750;">GL 99.7% USP Vegetable Based <i class="tiny material-icons right " style="color:black !important;margin-top:-32px !important;">arrow_forward</i></span>
</div>
</a>
</div>
</div>
...
<!-- <ol>
<li style="font-family: 16px;">C☆Pharm™ Sorbidex NC (non-crystallizing)</li>
<li style="font-family: 16px;">C☆Pharm™ Sorbidex C (crystallizing)</li>
</ol> -->
<!-- <h5><b>Funcionalidades:</b></h5> -->
<!-- <ol>
<li>Productos Cosmeticos</li>
...
<h6><b>Aplicaciones:</b></h6>
<ol>
<li style="font-size:16px;">Cosmeticos</li>
<li style="font-size:16px;">Alimentos</li>
<li style="font-size:16px;">Farmacéutica</li>
<li style="font-size:16px;">Quimica General</li>
</ol>
</div>
</div>
</div>
...
<p style="color:black;text-align:center;font-size:16px"><strong>© 2014 | Chemical Broker  Todos los Derechos Reservados. | <a href="Contact.php" style="color:black !important;font-size:16px">Contacto | </a><a href="PDF/CB_POLITICA_PRIVACIDAD_240521.pdf" download style="color:black !important;font-size:16px">Politica de Privacidad</a>
