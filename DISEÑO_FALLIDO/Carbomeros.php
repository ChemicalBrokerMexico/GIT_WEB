...
<h3 class="primertitulo"><b class="boldbanner">Chemical Broker </b><br/></h3><b class="segundotitulo" style="font-size: 26px;">Carbomeros </b>
</div>
</li>
</ul>
</div>
...
<img src="img/GLICERINA/GLYCERIN_Productos.png" alt="" style="max-width:250px;">
<h5 style="margin-top:35px;">Glicerinas</h5>
...
<a href="#">
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">GL 96.0% USP Kosher</span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">GL 99.7% Technical Grade</span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">GL 99.7% USP Kosher FPO</span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">GL 99.7% USP Kosher NPO</span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">GL 99.7% USP Tallow Based</span>
</div>
</a>
</div>
</div>
...
<div class="card darken-1 arrowblue" style="border-radius:5px;width:250px;height:100px;">
<div class="card-content black-text">
<span class="card-title hovercard" style="font-size:14px;">GL 99.7% USP Vegetable Based</span>
</div>
</a>
</div>
</div>
...
<tr style="font-size:14px;" id="primertr">
<th style="text-align:center;color:white;padding:10px;border:none;font-size:16px">Chemical Description</th>
<th id="prueba34" style="text-align:center;color:white;padding:10px;border:none;font-size:16px">CAS #</th>
<th id="prueba35" style="text-align:center;color:white;padding:10px;border:none;font-size:16px">Packing</th>
<th id="prueba35" style="text-align:center;color:white;padding:10px;border:none;font-size:16px">Grade</th>
<th id="prueba35" style="text-align:center;color:white;padding:10px;border:none;font-size:16px">Certifications</th>
<th id="prueba35" style="text-align:center;color:white;padding:10px;border:none;font-size:16px">Function</th>
<th id="prueba35" style="text-align:center;color:white;padding:10px;border:none;font-size:16px">Aplications</th>
</tr>
</thead>
<tbody>
<tr class="segundotr"> 
<td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Synthalen ® LP</b></a><br>(Carboxyvinyl Polymer Low Density)<a href="#" style="color:black" id="prueba33"> </a>
</td>
<td id="prueba35">
...
<ol style="list-style-type: disc;margin:0px;padding-left:20px;">
<p style="font-size: 14px;">Topical Applications:<br></p>
<li>Bioadhesion</li>
<li>Excellent Thickening</li>
<li>Excellent Thickening</li>
<li>Suspending & Emulsion Stabilizing Properties</li>
<li>Skin Felling</li>
<li>Ease of Formulating</li>
<p style="font-size: 14px;">Oral Suspension:<br></p>
<li>Excellent Suspending</li>
<li>Hydrated & Neutralized</li>
<li>Mask the taste</li>
<p style="font-size: 14px;">Controlled Release in Tablets:<br></p>
<li>Good Binding</li>
<li>Drug Relase</li>
<li>Excellent Hardness</li>
<li>Low Fribility</li>
...
<tr class="tercertr"> 
<td style="text-align: center;"> <a href="#"> <b style="color:#262137">Synthalen® MP</b></a><br>(Carboxyvinyl Polymer Medium Density)
</td>
<td>
...
<tr class="cuartotr"> 
<td style="text-align: center;"> <a href="#"> <b style="color:#262137">Synthalen® KP</b></a><br>(Carboxyvinyl Polymer High Density)
</td>
<td>
