      ...
      <!-- <table class="display compact responsive" id="table_id" name="table_id" style="width:100%;border-spacing:2px 5px;border:none">
        ...
        <tbody>
          <tr style="background-color:#e1e1e1"> 
            <td style="text-align: center;"> <a href="VenderBHA.php"> <b style="color:#262137">Sorbex 70 Solution</b></a><br>Sorbitol Syrup<a href="#" style="color:black" id="prueba33"> </a>
            </td>
            <td id="prueba35">
...
<li>NON-GMO</li>
            ...
            <li>Humectant</li>
            <li>Task Masketing Agent</li>
            <li>Non-Cariogenic Sweetening Agent</li>
            <li>Bodying Agent</li>
            <li>Bulking Agent</li>
            <li>Emollient</li>
...
<li>Plasricizer in Gelatin Capsules</li>
<li>Bulking Agent for Sugar Free Solutions and Syrups</li>
<li>Non-Cariogenic Sweetening Agent</li>
<li>Anti-Crystallizing Agent</li>
<li>Stabilizer for Drugs and Vitamins in Suspensions</li>
<li>Medicated Confectionery</li>
<li>Medicated Chewing Gumz</li>
<li>Topical Preparations:</li>
<li>Emollient and Humectant in Cream and Emulsions</li>

            </ol>
            
            
             <!-- <br>° <br><br> Liquid Dosage Forms:<br> ° <br> ° <br> ° <br> °<br><br><br> ° <br><br> <br> °    -->
            <!-- </td>
          </tr>
  ...
  <footer style="margin-top:70px">
    ...
    <div class="container-fluid" style="text-align:center;margin-top:-50px">
      <p style="color:black;text-align:center"><strong>© 2014 | Chemical Broker  Todos los Derechos Reservados. | <a href="Contact.php" style="color:black !important">Contacto | </a><a href="PDF/CB_POLITICA_PRIVACIDAD_240521.pdf" download style="color:black !important">Politica de Privacidad  </a><a href="#" style="color:black !important">Productos
